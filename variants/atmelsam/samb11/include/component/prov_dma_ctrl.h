...
#ifndef _SAMB11_PROV_DMA_CTRL_COMPONENT_H_
#define _SAMB11_PROV_DMA_CTRL_COMPONENT_H_
#define _SAMB11_PROV_DMA_CTRL_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 4 Channel DMA Controller
 *  @{
 */
/* ========================================================================== */
...
#define PROV_DMA_CTRL_PDC1234                    /**< (PROV_DMA_CTRL) Module ID */
#define REV_PROV_DMA_CTRL 0x100                  /**< (PROV_DMA_CTRL) Module revision */
...
#define PROV_DMA_CTRL_CH0_CMD_REG0_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CMD_REG0) Channel 0 First Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH0_CMD_REG0_RD_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH0_CMD_REG0) Start Address of Read Buffer Position */
#define PROV_DMA_CTRL_CH0_CMD_REG0_RD_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH0_CMD_REG0_RD_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG0) Start Address of Read Buffer Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG0_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH0_CMD_REG0) Register MASK  (Use PROV_DMA_CTRL_CH0_CMD_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CMD_REG0_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH0_CMD_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CMD_REG1_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CMD_REG1) Channel 0 Second Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH0_CMD_REG1_WR_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH0_CMD_REG1) Start Address of Write Buffer Position */
#define PROV_DMA_CTRL_CH0_CMD_REG1_WR_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH0_CMD_REG1_WR_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG1) Start Address of Write Buffer Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG1_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH0_CMD_REG1) Register MASK  (Use PROV_DMA_CTRL_CH0_CMD_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CMD_REG1_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH0_CMD_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CMD_REG2_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CMD_REG2) Channel 0 Third Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH0_CMD_REG2_BUFFER_SIZE_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH0_CMD_REG2_BUFFER_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG2) Size (in Bytes) of Buffer to Transfer Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG2_MASK     _U_(0x1FFF)                                    /**< \deprecated (PROV_DMA_CTRL_CH0_CMD_REG2) Register MASK  (Use PROV_DMA_CTRL_CH0_CMD_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CMD_REG2_Msk      _U_(0x1FFF)                                    /**< (PROV_DMA_CTRL_CH0_CMD_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CMD_REG3_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CMD_REG3) Channel 0 Fourth Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH0_CMD_REG3_CMD_SET_INT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CMD_REG3_CMD_SET_INT_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG3) Active High Interrupt Enable once buffer has been transfered Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG3_CMD_LAST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CMD_REG3_CMD_LAST_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG3) If set, channel stops when buffer done, otherwise load from CMD_NEXT_ADDR Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG3_CMD_NEXT_ADDR_Msk (_U_(0x3FFFFFFF) << PROV_DMA_CTRL_CH0_CMD_REG3_CMD_NEXT_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH0_CMD_REG3) Address of next command if CMD_LAST is not set Mask */
...
#define PROV_DMA_CTRL_CH0_CMD_REG3_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH0_CMD_REG3) Register MASK  (Use PROV_DMA_CTRL_CH0_CMD_REG3_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CMD_REG3_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH0_CMD_REG3) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG0_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH0_STATIC_REG0) Channel 0 Static Configuration Read  Reset Value */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG0_RD_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH0_STATIC_REG0_RD_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG0) Maximum number of bytes of an AHB read burst Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG0_RD_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH0_STATIC_REG0_RD_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG0) Number of AHB read commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG0_RD_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_STATIC_REG0_RD_INCR_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG0) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG0_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH0_STATIC_REG0) Register MASK  (Use PROV_DMA_CTRL_CH0_STATIC_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH0_STATIC_REG0_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH0_STATIC_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG1_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH0_STATIC_REG1) Channel 0 Static Configuration Write  Reset Value */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG1_WR_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH0_STATIC_REG1_WR_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG1) Maximum number of bytes of an AHB write burst Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG1_WR_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH0_STATIC_REG1_WR_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG1) Number of AHB write commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG1_WR_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_STATIC_REG1_WR_INCR_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG1) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG1_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH0_STATIC_REG1) Register MASK  (Use PROV_DMA_CTRL_CH0_STATIC_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH0_STATIC_REG1_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH0_STATIC_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG2_RESETVALUE _U_(0x10000)                                  /**<  (PROV_DMA_CTRL_CH0_STATIC_REG2) Channel 0 Block Mode  Reset Value */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG2_JOINT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_STATIC_REG2_JOINT_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) If set channel will work in joint mode Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_Msk (_U_(0x3) << PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) Endianness Byte Swapping Mask */
...
#define   PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_0_Val _U_(0x0)                                       /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) No Swapping  */
#define   PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_1_Val _U_(0x1)                                       /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) Swap bytes within 16 bits  */
#define   PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_2_Val _U_(0x2)                                       /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) Swap bytes within 32 bits  */
#define   PROV_DMA_CTRL_CH0_STATIC_REG2_END_SWAP_3_Val _U_(0x3)                                       /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) Swap bytes within 64 bits  */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG2_MASK  _U_(0x30010000)                                /**< \deprecated (PROV_DMA_CTRL_CH0_STATIC_REG2) Register MASK  (Use PROV_DMA_CTRL_CH0_STATIC_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH0_STATIC_REG2_Msk   _U_(0x30010000)                                /**< (PROV_DMA_CTRL_CH0_STATIC_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_STATIC_REG4) Channel 0 Static Configuration Peripheral  Reset Value */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_RD_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH0_STATIC_REG4_RD_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG4) Number of peripheral to read from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_RD_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH0_STATIC_REG4_RD_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG4) Number of cycles to wait for read request signal to update after issuing the read clear signal Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_WR_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH0_STATIC_REG4_WR_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG4) Number of peripheral to write from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_WR_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH0_STATIC_REG4_WR_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH0_STATIC_REG4) Number of cycles to wait for write request signal to update after issuing the write clear signal Mask */
...
#define PROV_DMA_CTRL_CH0_STATIC_REG4_MASK  _U_(0x71F071F)                                 /**< \deprecated (PROV_DMA_CTRL_CH0_STATIC_REG4) Register MASK  (Use PROV_DMA_CTRL_CH0_STATIC_REG4_Msk instead)  */
#define PROV_DMA_CTRL_CH0_STATIC_REG4_Msk   _U_(0x71F071F)                                 /**< (PROV_DMA_CTRL_CH0_STATIC_REG4) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_RESRICT_REG) Channel 0 Restrictions Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_RD_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_RD_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Read start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_WR_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_WR_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Write start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Burst sizes can equal data buffer size, otherwise max burst is half data buffer size Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_FULL_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_FULL_BURST_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Maximum burst of 16 strobes can be used (joint mode only) Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_JOINT_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_ALLOW_JOINT_BURST_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Joint bursts are currently active Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_SIMPLE_MEM_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_RESRICT_REG_SIMPLE_MEM_Pos)  /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Configuration is aligned and peripherals are not used Mask */
...
#define PROV_DMA_CTRL_CH0_RESRICT_REG_MASK  _U_(0x11F)                                     /**< \deprecated (PROV_DMA_CTRL_CH0_RESRICT_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_RESRICT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_RESRICT_REG_Msk   _U_(0x11F)                                     /**< (PROV_DMA_CTRL_CH0_RESRICT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG) Channel 0 FIFO Fullness Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_RD_GAP_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_RD_GAP_Pos)  /**< (PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG) Remaining space (in bytes) in FIFO for read data Mask */
...
#define PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_WR_FULLNESS_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_WR_FULLNESS_Pos)  /**< (PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG) Occupied space (in bytes) in FIFO by write data Mask */
...
#define PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_MASK _U_(0x1FFF1FFF)                                /**< \deprecated (PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG_Msk _U_(0x1FFF1FFF)                                /**< (PROV_DMA_CTRL_CH0_FIFO_FULLNESS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CH_ENABLE_REG_RESETVALUE _U_(0x01)                                     /**<  (PROV_DMA_CTRL_CH0_CH_ENABLE_REG) Channel 0 Channel Enable Register  Reset Value */

#define PROV_DMA_CTRL_CH0_CH_ENABLE_REG_CH0_CH_ENABLE_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH0_CH_ENABLE_REG)  Position */
#define PROV_DMA_CTRL_CH0_CH_ENABLE_REG_CH0_CH_ENABLE_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CH_ENABLE_REG_CH0_CH_ENABLE_REG_Pos)  /**< (PROV_DMA_CTRL_CH0_CH_ENABLE_REG)  Mask */
...
#define PROV_DMA_CTRL_CH0_CH_ENABLE_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_CH_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_CH_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CH_ENABLE_REG_Msk _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH0_CH_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CH_START_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CH_START_REG) Channel 0 Channel Start Register  Reset Value */

#define PROV_DMA_CTRL_CH0_CH_START_REG_CH0_CH_START_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH0_CH_START_REG)  Position */
#define PROV_DMA_CTRL_CH0_CH_START_REG_CH0_CH_START_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CH_START_REG_CH0_CH_START_REG_Pos)  /**< (PROV_DMA_CTRL_CH0_CH_START_REG)  Mask */
...
#define PROV_DMA_CTRL_CH0_CH_START_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_CH_START_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_CH_START_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CH_START_REG_Msk  _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH0_CH_START_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_CH_ACTIVE_REG) Channel 0 Channel Active Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_CH_RD_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_CH_RD_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH0_CH_ACTIVE_REG) Set if channel is enabled and all read data has been received Mask */
...
#define PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_CH_WR_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_CH_WR_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH0_CH_ACTIVE_REG) Set if channel is enabled and all write data has been transfered Mask */
...
#define PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_MASK _U_(0x03)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_CH_ACTIVE_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_CH_ACTIVE_REG_Msk _U_(0x03)                                      /**< (PROV_DMA_CTRL_CH0_CH_ACTIVE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_COUNT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_COUNT_REG) Channel 0 Buffer Counter Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH0_COUNT_REG_BUFF_COUNT_Msk (_U_(0xFFF) << PROV_DMA_CTRL_CH0_COUNT_REG_BUFF_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH0_COUNT_REG) Number of buffers transferred by channel since started Mask */
...
#define PROV_DMA_CTRL_CH0_COUNT_REG_INT_COUNT_Msk (_U_(0xF) << PROV_DMA_CTRL_CH0_COUNT_REG_INT_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH0_COUNT_REG) Number of unserviced end interrupts Mask */
...
#define PROV_DMA_CTRL_CH0_COUNT_REG_MASK    _U_(0xF0FFF)                                   /**< \deprecated (PROV_DMA_CTRL_CH0_COUNT_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_COUNT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_COUNT_REG_Msk     _U_(0xF0FFF)                                   /**< (PROV_DMA_CTRL_CH0_COUNT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Channel 0 Interrupt Raw Status (Write 1 to any field to issue interrupt)  Reset Value */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH0_INT_RAWSTAT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Channel 0 Interrupt Clear (Write 1 to clear)  Reset Value */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clear channel end interrupt. Decrements INT_COUNT register Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clear AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clear AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clears FIFO overflow Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clears FIFO underflow Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clears Read Timeout Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clears Write Timeout Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_CLEAR_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Clears WDT Mask */
...
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_INT_CLEAR_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_INT_CLEAR_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH0_INT_CLEAR_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Channel 0 Interrupt Enable  Reset Value */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables end of channel interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables AHB read slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables AHB write slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables FIFO overflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables FIFO underflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables AHB Read timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables AHB Write timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_ENABLE_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Enables WDT interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_INT_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_INT_ENABLE_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH0_INT_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Channel 0 Interrupt Status  Reset Value */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH0_INT_STATUS_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Register MASK  (Use PROV_DMA_CTRL_CH0_INT_STATUS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH0_INT_STATUS_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH0_INT_STATUS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CMD_REG0_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CMD_REG0) Channel 1 First Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH1_CMD_REG0_RD_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH1_CMD_REG0) Start Address of Read Buffer Position */
#define PROV_DMA_CTRL_CH1_CMD_REG0_RD_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH1_CMD_REG0_RD_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG0) Start Address of Read Buffer Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG0_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH1_CMD_REG0) Register MASK  (Use PROV_DMA_CTRL_CH1_CMD_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CMD_REG0_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH1_CMD_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CMD_REG1_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CMD_REG1) Channel 1 Second Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH1_CMD_REG1_WR_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH1_CMD_REG1) Start Address of Write Buffer Position */
#define PROV_DMA_CTRL_CH1_CMD_REG1_WR_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH1_CMD_REG1_WR_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG1) Start Address of Write Buffer Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG1_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH1_CMD_REG1) Register MASK  (Use PROV_DMA_CTRL_CH1_CMD_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CMD_REG1_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH1_CMD_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CMD_REG2_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CMD_REG2) Channel 1 Third Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH1_CMD_REG2_BUFFER_SIZE_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH1_CMD_REG2_BUFFER_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG2) Size (in Bytes) of Buffer to Transfer Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG2_MASK     _U_(0x1FFF)                                    /**< \deprecated (PROV_DMA_CTRL_CH1_CMD_REG2) Register MASK  (Use PROV_DMA_CTRL_CH1_CMD_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CMD_REG2_Msk      _U_(0x1FFF)                                    /**< (PROV_DMA_CTRL_CH1_CMD_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CMD_REG3_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CMD_REG3) Channel 1 Fourth Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH1_CMD_REG3_CMD_SET_INT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CMD_REG3_CMD_SET_INT_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG3) Active High Interrupt Enable once buffer has been transfered Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG3_CMD_LAST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CMD_REG3_CMD_LAST_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG3) If set, channel stops when buffer done, otherwise load from CMD_NEXT_ADDR Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG3_CMD_NEXT_ADDR_Msk (_U_(0x3FFFFFFF) << PROV_DMA_CTRL_CH1_CMD_REG3_CMD_NEXT_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH1_CMD_REG3) Address of next command if CMD_LAST is not set Mask */
...
#define PROV_DMA_CTRL_CH1_CMD_REG3_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH1_CMD_REG3) Register MASK  (Use PROV_DMA_CTRL_CH1_CMD_REG3_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CMD_REG3_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH1_CMD_REG3) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG0_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH1_STATIC_REG0) Channel 1 Static Configuration Read  Reset Value */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG0_RD_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH1_STATIC_REG0_RD_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG0) Maximum number of bytes of an AHB read burst Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG0_RD_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH1_STATIC_REG0_RD_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG0) Number of AHB read commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG0_RD_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_STATIC_REG0_RD_INCR_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG0) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG0_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH1_STATIC_REG0) Register MASK  (Use PROV_DMA_CTRL_CH1_STATIC_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH1_STATIC_REG0_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH1_STATIC_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG1_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH1_STATIC_REG1) Channel 1 Static Configuration Write  Reset Value */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG1_WR_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH1_STATIC_REG1_WR_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG1) Maximum number of bytes of an AHB write burst Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG1_WR_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH1_STATIC_REG1_WR_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG1) Number of AHB write commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG1_WR_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_STATIC_REG1_WR_INCR_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG1) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG1_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH1_STATIC_REG1) Register MASK  (Use PROV_DMA_CTRL_CH1_STATIC_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH1_STATIC_REG1_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH1_STATIC_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG2_RESETVALUE _U_(0x10000)                                  /**<  (PROV_DMA_CTRL_CH1_STATIC_REG2) Channel 1 Block Mode  Reset Value */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG2_JOINT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_STATIC_REG2_JOINT_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) If set channel will work in joint mode Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_Msk (_U_(0x3) << PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) Endianness Byte Swapping Mask */
...
#define   PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_0_Val _U_(0x0)                                       /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) No Swapping  */
#define   PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_1_Val _U_(0x1)                                       /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) Swap bytes within 16 bits  */
#define   PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_2_Val _U_(0x2)                                       /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) Swap bytes within 32 bits  */
#define   PROV_DMA_CTRL_CH1_STATIC_REG2_END_SWAP_3_Val _U_(0x3)                                       /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) Swap bytes within 64 bits  */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG2_MASK  _U_(0x30010000)                                /**< \deprecated (PROV_DMA_CTRL_CH1_STATIC_REG2) Register MASK  (Use PROV_DMA_CTRL_CH1_STATIC_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH1_STATIC_REG2_Msk   _U_(0x30010000)                                /**< (PROV_DMA_CTRL_CH1_STATIC_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_STATIC_REG4) Channel 1 Static Configuration Peripheral  Reset Value */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_RD_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH1_STATIC_REG4_RD_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG4) Number of peripheral to read from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_RD_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH1_STATIC_REG4_RD_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG4) Number of cycles to wait for read request signal to update after issuing the read clear signal Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_WR_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH1_STATIC_REG4_WR_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG4) Number of peripheral to write from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_WR_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH1_STATIC_REG4_WR_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH1_STATIC_REG4) Number of cycles to wait for write request signal to update after issuing the write clear signal Mask */
...
#define PROV_DMA_CTRL_CH1_STATIC_REG4_MASK  _U_(0x71F071F)                                 /**< \deprecated (PROV_DMA_CTRL_CH1_STATIC_REG4) Register MASK  (Use PROV_DMA_CTRL_CH1_STATIC_REG4_Msk instead)  */
#define PROV_DMA_CTRL_CH1_STATIC_REG4_Msk   _U_(0x71F071F)                                 /**< (PROV_DMA_CTRL_CH1_STATIC_REG4) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_RESRICT_REG) Channel 1 Restrictions Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_RD_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_RD_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Read start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_WR_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_WR_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Write start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Burst sizes can equal data buffer size, otherwise max burst is half data buffer size Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_FULL_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_FULL_BURST_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Maximum burst of 16 strobes can be used (joint mode only) Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_JOINT_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_ALLOW_JOINT_BURST_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Joint bursts are currently active Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_SIMPLE_MEM_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_RESRICT_REG_SIMPLE_MEM_Pos)  /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Configuration is aligned and peripherals are not used Mask */
...
#define PROV_DMA_CTRL_CH1_RESRICT_REG_MASK  _U_(0x11F)                                     /**< \deprecated (PROV_DMA_CTRL_CH1_RESRICT_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_RESRICT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_RESRICT_REG_Msk   _U_(0x11F)                                     /**< (PROV_DMA_CTRL_CH1_RESRICT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG) Channel 1 FIFO Fullness Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_RD_GAP_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_RD_GAP_Pos)  /**< (PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG) Remaining space (in bytes) in FIFO for read data Mask */
...
#define PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_WR_FULLNESS_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_WR_FULLNESS_Pos)  /**< (PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG) Occupied space (in bytes) in FIFO by write data Mask */
...
#define PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_MASK _U_(0x1FFF1FFF)                                /**< \deprecated (PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG_Msk _U_(0x1FFF1FFF)                                /**< (PROV_DMA_CTRL_CH1_FIFO_FULLNESS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CH_ENABLE_REG_RESETVALUE _U_(0x01)                                     /**<  (PROV_DMA_CTRL_CH1_CH_ENABLE_REG) Channel 1 Channel Enable Register  Reset Value */

#define PROV_DMA_CTRL_CH1_CH_ENABLE_REG_CH1_CH_ENABLE_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH1_CH_ENABLE_REG)  Position */
#define PROV_DMA_CTRL_CH1_CH_ENABLE_REG_CH1_CH_ENABLE_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CH_ENABLE_REG_CH1_CH_ENABLE_REG_Pos)  /**< (PROV_DMA_CTRL_CH1_CH_ENABLE_REG)  Mask */
...
#define PROV_DMA_CTRL_CH1_CH_ENABLE_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_CH_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_CH_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CH_ENABLE_REG_Msk _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH1_CH_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CH_START_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CH_START_REG) Channel 1 Channel Start Register  Reset Value */

#define PROV_DMA_CTRL_CH1_CH_START_REG_CH1_CH_START_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH1_CH_START_REG)  Position */
#define PROV_DMA_CTRL_CH1_CH_START_REG_CH1_CH_START_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CH_START_REG_CH1_CH_START_REG_Pos)  /**< (PROV_DMA_CTRL_CH1_CH_START_REG)  Mask */
...
#define PROV_DMA_CTRL_CH1_CH_START_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_CH_START_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_CH_START_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CH_START_REG_Msk  _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH1_CH_START_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_CH_ACTIVE_REG) Channel 1 Channel Active Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_CH_RD_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_CH_RD_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH1_CH_ACTIVE_REG) Set if channel is enabled and all read data has been received Mask */
...
#define PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_CH_WR_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_CH_WR_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH1_CH_ACTIVE_REG) Set if channel is enabled and all write data has been transfered Mask */
...
#define PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_MASK _U_(0x03)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_CH_ACTIVE_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_CH_ACTIVE_REG_Msk _U_(0x03)                                      /**< (PROV_DMA_CTRL_CH1_CH_ACTIVE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_COUNT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_COUNT_REG) Channel 1 Buffer Counter Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH1_COUNT_REG_BUFF_COUNT_Msk (_U_(0xFFF) << PROV_DMA_CTRL_CH1_COUNT_REG_BUFF_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH1_COUNT_REG) Number of buffers transferred by channel since started Mask */
...
#define PROV_DMA_CTRL_CH1_COUNT_REG_INT_COUNT_Msk (_U_(0xF) << PROV_DMA_CTRL_CH1_COUNT_REG_INT_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH1_COUNT_REG) Number of unserviced end interrupts Mask */
...
#define PROV_DMA_CTRL_CH1_COUNT_REG_MASK    _U_(0xF0FFF)                                   /**< \deprecated (PROV_DMA_CTRL_CH1_COUNT_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_COUNT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_COUNT_REG_Msk     _U_(0xF0FFF)                                   /**< (PROV_DMA_CTRL_CH1_COUNT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Channel 1 Interrupt Raw Status (Write 1 to any field to issue interrupt)  Reset Value */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH1_INT_RAWSTAT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Channel 1 Interrupt Clear (Write 1 to clear)  Reset Value */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clear channel end interrupt. Decrements INT_COUNT register Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clear AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clear AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clears FIFO overflow Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clears FIFO underflow Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clears Read Timeout Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clears Write Timeout Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_CLEAR_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Clears WDT Mask */
...
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_INT_CLEAR_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_INT_CLEAR_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH1_INT_CLEAR_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Channel 1 Interrupt Enable  Reset Value */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables end of channel interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables AHB read slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables AHB write slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables FIFO overflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables FIFO underflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables AHB Read timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables AHB Write timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_ENABLE_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Enables WDT interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_INT_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_INT_ENABLE_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH1_INT_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Channel 1 Interrupt Status  Reset Value */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH1_INT_STATUS_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Register MASK  (Use PROV_DMA_CTRL_CH1_INT_STATUS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH1_INT_STATUS_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH1_INT_STATUS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CMD_REG0_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CMD_REG0) Channel 2 First Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH2_CMD_REG0_RD_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH2_CMD_REG0) Start Address of Read Buffer Position */
#define PROV_DMA_CTRL_CH2_CMD_REG0_RD_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH2_CMD_REG0_RD_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG0) Start Address of Read Buffer Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG0_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH2_CMD_REG0) Register MASK  (Use PROV_DMA_CTRL_CH2_CMD_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CMD_REG0_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH2_CMD_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CMD_REG1_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CMD_REG1) Channel 2 Second Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH2_CMD_REG1_WR_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH2_CMD_REG1) Start Address of Write Buffer Position */
#define PROV_DMA_CTRL_CH2_CMD_REG1_WR_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH2_CMD_REG1_WR_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG1) Start Address of Write Buffer Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG1_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH2_CMD_REG1) Register MASK  (Use PROV_DMA_CTRL_CH2_CMD_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CMD_REG1_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH2_CMD_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CMD_REG2_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CMD_REG2) Channel 2 Third Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH2_CMD_REG2_BUFFER_SIZE_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH2_CMD_REG2_BUFFER_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG2) Size (in Bytes) of Buffer to Transfer Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG2_MASK     _U_(0x1FFF)                                    /**< \deprecated (PROV_DMA_CTRL_CH2_CMD_REG2) Register MASK  (Use PROV_DMA_CTRL_CH2_CMD_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CMD_REG2_Msk      _U_(0x1FFF)                                    /**< (PROV_DMA_CTRL_CH2_CMD_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CMD_REG3_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CMD_REG3) Channel 2 Fourth Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH2_CMD_REG3_CMD_SET_INT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CMD_REG3_CMD_SET_INT_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG3) Active High Interrupt Enable once buffer has been transfered Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG3_CMD_LAST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CMD_REG3_CMD_LAST_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG3) If set, channel stops when buffer done, otherwise load from CMD_NEXT_ADDR Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG3_CMD_NEXT_ADDR_Msk (_U_(0x3FFFFFFF) << PROV_DMA_CTRL_CH2_CMD_REG3_CMD_NEXT_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH2_CMD_REG3) Address of next command if CMD_LAST is not set Mask */
...
#define PROV_DMA_CTRL_CH2_CMD_REG3_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH2_CMD_REG3) Register MASK  (Use PROV_DMA_CTRL_CH2_CMD_REG3_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CMD_REG3_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH2_CMD_REG3) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG0_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH2_STATIC_REG0) Channel 2 Static Configuration Read  Reset Value */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG0_RD_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH2_STATIC_REG0_RD_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG0) Maximum number of bytes of an AHB read burst Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG0_RD_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH2_STATIC_REG0_RD_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG0) Number of AHB read commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG0_RD_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_STATIC_REG0_RD_INCR_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG0) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG0_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH2_STATIC_REG0) Register MASK  (Use PROV_DMA_CTRL_CH2_STATIC_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH2_STATIC_REG0_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH2_STATIC_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG1_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH2_STATIC_REG1) Channel 2 Static Configuration Write  Reset Value */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG1_WR_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH2_STATIC_REG1_WR_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG1) Maximum number of bytes of an AHB write burst Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG1_WR_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH2_STATIC_REG1_WR_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG1) Number of AHB write commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG1_WR_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_STATIC_REG1_WR_INCR_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG1) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG1_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH2_STATIC_REG1) Register MASK  (Use PROV_DMA_CTRL_CH2_STATIC_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH2_STATIC_REG1_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH2_STATIC_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG2_RESETVALUE _U_(0x10000)                                  /**<  (PROV_DMA_CTRL_CH2_STATIC_REG2) Channel 2 Block Mode  Reset Value */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG2_JOINT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_STATIC_REG2_JOINT_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) If set channel will work in joint mode Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_Msk (_U_(0x3) << PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) Endianness Byte Swapping Mask */
...
#define   PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_0_Val _U_(0x0)                                       /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) No Swapping  */
#define   PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_1_Val _U_(0x1)                                       /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) Swap bytes within 16 bits  */
#define   PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_2_Val _U_(0x2)                                       /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) Swap bytes within 32 bits  */
#define   PROV_DMA_CTRL_CH2_STATIC_REG2_END_SWAP_3_Val _U_(0x3)                                       /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) Swap bytes within 64 bits  */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG2_MASK  _U_(0x30010000)                                /**< \deprecated (PROV_DMA_CTRL_CH2_STATIC_REG2) Register MASK  (Use PROV_DMA_CTRL_CH2_STATIC_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH2_STATIC_REG2_Msk   _U_(0x30010000)                                /**< (PROV_DMA_CTRL_CH2_STATIC_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_STATIC_REG4) Channel 2 Static Configuration Peripheral  Reset Value */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_RD_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH2_STATIC_REG4_RD_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG4) Number of peripheral to read from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_RD_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH2_STATIC_REG4_RD_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG4) Number of cycles to wait for read request signal to update after issuing the read clear signal Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_WR_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH2_STATIC_REG4_WR_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG4) Number of peripheral to write from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_WR_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH2_STATIC_REG4_WR_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH2_STATIC_REG4) Number of cycles to wait for write request signal to update after issuing the write clear signal Mask */
...
#define PROV_DMA_CTRL_CH2_STATIC_REG4_MASK  _U_(0x71F071F)                                 /**< \deprecated (PROV_DMA_CTRL_CH2_STATIC_REG4) Register MASK  (Use PROV_DMA_CTRL_CH2_STATIC_REG4_Msk instead)  */
#define PROV_DMA_CTRL_CH2_STATIC_REG4_Msk   _U_(0x71F071F)                                 /**< (PROV_DMA_CTRL_CH2_STATIC_REG4) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_RESRICT_REG) Channel 2 Restrictions Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_RD_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_RD_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Read start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_WR_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_WR_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Write start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Burst sizes can equal data buffer size, otherwise max burst is half data buffer size Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_FULL_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_FULL_BURST_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Maximum burst of 16 strobes can be used (joint mode only) Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_JOINT_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_ALLOW_JOINT_BURST_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Joint bursts are currently active Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_SIMPLE_MEM_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_RESRICT_REG_SIMPLE_MEM_Pos)  /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Configuration is aligned and peripherals are not used Mask */
...
#define PROV_DMA_CTRL_CH2_RESRICT_REG_MASK  _U_(0x11F)                                     /**< \deprecated (PROV_DMA_CTRL_CH2_RESRICT_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_RESRICT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_RESRICT_REG_Msk   _U_(0x11F)                                     /**< (PROV_DMA_CTRL_CH2_RESRICT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG) Channel 2 FIFO Fullness Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_RD_GAP_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_RD_GAP_Pos)  /**< (PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG) Remaining space (in bytes) in FIFO for read data Mask */
...
#define PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_WR_FULLNESS_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_WR_FULLNESS_Pos)  /**< (PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG) Occupied space (in bytes) in FIFO by write data Mask */
...
#define PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_MASK _U_(0x1FFF1FFF)                                /**< \deprecated (PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG_Msk _U_(0x1FFF1FFF)                                /**< (PROV_DMA_CTRL_CH2_FIFO_FULLNESS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CH_ENABLE_REG_RESETVALUE _U_(0x01)                                     /**<  (PROV_DMA_CTRL_CH2_CH_ENABLE_REG) Channel 2 Channel Enable Register  Reset Value */

#define PROV_DMA_CTRL_CH2_CH_ENABLE_REG_CH2_CH_ENABLE_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH2_CH_ENABLE_REG)  Position */
#define PROV_DMA_CTRL_CH2_CH_ENABLE_REG_CH2_CH_ENABLE_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CH_ENABLE_REG_CH2_CH_ENABLE_REG_Pos)  /**< (PROV_DMA_CTRL_CH2_CH_ENABLE_REG)  Mask */
...
#define PROV_DMA_CTRL_CH2_CH_ENABLE_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_CH_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_CH_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CH_ENABLE_REG_Msk _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH2_CH_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CH_START_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CH_START_REG) Channel 2 Channel Start Register  Reset Value */

#define PROV_DMA_CTRL_CH2_CH_START_REG_CH2_CH_START_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH2_CH_START_REG)  Position */
#define PROV_DMA_CTRL_CH2_CH_START_REG_CH2_CH_START_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CH_START_REG_CH2_CH_START_REG_Pos)  /**< (PROV_DMA_CTRL_CH2_CH_START_REG)  Mask */
...
#define PROV_DMA_CTRL_CH2_CH_START_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_CH_START_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_CH_START_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CH_START_REG_Msk  _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH2_CH_START_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_CH_ACTIVE_REG) Channel 2 Channel Active Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_CH_RD_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_CH_RD_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH2_CH_ACTIVE_REG) Set if channel is enabled and all read data has been received Mask */
...
#define PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_CH_WR_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_CH_WR_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH2_CH_ACTIVE_REG) Set if channel is enabled and all write data has been transfered Mask */
...
#define PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_MASK _U_(0x03)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_CH_ACTIVE_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_CH_ACTIVE_REG_Msk _U_(0x03)                                      /**< (PROV_DMA_CTRL_CH2_CH_ACTIVE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_COUNT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_COUNT_REG) Channel 2 Buffer Counter Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH2_COUNT_REG_BUFF_COUNT_Msk (_U_(0xFFF) << PROV_DMA_CTRL_CH2_COUNT_REG_BUFF_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH2_COUNT_REG) Number of buffers transferred by channel since started Mask */
...
#define PROV_DMA_CTRL_CH2_COUNT_REG_INT_COUNT_Msk (_U_(0xF) << PROV_DMA_CTRL_CH2_COUNT_REG_INT_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH2_COUNT_REG) Number of unserviced end interrupts Mask */
...
#define PROV_DMA_CTRL_CH2_COUNT_REG_MASK    _U_(0xF0FFF)                                   /**< \deprecated (PROV_DMA_CTRL_CH2_COUNT_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_COUNT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_COUNT_REG_Msk     _U_(0xF0FFF)                                   /**< (PROV_DMA_CTRL_CH2_COUNT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Channel 2 Interrupt Raw Status (Write 1 to any field to issue interrupt)  Reset Value */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH2_INT_RAWSTAT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Channel 2 Interrupt Clear (Write 1 to clear)  Reset Value */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clear channel end interrupt. Decrements INT_COUNT register Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clear AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clear AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clears FIFO overflow Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clears FIFO underflow Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clears Read Timeout Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clears Write Timeout Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_CLEAR_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Clears WDT Mask */
...
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_INT_CLEAR_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_INT_CLEAR_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH2_INT_CLEAR_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Channel 2 Interrupt Enable  Reset Value */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables end of channel interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables AHB read slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables AHB write slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables FIFO overflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables FIFO underflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables AHB Read timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables AHB Write timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_ENABLE_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Enables WDT interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_INT_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_INT_ENABLE_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH2_INT_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Channel 2 Interrupt Status  Reset Value */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH2_INT_STATUS_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Register MASK  (Use PROV_DMA_CTRL_CH2_INT_STATUS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH2_INT_STATUS_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH2_INT_STATUS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CMD_REG0_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CMD_REG0) Channel 3 First Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH3_CMD_REG0_RD_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH3_CMD_REG0) Start Address of Read Buffer Position */
#define PROV_DMA_CTRL_CH3_CMD_REG0_RD_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH3_CMD_REG0_RD_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG0) Start Address of Read Buffer Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG0_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH3_CMD_REG0) Register MASK  (Use PROV_DMA_CTRL_CH3_CMD_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CMD_REG0_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH3_CMD_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CMD_REG1_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CMD_REG1) Channel 3 Second Line Channel Command  Reset Value */

#define PROV_DMA_CTRL_CH3_CMD_REG1_WR_START_ADDR_Pos 0                                              /**< (PROV_DMA_CTRL_CH3_CMD_REG1) Start Address of Write Buffer Position */
#define PROV_DMA_CTRL_CH3_CMD_REG1_WR_START_ADDR_Msk (_U_(0xFFFFFFFF) << PROV_DMA_CTRL_CH3_CMD_REG1_WR_START_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG1) Start Address of Write Buffer Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG1_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH3_CMD_REG1) Register MASK  (Use PROV_DMA_CTRL_CH3_CMD_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CMD_REG1_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH3_CMD_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CMD_REG2_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CMD_REG2) Channel 3 Third Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH3_CMD_REG2_BUFFER_SIZE_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH3_CMD_REG2_BUFFER_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG2) Size (in Bytes) of Buffer to Transfer Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG2_MASK     _U_(0x1FFF)                                    /**< \deprecated (PROV_DMA_CTRL_CH3_CMD_REG2) Register MASK  (Use PROV_DMA_CTRL_CH3_CMD_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CMD_REG2_Msk      _U_(0x1FFF)                                    /**< (PROV_DMA_CTRL_CH3_CMD_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CMD_REG3_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CMD_REG3) Channel 3 Fourth Line Channel Command  Reset Value */
...
#define PROV_DMA_CTRL_CH3_CMD_REG3_CMD_SET_INT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CMD_REG3_CMD_SET_INT_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG3) Active High Interrupt Enable once buffer has been transfered Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG3_CMD_LAST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CMD_REG3_CMD_LAST_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG3) If set, channel stops when buffer done, otherwise load from CMD_NEXT_ADDR Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG3_CMD_NEXT_ADDR_Msk (_U_(0x3FFFFFFF) << PROV_DMA_CTRL_CH3_CMD_REG3_CMD_NEXT_ADDR_Pos)  /**< (PROV_DMA_CTRL_CH3_CMD_REG3) Address of next command if CMD_LAST is not set Mask */
...
#define PROV_DMA_CTRL_CH3_CMD_REG3_MASK     _U_(0xFFFFFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CH3_CMD_REG3) Register MASK  (Use PROV_DMA_CTRL_CH3_CMD_REG3_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CMD_REG3_Msk      _U_(0xFFFFFFFF)                                /**< (PROV_DMA_CTRL_CH3_CMD_REG3) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG0_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH3_STATIC_REG0) Channel 3 Static Configuration Read  Reset Value */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG0_RD_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH3_STATIC_REG0_RD_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG0) Maximum number of bytes of an AHB read burst Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG0_RD_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH3_STATIC_REG0_RD_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG0) Number of AHB read commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG0_RD_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_STATIC_REG0_RD_INCR_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG0) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG0_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH3_STATIC_REG0) Register MASK  (Use PROV_DMA_CTRL_CH3_STATIC_REG0_Msk instead)  */
#define PROV_DMA_CTRL_CH3_STATIC_REG0_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH3_STATIC_REG0) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG1_RESETVALUE _U_(0x80010000)                               /**<  (PROV_DMA_CTRL_CH3_STATIC_REG1) Channel 3 Static Configuration Write  Reset Value */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG1_WR_BURST_MAX_SIZE_Msk (_U_(0x7F) << PROV_DMA_CTRL_CH3_STATIC_REG1_WR_BURST_MAX_SIZE_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG1) Maximum number of bytes of an AHB write burst Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG1_WR_TOKENS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CH3_STATIC_REG1_WR_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG1) Number of AHB write commands to issue before channel is released Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG1_WR_INCR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_STATIC_REG1_WR_INCR_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG1) If set the controller will increment the next burst address Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG1_MASK  _U_(0x803F007F)                                /**< \deprecated (PROV_DMA_CTRL_CH3_STATIC_REG1) Register MASK  (Use PROV_DMA_CTRL_CH3_STATIC_REG1_Msk instead)  */
#define PROV_DMA_CTRL_CH3_STATIC_REG1_Msk   _U_(0x803F007F)                                /**< (PROV_DMA_CTRL_CH3_STATIC_REG1) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG2_RESETVALUE _U_(0x10000)                                  /**<  (PROV_DMA_CTRL_CH3_STATIC_REG2) Channel 3 Block Mode  Reset Value */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG2_JOINT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_STATIC_REG2_JOINT_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) If set channel will work in joint mode Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_Msk (_U_(0x3) << PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) Endianness Byte Swapping Mask */
...
#define   PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_0_Val _U_(0x0)                                       /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) No Swapping  */
#define   PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_1_Val _U_(0x1)                                       /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) Swap bytes within 16 bits  */
#define   PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_2_Val _U_(0x2)                                       /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) Swap bytes within 32 bits  */
#define   PROV_DMA_CTRL_CH3_STATIC_REG2_END_SWAP_3_Val _U_(0x3)                                       /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) Swap bytes within 64 bits  */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG2_MASK  _U_(0x30010000)                                /**< \deprecated (PROV_DMA_CTRL_CH3_STATIC_REG2) Register MASK  (Use PROV_DMA_CTRL_CH3_STATIC_REG2_Msk instead)  */
#define PROV_DMA_CTRL_CH3_STATIC_REG2_Msk   _U_(0x30010000)                                /**< (PROV_DMA_CTRL_CH3_STATIC_REG2) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_STATIC_REG4) Channel 3 Static Configuration Peripheral  Reset Value */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_RD_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH3_STATIC_REG4_RD_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG4) Number of peripheral to read from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_RD_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH3_STATIC_REG4_RD_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG4) Number of cycles to wait for read request signal to update after issuing the read clear signal Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_WR_PERIPH_NUM_Msk (_U_(0x1F) << PROV_DMA_CTRL_CH3_STATIC_REG4_WR_PERIPH_NUM_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG4) Number of peripheral to write from (0 if memory or no peripheral flow control) Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_WR_PERIPH_DELAY_Msk (_U_(0x7) << PROV_DMA_CTRL_CH3_STATIC_REG4_WR_PERIPH_DELAY_Pos)  /**< (PROV_DMA_CTRL_CH3_STATIC_REG4) Number of cycles to wait for write request signal to update after issuing the write clear signal Mask */
...
#define PROV_DMA_CTRL_CH3_STATIC_REG4_MASK  _U_(0x71F071F)                                 /**< \deprecated (PROV_DMA_CTRL_CH3_STATIC_REG4) Register MASK  (Use PROV_DMA_CTRL_CH3_STATIC_REG4_Msk instead)  */
#define PROV_DMA_CTRL_CH3_STATIC_REG4_Msk   _U_(0x71F071F)                                 /**< (PROV_DMA_CTRL_CH3_STATIC_REG4) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_RESRICT_REG) Channel 3 Restrictions Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_RD_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_RD_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Read start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_WR_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_WR_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Write start address does not restrict burst size Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_FULL_FIFO_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_FULL_FIFO_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Burst sizes can equal data buffer size, otherwise max burst is half data buffer size Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_FULL_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_FULL_BURST_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Maximum burst of 16 strobes can be used (joint mode only) Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_JOINT_BURST_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_ALLOW_JOINT_BURST_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Joint bursts are currently active Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_SIMPLE_MEM_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_RESRICT_REG_SIMPLE_MEM_Pos)  /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Configuration is aligned and peripherals are not used Mask */
...
#define PROV_DMA_CTRL_CH3_RESRICT_REG_MASK  _U_(0x11F)                                     /**< \deprecated (PROV_DMA_CTRL_CH3_RESRICT_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_RESRICT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_RESRICT_REG_Msk   _U_(0x11F)                                     /**< (PROV_DMA_CTRL_CH3_RESRICT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG) Channel 3 FIFO Fullness Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_RD_GAP_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_RD_GAP_Pos)  /**< (PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG) Remaining space (in bytes) in FIFO for read data Mask */
...
#define PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_WR_FULLNESS_Msk (_U_(0x1FFF) << PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_WR_FULLNESS_Pos)  /**< (PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG) Occupied space (in bytes) in FIFO by write data Mask */
...
#define PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_MASK _U_(0x1FFF1FFF)                                /**< \deprecated (PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG_Msk _U_(0x1FFF1FFF)                                /**< (PROV_DMA_CTRL_CH3_FIFO_FULLNESS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CH_ENABLE_REG_RESETVALUE _U_(0x01)                                     /**<  (PROV_DMA_CTRL_CH3_CH_ENABLE_REG) Channel 3 Channel Enable Register  Reset Value */

#define PROV_DMA_CTRL_CH3_CH_ENABLE_REG_CH3_CH_ENABLE_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH3_CH_ENABLE_REG)  Position */
#define PROV_DMA_CTRL_CH3_CH_ENABLE_REG_CH3_CH_ENABLE_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CH_ENABLE_REG_CH3_CH_ENABLE_REG_Pos)  /**< (PROV_DMA_CTRL_CH3_CH_ENABLE_REG)  Mask */
...
#define PROV_DMA_CTRL_CH3_CH_ENABLE_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_CH_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_CH_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CH_ENABLE_REG_Msk _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH3_CH_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CH_START_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CH_START_REG) Channel 3 Channel Start Register  Reset Value */

#define PROV_DMA_CTRL_CH3_CH_START_REG_CH3_CH_START_REG_Pos 0                                              /**< (PROV_DMA_CTRL_CH3_CH_START_REG)  Position */
#define PROV_DMA_CTRL_CH3_CH_START_REG_CH3_CH_START_REG_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CH_START_REG_CH3_CH_START_REG_Pos)  /**< (PROV_DMA_CTRL_CH3_CH_START_REG)  Mask */
...
#define PROV_DMA_CTRL_CH3_CH_START_REG_MASK _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_CH_START_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_CH_START_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CH_START_REG_Msk  _U_(0x01)                                      /**< (PROV_DMA_CTRL_CH3_CH_START_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_CH_ACTIVE_REG) Channel 3 Channel Active Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_CH_RD_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_CH_RD_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH3_CH_ACTIVE_REG) Set if channel is enabled and all read data has been received Mask */
...
#define PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_CH_WR_ACTIVE_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_CH_WR_ACTIVE_Pos)  /**< (PROV_DMA_CTRL_CH3_CH_ACTIVE_REG) Set if channel is enabled and all write data has been transfered Mask */
...
#define PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_MASK _U_(0x03)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_CH_ACTIVE_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_CH_ACTIVE_REG_Msk _U_(0x03)                                      /**< (PROV_DMA_CTRL_CH3_CH_ACTIVE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_COUNT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_COUNT_REG) Channel 3 Buffer Counter Status Register  Reset Value */
...
#define PROV_DMA_CTRL_CH3_COUNT_REG_BUFF_COUNT_Msk (_U_(0xFFF) << PROV_DMA_CTRL_CH3_COUNT_REG_BUFF_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH3_COUNT_REG) Number of buffers transferred by channel since started Mask */
...
#define PROV_DMA_CTRL_CH3_COUNT_REG_INT_COUNT_Msk (_U_(0xF) << PROV_DMA_CTRL_CH3_COUNT_REG_INT_COUNT_Pos)  /**< (PROV_DMA_CTRL_CH3_COUNT_REG) Number of unserviced end interrupts Mask */
...
#define PROV_DMA_CTRL_CH3_COUNT_REG_MASK    _U_(0xF0FFF)                                   /**< \deprecated (PROV_DMA_CTRL_CH3_COUNT_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_COUNT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_COUNT_REG_Msk     _U_(0xF0FFF)                                   /**< (PROV_DMA_CTRL_CH3_COUNT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Channel 3 Interrupt Raw Status (Write 1 to any field to issue interrupt)  Reset Value */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH3_INT_RAWSTAT_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Channel 3 Interrupt Clear (Write 1 to clear)  Reset Value */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clear channel end interrupt. Decrements INT_COUNT register Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clear AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clear AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clears FIFO overflow Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clears FIFO underflow Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clears Read Timeout Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clears Write Timeout Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_CLEAR_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Clears WDT Mask */
...
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_INT_CLEAR_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_INT_CLEAR_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH3_INT_CLEAR_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Channel 3 Interrupt Enable  Reset Value */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables end of channel interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables AHB read slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables AHB write slave error interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables FIFO overflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables FIFO underflow interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables AHB Read timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables AHB Write timeout interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_ENABLE_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Enables WDT interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_INT_ENABLE_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_INT_ENABLE_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH3_INT_ENABLE_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Channel 3 Interrupt Status  Reset Value */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_CH_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_CH_END_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Indicates an unserviced channel end interrupt Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_RD_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_RD_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) AHB read slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_WR_SLVERR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_WR_SLVERR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) AHB write slave error Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_FIFO_OVERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_FIFO_OVERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) FIFO has been overflown Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_FIFO_UNDERFLOW_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_FIFO_UNDERFLOW_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) FIFO has been underflown Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_TIMEOUT_RD_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_TIMEOUT_RD_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Read timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_TIMEOUT_WR_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_TIMEOUT_WR_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Write timeout on AHB bus (timeout value fixed at 1024 cycles) Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CH3_INT_STATUS_REG_WDT_Pos)  /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Channel active but did not start a burst for 2048 cycles Mask */
...
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_MASK _U_(0xFF)                                      /**< \deprecated (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Register MASK  (Use PROV_DMA_CTRL_CH3_INT_STATUS_REG_Msk instead)  */
#define PROV_DMA_CTRL_CH3_INT_STATUS_REG_Msk _U_(0xFF)                                      /**< (PROV_DMA_CTRL_CH3_INT_STATUS_REG) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CORE_INT_STATUS) Indicates which channels caused interrupt  Reset Value */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_0_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_0_Pos)  /**< (PROV_DMA_CTRL_CORE_INT_STATUS) Indicates channel 0 caused interrupt Mask */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_1_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_1_Pos)  /**< (PROV_DMA_CTRL_CORE_INT_STATUS) Indicates channel 1 caused interrupt Mask */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_2_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_2_Pos)  /**< (PROV_DMA_CTRL_CORE_INT_STATUS) Indicates channel 2 caused interrupt Mask */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_3_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL_3_Pos)  /**< (PROV_DMA_CTRL_CORE_INT_STATUS) Indicates channel 3 caused interrupt Mask */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_MASK  _U_(0x0F)                                      /**< \deprecated (PROV_DMA_CTRL_CORE_INT_STATUS) Register MASK  (Use PROV_DMA_CTRL_CORE_INT_STATUS_Msk instead)  */
#define PROV_DMA_CTRL_CORE_INT_STATUS_Msk   _U_(0x0F)                                      /**< (PROV_DMA_CTRL_CORE_INT_STATUS) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL__Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_INT_STATUS_CHANNEL__Pos)  /**< (PROV_DMA_CTRL_CORE_INT_STATUS Mask) CHANNEL_ */
...
#define PROV_DMA_CTRL_CORE_JOINT_MODE_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CORE_JOINT_MODE) If set, core works in joint mode  Reset Value */

#define PROV_DMA_CTRL_CORE_JOINT_MODE_CORE_JOINT_MODE_Pos 0                                              /**< (PROV_DMA_CTRL_CORE_JOINT_MODE)  Position */
#define PROV_DMA_CTRL_CORE_JOINT_MODE_CORE_JOINT_MODE_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_JOINT_MODE_CORE_JOINT_MODE_Pos)  /**< (PROV_DMA_CTRL_CORE_JOINT_MODE)  Mask */
...
#define PROV_DMA_CTRL_CORE_JOINT_MODE_MASK  _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CORE_JOINT_MODE) Register MASK  (Use PROV_DMA_CTRL_CORE_JOINT_MODE_Msk instead)  */
#define PROV_DMA_CTRL_CORE_JOINT_MODE_Msk   _U_(0x01)                                      /**< (PROV_DMA_CTRL_CORE_JOINT_MODE) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CORE_PRIORITY) Core Priority Channels  Reset Value */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_TOP_NUM_Msk (_U_(0x7) << PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_TOP_NUM_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Read Top Priority Channel Number Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_TOP_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_TOP_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Read Top Priority Enable Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_HIGH_NUM_Msk (_U_(0x7) << PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_HIGH_NUM_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Read High Priority Channel Number Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_HIGH_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_PRIORITY_RD_PRIO_HIGH_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Read High Priority Enable Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_TOP_NUM_Msk (_U_(0x7) << PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_TOP_NUM_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Write Top Priority Channel Number Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_TOP_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_TOP_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Write Top Priority Enable Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_HIGH_NUM_Msk (_U_(0x7) << PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_HIGH_NUM_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Write High Priority Channel Number Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_HIGH_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_PRIORITY_WR_PRIO_HIGH_Pos)  /**< (PROV_DMA_CTRL_CORE_PRIORITY) Core Write High Priority Enable Mask */
...
#define PROV_DMA_CTRL_CORE_PRIORITY_MASK    _U_(0xFFFF)                                    /**< \deprecated (PROV_DMA_CTRL_CORE_PRIORITY) Register MASK  (Use PROV_DMA_CTRL_CORE_PRIORITY_Msk instead)  */
#define PROV_DMA_CTRL_CORE_PRIORITY_Msk     _U_(0xFFFF)                                    /**< (PROV_DMA_CTRL_CORE_PRIORITY) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_CLKDIV_RESETVALUE _U_(0x01)                                     /**<  (PROV_DMA_CTRL_CORE_CLKDIV) Ratio between main clock and core clock  Reset Value */

#define PROV_DMA_CTRL_CORE_CLKDIV_CORE_CLKDIV_Pos 0                                              /**< (PROV_DMA_CTRL_CORE_CLKDIV)  Position */
#define PROV_DMA_CTRL_CORE_CLKDIV_CORE_CLKDIV_Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_CLKDIV_CORE_CLKDIV_Pos)  /**< (PROV_DMA_CTRL_CORE_CLKDIV)  Mask */
...
#define PROV_DMA_CTRL_CORE_CLKDIV_MASK      _U_(0x0F)                                      /**< \deprecated (PROV_DMA_CTRL_CORE_CLKDIV) Register MASK  (Use PROV_DMA_CTRL_CORE_CLKDIV_Msk instead)  */
#define PROV_DMA_CTRL_CORE_CLKDIV_Msk       _U_(0x0F)                                      /**< (PROV_DMA_CTRL_CORE_CLKDIV) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_CH_START_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CORE_CH_START) Channel Start  Reset Value */

#define PROV_DMA_CTRL_CORE_CH_START_CH_0_Pos 0                                              /**< (PROV_DMA_CTRL_CORE_CH_START) Starts Channel 0 Position */
#define PROV_DMA_CTRL_CORE_CH_START_CH_0_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_CH_START_CH_0_Pos)  /**< (PROV_DMA_CTRL_CORE_CH_START) Starts Channel 0 Mask */
...
#define PROV_DMA_CTRL_CORE_CH_START_CH_1_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_CH_START_CH_1_Pos)  /**< (PROV_DMA_CTRL_CORE_CH_START) Starts Channel 1 Mask */
...
#define PROV_DMA_CTRL_CORE_CH_START_CH_2_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_CH_START_CH_2_Pos)  /**< (PROV_DMA_CTRL_CORE_CH_START) Starts Channel 2 Mask */
...
#define PROV_DMA_CTRL_CORE_CH_START_CH_3_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_CH_START_CH_3_Pos)  /**< (PROV_DMA_CTRL_CORE_CH_START) Starts Channel 3 Mask */
...
#define PROV_DMA_CTRL_CORE_CH_START_MASK    _U_(0x0F)                                      /**< \deprecated (PROV_DMA_CTRL_CORE_CH_START) Register MASK  (Use PROV_DMA_CTRL_CORE_CH_START_Msk instead)  */
#define PROV_DMA_CTRL_CORE_CH_START_Msk     _U_(0x0F)                                      /**< (PROV_DMA_CTRL_CORE_CH_START) Register Mask  */

#define PROV_DMA_CTRL_CORE_CH_START_CH__Pos 0                                              /**< (PROV_DMA_CTRL_CORE_CH_START Position) Starts Channel 3 */
#define PROV_DMA_CTRL_CORE_CH_START_CH__Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_CH_START_CH__Pos)  /**< (PROV_DMA_CTRL_CORE_CH_START Mask) CH_ */
...
#define PROV_DMA_CTRL_PERIPH_RX_CTRL_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_PERIPH_RX_CTRL) Direct control of peripheral RX request  Reset Value */
...
#define PROV_DMA_CTRL_PERIPH_RX_CTRL_RX_REQ_Msk (_U_(0x7FFFFFFF) << PROV_DMA_CTRL_PERIPH_RX_CTRL_RX_REQ_Pos)  /**< (PROV_DMA_CTRL_PERIPH_RX_CTRL) Allows direct control of the peripheral RX request bus Mask */
...
#define PROV_DMA_CTRL_PERIPH_RX_CTRL_MASK   _U_(0xFFFFFFFE)                                /**< \deprecated (PROV_DMA_CTRL_PERIPH_RX_CTRL) Register MASK  (Use PROV_DMA_CTRL_PERIPH_RX_CTRL_Msk instead)  */
#define PROV_DMA_CTRL_PERIPH_RX_CTRL_Msk    _U_(0xFFFFFFFE)                                /**< (PROV_DMA_CTRL_PERIPH_RX_CTRL) Register Mask  */
...
#define PROV_DMA_CTRL_PERIPH_TX_CTRL_RESETVALUE _U_(0x00)                                     /**<  (PROV_DMA_CTRL_PERIPH_TX_CTRL) Direct control of peripheral TX request  Reset Value */
...
#define PROV_DMA_CTRL_PERIPH_TX_CTRL_TX_REQ_Msk (_U_(0x7FFFFFFF) << PROV_DMA_CTRL_PERIPH_TX_CTRL_TX_REQ_Pos)  /**< (PROV_DMA_CTRL_PERIPH_TX_CTRL) Allows direct control of the peripheral TX request bus Mask */
...
#define PROV_DMA_CTRL_PERIPH_TX_CTRL_MASK   _U_(0xFFFFFFFE)                                /**< \deprecated (PROV_DMA_CTRL_PERIPH_TX_CTRL) Register MASK  (Use PROV_DMA_CTRL_PERIPH_TX_CTRL_Msk instead)  */
#define PROV_DMA_CTRL_PERIPH_TX_CTRL_Msk    _U_(0xFFFFFFFE)                                /**< (PROV_DMA_CTRL_PERIPH_TX_CTRL) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_IDLE_RESETVALUE  _U_(0x00)                                     /**<  (PROV_DMA_CTRL_CORE_IDLE) Indicates all channels have stopped and transactions have completed  Reset Value */

#define PROV_DMA_CTRL_CORE_IDLE_CORE_IDLE_Pos 0                                              /**< (PROV_DMA_CTRL_CORE_IDLE)  Position */
#define PROV_DMA_CTRL_CORE_IDLE_CORE_IDLE_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_IDLE_CORE_IDLE_Pos)  /**< (PROV_DMA_CTRL_CORE_IDLE)  Mask */
...
#define PROV_DMA_CTRL_CORE_IDLE_MASK        _U_(0x01)                                      /**< \deprecated (PROV_DMA_CTRL_CORE_IDLE) Register MASK  (Use PROV_DMA_CTRL_CORE_IDLE_Msk instead)  */
#define PROV_DMA_CTRL_CORE_IDLE_Msk         _U_(0x01)                                      /**< (PROV_DMA_CTRL_CORE_IDLE) Register Mask  */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_RESETVALUE _U_(0x80000001)                               /**<  (PROV_DMA_CTRL_USER_DEF_STATUS) User Defined Configurations  Reset Value */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_INT_NUM_Msk (_U_(0xF) << PROV_DMA_CTRL_USER_DEF_STATUS_INT_NUM_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) Number of bits in interrupt bus Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_DUAL_CORE_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_DUAL_CORE_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set the design has two cores Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_IC_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_IC_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set an AHB matrix is used Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_IC_DUAL_PORT_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_IC_DUAL_PORT_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set AHB matrix has two output ports Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_CLKGATE_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_CLKGATE_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set design contains functional clock gates Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_PORT0_MUX_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_PORT0_MUX_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set AHB port 0 is using an AHB mux Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_PORT1_MUX_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_PORT1_MUX_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) If set AHB port 1 is using an AHB mux Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_PROJ_Msk (_U_(0x1) << PROV_DMA_CTRL_USER_DEF_STATUS_PROJ_Pos)  /**< (PROV_DMA_CTRL_USER_DEF_STATUS) User Defined Project Mask */
...
#define PROV_DMA_CTRL_USER_DEF_STATUS_MASK  _U_(0x800007EF)                                /**< \deprecated (PROV_DMA_CTRL_USER_DEF_STATUS) Register MASK  (Use PROV_DMA_CTRL_USER_DEF_STATUS_Msk instead)  */
#define PROV_DMA_CTRL_USER_DEF_STATUS_Msk   _U_(0x800007EF)                                /**< (PROV_DMA_CTRL_USER_DEF_STATUS) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_RESETVALUE _U_(0xA601151)                                /**<  (PROV_DMA_CTRL_CORE_DEF_STATUS0) User Defined Core Configurations 0  Reset Value */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_CH_NUM_Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_DEF_STATUS0_CH_NUM_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Number of channels (reads 1, should read 4) Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_FIFO_SIZE_Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_DEF_STATUS0_FIFO_SIZE_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Log2 of FIFO size per channel Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_WCMD_DEPTH_Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_DEF_STATUS0_WCMD_DEPTH_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Log2 of maximum number of pending write commands Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_RCMD_DEPTH_Msk (_U_(0xF) << PROV_DMA_CTRL_CORE_DEF_STATUS0_RCMD_DEPTH_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Log2 of maximum number of pending read commands Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_ADDR_BITS_Msk (_U_(0x3F) << PROV_DMA_CTRL_CORE_DEF_STATUS0_ADDR_BITS_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Number of bits in address buses Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_AHB_BUS_32_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS0_AHB_BUS_32_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) If set AHB bus is 32 bit otherwise 64 bit Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_BUFF_BITS_Msk (_U_(0x1F) << PROV_DMA_CTRL_CORE_DEF_STATUS0_BUFF_BITS_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Number of bits in BUFFER_SIZE Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_MASK _U_(0x1F7FFFFF)                                /**< \deprecated (PROV_DMA_CTRL_CORE_DEF_STATUS0) Register MASK  (Use PROV_DMA_CTRL_CORE_DEF_STATUS0_Msk instead)  */
#define PROV_DMA_CTRL_CORE_DEF_STATUS0_Msk  _U_(0x1F7FFFFF)                                /**< (PROV_DMA_CTRL_CORE_DEF_STATUS0) Register Mask  */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_RESETVALUE _U_(0xF87)                                    /**<  (PROV_DMA_CTRL_CORE_DEF_STATUS1) User Defined Core Configurations 1  Reset Value */

#define PROV_DMA_CTRL_CORE_DEF_STATUS1_WDT_Pos 0                                              /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core has watchdog timer Position */
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_WDT_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_WDT_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core has watchdog timer Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_AHB_TIMEOUT_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_AHB_TIMEOUT_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports timeouts on AHB read and write buses Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_TOKENS_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_TOKENS_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core has tokens support Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_PRIO_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_PRIO_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core has priority modes support Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_OUTS_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_OUTS_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports outstanding mode Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_WAIT_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_WAIT_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports scheduled channels Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_BLOCK_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_BLOCK_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports block transfer Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_JOINT_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_JOINT_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports joint mode Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_INDEPENDENT_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_INDEPENDENT_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports independent mode Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_PERIPH_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_PERIPH_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports peripherals Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_LISTS_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_LISTS_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports command lists Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_END_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_END_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports endianness swapping Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_CLKDIV_Msk (_U_(0x1) << PROV_DMA_CTRL_CORE_DEF_STATUS1_CLKDIV_Pos)  /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Set if core supports clock division ratios Mask */
...
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_MASK _U_(0x1FFF)                                    /**< \deprecated (PROV_DMA_CTRL_CORE_DEF_STATUS1) Register MASK  (Use PROV_DMA_CTRL_CORE_DEF_STATUS1_Msk instead)  */
#define PROV_DMA_CTRL_CORE_DEF_STATUS1_Msk  _U_(0x1FFF)                                    /**< (PROV_DMA_CTRL_CORE_DEF_STATUS1) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of 4 Channel DMA Controller */

#endif /* _SAMB11_PROV_DMA_CTRL_COMPONENT_H_ */
