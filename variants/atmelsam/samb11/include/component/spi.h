...
#ifndef _SAMB11_SPI_COMPONENT_H_
#define _SAMB11_SPI_COMPONENT_H_
#define _SAMB11_SPI_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 SPI Master/Slave Controller
 *  @{
 */
/* ========================================================================== */
...
#define SPI_S1234                      /**< (SPI) Module ID */
#define REV_SPI 0x100                  /**< (SPI) Module revision */
...
#define SPI_TRANSMIT_DATA_RESETVALUE        _U_(0x00)                                     /**<  (SPI_TRANSMIT_DATA) Writes one byte to SPI Transmit Data FIFO.   Reset Value */

#define SPI_TRANSMIT_DATA_TX_BYTE_Pos       0                                              /**< (SPI_TRANSMIT_DATA) Writes data in transmit FIFO.  Position */
#define SPI_TRANSMIT_DATA_TX_BYTE_Msk       (_U_(0xFF) << SPI_TRANSMIT_DATA_TX_BYTE_Pos)   /**< (SPI_TRANSMIT_DATA) Writes data in transmit FIFO.  Mask */
#define SPI_TRANSMIT_DATA_TX_BYTE(value)    (SPI_TRANSMIT_DATA_TX_BYTE_Msk & ((value) << SPI_TRANSMIT_DATA_TX_BYTE_Pos))
#define SPI_TRANSMIT_DATA_MASK              _U_(0xFF)                                      /**< \deprecated (SPI_TRANSMIT_DATA) Register MASK  (Use SPI_TRANSMIT_DATA_Msk instead)  */
#define SPI_TRANSMIT_DATA_Msk               _U_(0xFF)                                      /**< (SPI_TRANSMIT_DATA) Register Mask  */
...
#define SPI_RECEIVE_DATA_RESETVALUE         _U_(0x00)                                     /**<  (SPI_RECEIVE_DATA) Read one byte from SPI Receive Data FIFO.   Reset Value */

#define SPI_RECEIVE_DATA_RX_BYTE_Pos        0                                              /**< (SPI_RECEIVE_DATA) Oldest data in receive FIFO.  Position */
#define SPI_RECEIVE_DATA_RX_BYTE_Msk        (_U_(0xFF) << SPI_RECEIVE_DATA_RX_BYTE_Pos)    /**< (SPI_RECEIVE_DATA) Oldest data in receive FIFO.  Mask */
#define SPI_RECEIVE_DATA_RX_BYTE(value)     (SPI_RECEIVE_DATA_RX_BYTE_Msk & ((value) << SPI_RECEIVE_DATA_RX_BYTE_Pos))
#define SPI_RECEIVE_DATA_MASK               _U_(0xFF)                                      /**< \deprecated (SPI_RECEIVE_DATA) Register MASK  (Use SPI_RECEIVE_DATA_Msk instead)  */
#define SPI_RECEIVE_DATA_Msk                _U_(0xFF)                                      /**< (SPI_RECEIVE_DATA) Register Mask  */
...
#define SPI_TRANSMIT_STATUS_RESETVALUE      _U_(0x00)                                     /**<  (SPI_TRANSMIT_STATUS) Status of the SPI transmitter. Each field can generate an interrupt if corresponding bit in  the Tx interrupt mask register is set.   Reset Value */
...
#define SPI_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Msk (_U_(0x1) << SPI_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Pos)  /**< (SPI_TRANSMIT_STATUS) Active High indication when Tx FIFO can still accepts at least one more character. Mask */
...
#define   SPI_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_0_Val _U_(0x0)                                       /**< (SPI_TRANSMIT_STATUS) TX FIFO Full  */
#define   SPI_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_1_Val _U_(0x1)                                       /**< (SPI_TRANSMIT_STATUS) TX FIFO not Full  */
...
#define SPI_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Msk (_U_(0x1) << SPI_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Pos)  /**< (SPI_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least quarter empty. Reset when more.  Mask */
...
#define SPI_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Msk (_U_(0x1) << SPI_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Pos)  /**< (SPI_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least half empty. Reset when more.  Mask */
...
#define SPI_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Msk (_U_(0x1) << SPI_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Pos)  /**< (SPI_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least three quarters empty. Reset when more.  Mask */
...
#define SPI_TRANSMIT_STATUS_TX_FIFO_EMPTY_Msk (_U_(0x1) << SPI_TRANSMIT_STATUS_TX_FIFO_EMPTY_Pos)  /**< (SPI_TRANSMIT_STATUS) Active High indication when Tx FIFO is Empty and has no more character to transmit  Mask */
...
#define SPI_TRANSMIT_STATUS_MASK            _U_(0x1F)                                      /**< \deprecated (SPI_TRANSMIT_STATUS) Register MASK  (Use SPI_TRANSMIT_STATUS_Msk instead)  */
#define SPI_TRANSMIT_STATUS_Msk             _U_(0x1F)                                      /**< (SPI_TRANSMIT_STATUS) Register Mask  */
...
#define SPI_RECEIVE_STATUS_RESETVALUE       _U_(0x00)                                     /**<  (SPI_RECEIVE_STATUS) Status of the SPI receiver. Each field can generate an interrupt if corresponding bit in  the Rx interrupt mask register is set.   Reset Value */
...
#define SPI_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Msk (_U_(0x1) << SPI_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Pos)  /**< (SPI_RECEIVE_STATUS) Active High indication when data is available in Rx FIFO Mask */
...
#define SPI_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Msk (_U_(0x1) << SPI_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Pos)  /**< (SPI_RECEIVE_STATUS) Active High indication when FIFO is at least quarter full. Reset when less.  Mask */
...
#define SPI_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Msk (_U_(0x1) << SPI_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Pos)  /**< (SPI_RECEIVE_STATUS) Active High indication when FIFO is at least half full. Reset when less.  Mask */
...
#define SPI_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Msk (_U_(0x1) << SPI_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Pos)  /**< (SPI_RECEIVE_STATUS) Active High indication when FIFO is at least three quarters full. Reset when less.  Mask */
...
#define SPI_RECEIVE_STATUS_FAULT_Msk        (_U_(0x1) << SPI_RECEIVE_STATUS_FAULT_Pos)     /**< (SPI_RECEIVE_STATUS) Active High indication when two masters attempt to access the SPI bus at the same time. The SPI interface will put itself in slave mode in this case. This bit is reset when the status register is read.   Mask */
...
#define SPI_RECEIVE_STATUS_FIFO_OVERRUN_Msk (_U_(0x1) << SPI_RECEIVE_STATUS_FIFO_OVERRUN_Pos)  /**< (SPI_RECEIVE_STATUS) Active High indication when character is received but FIFO is full. Reset by reading  the status register.  Mask */
...
#define SPI_RECEIVE_STATUS_MASK             _U_(0x3F)                                      /**< \deprecated (SPI_RECEIVE_STATUS) Register MASK  (Use SPI_RECEIVE_STATUS_Msk instead)  */
#define SPI_RECEIVE_STATUS_Msk              _U_(0x3F)                                      /**< (SPI_RECEIVE_STATUS) Register Mask  */
...
#define SPI_CLOCK_SOURCE_SELECT_RESETVALUE  _U_(0x00)                                     /**<  (SPI_CLOCK_SOURCE_SELECT) Clock Source Select  Reset Value */

#define SPI_CLOCK_SOURCE_SELECT_CLOCK_Pos   0                                              /**< (SPI_CLOCK_SOURCE_SELECT) Clock Used to Generate Divided Clock Position */
#define SPI_CLOCK_SOURCE_SELECT_CLOCK_Msk   (_U_(0x3) << SPI_CLOCK_SOURCE_SELECT_CLOCK_Pos)  /**< (SPI_CLOCK_SOURCE_SELECT) Clock Used to Generate Divided Clock Mask */
#define SPI_CLOCK_SOURCE_SELECT_CLOCK(value) (SPI_CLOCK_SOURCE_SELECT_CLOCK_Msk & ((value) << SPI_CLOCK_SOURCE_SELECT_CLOCK_Pos))
#define   SPI_CLOCK_SOURCE_SELECT_CLOCK_0_Val _U_(0x0)                                       /**< (SPI_CLOCK_SOURCE_SELECT) 26 MHz Clock  */
#define   SPI_CLOCK_SOURCE_SELECT_CLOCK_1_Val _U_(0x1)                                       /**< (SPI_CLOCK_SOURCE_SELECT) 13 MHz Clock  */
#define   SPI_CLOCK_SOURCE_SELECT_CLOCK_2_Val _U_(0x2)                                       /**< (SPI_CLOCK_SOURCE_SELECT) 6.5 MHz Clock  */
#define   SPI_CLOCK_SOURCE_SELECT_CLOCK_3_Val _U_(0x3)                                       /**< (SPI_CLOCK_SOURCE_SELECT) 3.25 MHz Clock  */
...
#define SPI_CLOCK_SOURCE_SELECT_MASK        _U_(0x03)                                      /**< \deprecated (SPI_CLOCK_SOURCE_SELECT) Register MASK  (Use SPI_CLOCK_SOURCE_SELECT_Msk instead)  */
#define SPI_CLOCK_SOURCE_SELECT_Msk         _U_(0x03)                                      /**< (SPI_CLOCK_SOURCE_SELECT) Register Mask  */
...
#define SPI_CLK_DIVIDER_RESETVALUE          _U_(0x00)                                     /**<  (SPI_CLK_DIVIDER) Register sets the divide ratio used to generate the sck clock from the module's input clock.   Reset Value */
...
#define SPI_CLK_DIVIDER_SPI_DIVIDE_RATIO_Msk (_U_(0xFFFF) << SPI_CLK_DIVIDER_SPI_DIVIDE_RATIO_Pos)  /**< (SPI_CLK_DIVIDER) Clock Divide Ratio. The input clock signal is divided by (n+1) where n is the value set in  this field.  The minimum division is by 2; a value of 0 is illegal.  Mask */
...
#define SPI_CLK_DIVIDER_MASK                _U_(0xFFFF)                                    /**< \deprecated (SPI_CLK_DIVIDER) Register MASK  (Use SPI_CLK_DIVIDER_Msk instead)  */
#define SPI_CLK_DIVIDER_Msk                 _U_(0xFFFF)                                    /**< (SPI_CLK_DIVIDER) Register Mask  */
...
#define SPI_MODULE_ENABLE_RESETVALUE        _U_(0x00)                                     /**<  (SPI_MODULE_ENABLE) SPI Enable  Reset Value */

#define SPI_MODULE_ENABLE_ENABLE_Pos        0                                              /**< (SPI_MODULE_ENABLE) Enables SPI operation Position */
#define SPI_MODULE_ENABLE_ENABLE_Msk        (_U_(0x1) << SPI_MODULE_ENABLE_ENABLE_Pos)     /**< (SPI_MODULE_ENABLE) Enables SPI operation Mask */
...
#define SPI_MODULE_ENABLE_MASK              _U_(0x01)                                      /**< \deprecated (SPI_MODULE_ENABLE) Register MASK  (Use SPI_MODULE_ENABLE_Msk instead)  */
#define SPI_MODULE_ENABLE_Msk               _U_(0x01)                                      /**< (SPI_MODULE_ENABLE) Register Mask  */
...
#define SPI_MASTER_MODE_RESETVALUE          _U_(0x00)                                     /**<  (SPI_MASTER_MODE) SPI Master/Slave Mode. When clear, SPI is in Slave Mode.   Reset Value */

#define SPI_MASTER_MODE_MASTER_ENABLE_Pos   0                                              /**< (SPI_MASTER_MODE) Active High SPI Master Mode Enable Position */
#define SPI_MASTER_MODE_MASTER_ENABLE_Msk   (_U_(0x1) << SPI_MASTER_MODE_MASTER_ENABLE_Pos)  /**< (SPI_MASTER_MODE) Active High SPI Master Mode Enable Mask */
...
#define   SPI_MASTER_MODE_MASTER_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_MASTER_MODE) SPI Slave  */
#define   SPI_MASTER_MODE_MASTER_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_MASTER_MODE) SPI Master  */
...
#define SPI_MASTER_MODE_MASK                _U_(0x01)                                      /**< \deprecated (SPI_MASTER_MODE) Register MASK  (Use SPI_MASTER_MODE_Msk instead)  */
#define SPI_MASTER_MODE_Msk                 _U_(0x01)                                      /**< (SPI_MASTER_MODE) Register Mask  */
...
#define   SPI_FAULT_ENABLE_FAULT_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_FAULT_ENABLE) Faults ignored on SPI bus  */
#define   SPI_FAULT_ENABLE_FAULT_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_FAULT_ENABLE) Faults detected on SPI bus  */
...
#define SPI_FAULT_ENABLE_MASK               _U_(0x01)                                      /**< \deprecated (SPI_FAULT_ENABLE) Register MASK  (Use SPI_FAULT_ENABLE_Msk instead)  */
#define SPI_FAULT_ENABLE_Msk                _U_(0x01)                                      /**< (SPI_FAULT_ENABLE) Register Mask  */
...
#define SPI_CONFIGURATION_RESETVALUE        _U_(0xE0)                                     /**<  (SPI_CONFIGURATION) SPI Operation Configuration Register. This register should not be modified while SPI bus is active,  otherwise the SPI Module state shall not be guaranteed.   Reset Value */

#define SPI_CONFIGURATION_SCK_POLARITY_Pos  0                                              /**< (SPI_CONFIGURATION) Selects the level of sck in Idle State Position */
#define SPI_CONFIGURATION_SCK_POLARITY_Msk  (_U_(0x1) << SPI_CONFIGURATION_SCK_POLARITY_Pos)  /**< (SPI_CONFIGURATION) Selects the level of sck in Idle State Mask */
...
#define   SPI_CONFIGURATION_SCK_POLARITY_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) SCK is Low  */
#define   SPI_CONFIGURATION_SCK_POLARITY_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) SCK is High  */
...
#define SPI_CONFIGURATION_SCK_PHASE_Msk     (_U_(0x1) << SPI_CONFIGURATION_SCK_PHASE_Pos)  /**< (SPI_CONFIGURATION) Selects clock edge used for data sampling and launching Mask */
...
#define   SPI_CONFIGURATION_SCK_PHASE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) Bits are sampled on the first edge and the following bit is output on the next edge  */
#define   SPI_CONFIGURATION_SCK_PHASE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) Bits are output on the first edge and are sampled on the following edge  */
...
#define SPI_CONFIGURATION_LSB_FIRST_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_LSB_FIRST_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Selects LSB bits to be transmitted first Mask */
...
#define   SPI_CONFIGURATION_LSB_FIRST_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) Data transmitted MSB first  */
#define   SPI_CONFIGURATION_LSB_FIRST_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) Data transmitted LSB first  */
...
#define SPI_CONFIGURATION_BIDIRECTIONAL_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_BIDIRECTIONAL_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Enable Bidirectional mode of operation Mask */
...
#define   SPI_CONFIGURATION_BIDIRECTIONAL_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) SPI is unidirectional, Tx and Rx each has dedicated one port  */
#define   SPI_CONFIGURATION_BIDIRECTIONAL_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) SPI is bidirectional, Tx and Rx share one input/output port (MOSI if Master, MISO if Slave)  */
...
#define SPI_CONFIGURATION_OUTPUT_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_OUTPUT_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Active High Output Enable when in Bidirectional Mode Mask */
...
#define   SPI_CONFIGURATION_OUTPUT_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) MISO is an input if in Slave mode. MOSI is an input if in Master mode  */
#define   SPI_CONFIGURATION_OUTPUT_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) MISO is an output if in Slave mode. MOSI is an output if in Master mode  */
...
#define SPI_CONFIGURATION_SSN_SHIFT_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_SSN_SHIFT_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Active High Shift Enable when SSN signal is asserted Mask */
...
#define   SPI_CONFIGURATION_SSN_SHIFT_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) Shift counter is enabled only when ssn is asserted  */
#define   SPI_CONFIGURATION_SSN_SHIFT_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) Shift counter is always enabled  */
...
#define SPI_CONFIGURATION_SSN_SYNC_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_SSN_SYNC_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Active High SSN Signal Synchronisation Enable Mask */
...
#define   SPI_CONFIGURATION_SSN_SYNC_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) SSN internal synchronisation is bypassed  */
#define   SPI_CONFIGURATION_SSN_SYNC_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) SSN is internally synchronised before being used  */
...
#define SPI_CONFIGURATION_RX_DONE_SYNC_ENABLE_Msk (_U_(0x1) << SPI_CONFIGURATION_RX_DONE_SYNC_ENABLE_Pos)  /**< (SPI_CONFIGURATION) Active High rx_done Signal Synchronisation Enable Mask */
...
#define   SPI_CONFIGURATION_RX_DONE_SYNC_ENABLE_0_Val _U_(0x0)                                       /**< (SPI_CONFIGURATION) rx_done internal synchronisation is bypassed  */
#define   SPI_CONFIGURATION_RX_DONE_SYNC_ENABLE_1_Val _U_(0x1)                                       /**< (SPI_CONFIGURATION) rx_done is internally synchronised before being used  */
...
#define SPI_CONFIGURATION_MASK              _U_(0xFF)                                      /**< \deprecated (SPI_CONFIGURATION) Register MASK  (Use SPI_CONFIGURATION_Msk instead)  */
#define SPI_CONFIGURATION_Msk               _U_(0xFF)                                      /**< (SPI_CONFIGURATION) Register Mask  */
...
#define SPI_BUS_STATUS_RESETVALUE           _U_(0x00)                                     /**<  (SPI_BUS_STATUS) Status of SPI bus.   Reset Value */
...
#define SPI_BUS_STATUS_SPI_ACTIVE_Msk       (_U_(0x1) << SPI_BUS_STATUS_SPI_ACTIVE_Pos)    /**< (SPI_BUS_STATUS) Active High indicatation that the SPI Module is active. While set, SPI configuration should not be modified.  Mask */
...
#define SPI_BUS_STATUS_MASK                 _U_(0x01)                                      /**< \deprecated (SPI_BUS_STATUS) Register MASK  (Use SPI_BUS_STATUS_Msk instead)  */
#define SPI_BUS_STATUS_Msk                  _U_(0x01)                                      /**< (SPI_BUS_STATUS) Register Mask  */
...
#define SPI_TX_INTERRUPT_MASK_RESETVALUE    _U_(0x00)                                     /**<  (SPI_TX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the tx_status register.   Reset Value */
...
#define SPI_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Msk (_U_(0x1) << SPI_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Pos)  /**< (SPI_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_not_full interrupt  Mask */
...
#define SPI_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Msk (_U_(0x1) << SPI_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Pos)  /**< (SPI_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p25_empty interrupt  Mask */
...
#define SPI_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Msk (_U_(0x1) << SPI_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Pos)  /**< (SPI_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p5_empty interrupt  Mask */
...
#define SPI_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Msk (_U_(0x1) << SPI_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Pos)  /**< (SPI_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p75_empty interrupt  Mask */
...
#define SPI_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Msk (_U_(0x1) << SPI_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Pos)  /**< (SPI_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_empty interrupt  Mask */
...
#define SPI_TX_INTERRUPT_MASK_Msk           _U_(0x1F)                                      /**< (SPI_TX_INTERRUPT_MASK) Register Mask  */
...
#define SPI_RX_INTERRUPT_MASK_RESETVALUE    _U_(0x00)                                     /**<  (SPI_RX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the rx_status register.   Reset Value */
...
#define SPI_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_not_empty interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p25_full interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p5_full interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p75_full interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_FAULT_DETECT_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_FAULT_DETECT_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of fault detection interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Msk (_U_(0x1) << SPI_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Pos)  /**< (SPI_RX_INTERRUPT_MASK) Active High Enable of FIFO overrun interrupt  Mask */
...
#define SPI_RX_INTERRUPT_MASK_Msk           _U_(0x3F)                                      /**< (SPI_RX_INTERRUPT_MASK) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of SPI Master/Slave Controller */

#endif /* _SAMB11_SPI_COMPONENT_H_ */
