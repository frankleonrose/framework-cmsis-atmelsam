...
#ifndef _SAMB11_WDT_COMPONENT_H_
#define _SAMB11_WDT_COMPONENT_H_
#define _SAMB11_WDT_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 Watchdog0 Timer
 *  @{
 */
/* ========================================================================== */
...
#define WDT_W1234                      /**< (WDT) Module ID */
#define REV_WDT 0x100                  /**< (WDT) Module revision */
...
#define WDT_WDOGLOAD_RESETVALUE             _U_(0xFFFFFFFF)                               /**<  (WDT_WDOGLOAD) Watchdog Load Register  Reset Value */

#define WDT_WDOGLOAD_WDOGLOAD_Pos           0                                              /**< (WDT_WDOGLOAD)  Position */
#define WDT_WDOGLOAD_WDOGLOAD_Msk           (_U_(0xFFFFFFFF) << WDT_WDOGLOAD_WDOGLOAD_Pos)  /**< (WDT_WDOGLOAD)  Mask */
#define WDT_WDOGLOAD_WDOGLOAD(value)        (WDT_WDOGLOAD_WDOGLOAD_Msk & ((value) << WDT_WDOGLOAD_WDOGLOAD_Pos))
#define WDT_WDOGLOAD_MASK                   _U_(0xFFFFFFFF)                                /**< \deprecated (WDT_WDOGLOAD) Register MASK  (Use WDT_WDOGLOAD_Msk instead)  */
#define WDT_WDOGLOAD_Msk                    _U_(0xFFFFFFFF)                                /**< (WDT_WDOGLOAD) Register Mask  */
...
#define WDT_WDOGVALUE_RESETVALUE            _U_(0xFFFFFFFF)                               /**<  (WDT_WDOGVALUE) Watchdog Value Register  Reset Value */

#define WDT_WDOGVALUE_WDOGVALUE_Pos         0                                              /**< (WDT_WDOGVALUE)  Position */
#define WDT_WDOGVALUE_WDOGVALUE_Msk         (_U_(0xFFFFFFFF) << WDT_WDOGVALUE_WDOGVALUE_Pos)  /**< (WDT_WDOGVALUE)  Mask */
#define WDT_WDOGVALUE_WDOGVALUE(value)      (WDT_WDOGVALUE_WDOGVALUE_Msk & ((value) << WDT_WDOGVALUE_WDOGVALUE_Pos))
#define WDT_WDOGVALUE_MASK                  _U_(0xFFFFFFFF)                                /**< \deprecated (WDT_WDOGVALUE) Register MASK  (Use WDT_WDOGVALUE_Msk instead)  */
#define WDT_WDOGVALUE_Msk                   _U_(0xFFFFFFFF)                                /**< (WDT_WDOGVALUE) Register Mask  */
...
#define WDT_WDOGCONTROL_RESETVALUE          _U_(0x00)                                     /**<  (WDT_WDOGCONTROL) Watchdog Control Register  Reset Value */

#define WDT_WDOGCONTROL_INTEN_Pos           0                                              /**< (WDT_WDOGCONTROL) Active High Enable Interrupt Event Position */
#define WDT_WDOGCONTROL_INTEN_Msk           (_U_(0x1) << WDT_WDOGCONTROL_INTEN_Pos)        /**< (WDT_WDOGCONTROL) Active High Enable Interrupt Event Mask */
...
#define WDT_WDOGCONTROL_RESEN_Msk           (_U_(0x1) << WDT_WDOGCONTROL_RESEN_Pos)        /**< (WDT_WDOGCONTROL) Active High Enable Watchdog Reset Output Mask */
...
#define WDT_WDOGCONTROL_MASK                _U_(0x03)                                      /**< \deprecated (WDT_WDOGCONTROL) Register MASK  (Use WDT_WDOGCONTROL_Msk instead)  */
#define WDT_WDOGCONTROL_Msk                 _U_(0x03)                                      /**< (WDT_WDOGCONTROL) Register Mask  */
...
#define WDT_WDOGINTCLR_RESETVALUE           _U_(0x00)                                     /**<  (WDT_WDOGINTCLR) Watchdog Clear Interrupt Register  Reset Value */

#define WDT_WDOGINTCLR_WDOGINTCLR_Pos       0                                              /**< (WDT_WDOGINTCLR)  Position */
#define WDT_WDOGINTCLR_WDOGINTCLR_Msk       (_U_(0x1) << WDT_WDOGINTCLR_WDOGINTCLR_Pos)    /**< (WDT_WDOGINTCLR)  Mask */
...
#define WDT_WDOGINTCLR_MASK                 _U_(0x01)                                      /**< \deprecated (WDT_WDOGINTCLR) Register MASK  (Use WDT_WDOGINTCLR_Msk instead)  */
#define WDT_WDOGINTCLR_Msk                  _U_(0x01)                                      /**< (WDT_WDOGINTCLR) Register Mask  */
...
#define WDT_WDOGRIS_RESETVALUE              _U_(0x00)                                     /**<  (WDT_WDOGRIS) Watchdog Raw Interrupt Status Register  Reset Value */

#define WDT_WDOGRIS_WDOGRIS_Pos             0                                              /**< (WDT_WDOGRIS)  Position */
#define WDT_WDOGRIS_WDOGRIS_Msk             (_U_(0x1) << WDT_WDOGRIS_WDOGRIS_Pos)          /**< (WDT_WDOGRIS)  Mask */
...
#define WDT_WDOGRIS_MASK                    _U_(0x01)                                      /**< \deprecated (WDT_WDOGRIS) Register MASK  (Use WDT_WDOGRIS_Msk instead)  */
#define WDT_WDOGRIS_Msk                     _U_(0x01)                                      /**< (WDT_WDOGRIS) Register Mask  */
...
#define WDT_WDOGMIS_RESETVALUE              _U_(0x00)                                     /**<  (WDT_WDOGMIS) Watchdog Interrupt Status Register  Reset Value */

#define WDT_WDOGMIS_WDOGMIS_Pos             0                                              /**< (WDT_WDOGMIS)  Position */
#define WDT_WDOGMIS_WDOGMIS_Msk             (_U_(0x1) << WDT_WDOGMIS_WDOGMIS_Pos)          /**< (WDT_WDOGMIS)  Mask */
...
#define WDT_WDOGMIS_MASK                    _U_(0x01)                                      /**< \deprecated (WDT_WDOGMIS) Register MASK  (Use WDT_WDOGMIS_Msk instead)  */
#define WDT_WDOGMIS_Msk                     _U_(0x01)                                      /**< (WDT_WDOGMIS) Register Mask  */
...
#define WDT_WDOGLOCK_RESETVALUE             _U_(0x00)                                     /**<  (WDT_WDOGLOCK) Watchdog Lock Register (Write 0x1ACCE551 to enable write access to all other registers)  Reset Value */

#define WDT_WDOGLOCK_ENABLE_STATUS_Pos      0                                              /**< (WDT_WDOGLOCK) Read back of 1 indicates that write access is enabled Position */
#define WDT_WDOGLOCK_ENABLE_STATUS_Msk      (_U_(0x1) << WDT_WDOGLOCK_ENABLE_STATUS_Pos)   /**< (WDT_WDOGLOCK) Read back of 1 indicates that write access is enabled Mask */
...
#define WDT_WDOGLOCK_ENABLE_REGISTER_WRITES_Msk (_U_(0x7FFFFFFF) << WDT_WDOGLOCK_ENABLE_REGISTER_WRITES_Pos)  /**< (WDT_WDOGLOCK) Read back all 0s, write 0x1ACCE551 to enable write access to all other registers Mask */
...
#define WDT_WDOGLOCK_MASK                   _U_(0xFFFFFFFF)                                /**< \deprecated (WDT_WDOGLOCK) Register MASK  (Use WDT_WDOGLOCK_Msk instead)  */
#define WDT_WDOGLOCK_Msk                    _U_(0xFFFFFFFF)                                /**< (WDT_WDOGLOCK) Register Mask  */
...
#define WDT_WDOGITCR_RESETVALUE             _U_(0x00)                                     /**<  (WDT_WDOGITCR) Watchdog Integration Test Control Register  Reset Value */

#define WDT_WDOGITCR_ENABLE_Pos             0                                              /**< (WDT_WDOGITCR) Set HIGH to place watchdog into integration test mode Position */
#define WDT_WDOGITCR_ENABLE_Msk             (_U_(0x1) << WDT_WDOGITCR_ENABLE_Pos)          /**< (WDT_WDOGITCR) Set HIGH to place watchdog into integration test mode Mask */
...
#define WDT_WDOGITCR_MASK                   _U_(0x01)                                      /**< \deprecated (WDT_WDOGITCR) Register MASK  (Use WDT_WDOGITCR_Msk instead)  */
#define WDT_WDOGITCR_Msk                    _U_(0x01)                                      /**< (WDT_WDOGITCR) Register Mask  */
...
#define WDT_WDOGITOP_RESETVALUE             _U_(0x00)                                     /**<  (WDT_WDOGITOP) Watchdog Integration Test Output Set Register  Reset Value */

#define WDT_WDOGITOP_WDOGRES_VALUE_Pos      0                                              /**< (WDT_WDOGITOP) Value output on WDOGRES when in Integration Test Mode Position */
#define WDT_WDOGITOP_WDOGRES_VALUE_Msk      (_U_(0x1) << WDT_WDOGITOP_WDOGRES_VALUE_Pos)   /**< (WDT_WDOGITOP) Value output on WDOGRES when in Integration Test Mode Mask */
...
#define WDT_WDOGITOP_WDOGINT_VALUE_Msk      (_U_(0x1) << WDT_WDOGITOP_WDOGINT_VALUE_Pos)   /**< (WDT_WDOGITOP) Value output on WDOGINT when in Integration Test Mode Mask */
...
#define WDT_WDOGITOP_MASK                   _U_(0x03)                                      /**< \deprecated (WDT_WDOGITOP) Register MASK  (Use WDT_WDOGITOP_Msk instead)  */
#define WDT_WDOGITOP_Msk                    _U_(0x03)                                      /**< (WDT_WDOGITOP) Register Mask  */
...
#define WDT_WDOGPERIPHID4_RESETVALUE        _U_(0x04)                                     /**<  (WDT_WDOGPERIPHID4) Peripheral ID Register 4  Reset Value */

#define WDT_WDOGPERIPHID4_JEP106_C_CODE_Pos 0                                              /**< (WDT_WDOGPERIPHID4) JEP106 C Code Position */
#define WDT_WDOGPERIPHID4_JEP106_C_CODE_Msk (_U_(0xF) << WDT_WDOGPERIPHID4_JEP106_C_CODE_Pos)  /**< (WDT_WDOGPERIPHID4) JEP106 C Code Mask */
...
#define WDT_WDOGPERIPHID4_BLOCK_COUNT_Msk   (_U_(0xF) << WDT_WDOGPERIPHID4_BLOCK_COUNT_Pos)  /**< (WDT_WDOGPERIPHID4) Block Count Mask */
#define WDT_WDOGPERIPHID4_BLOCK_COUNT(value) (WDT_WDOGPERIPHID4_BLOCK_COUNT_Msk & ((value) << WDT_WDOGPERIPHID4_BLOCK_COUNT_Pos))
#define WDT_WDOGPERIPHID4_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID4) Register MASK  (Use WDT_WDOGPERIPHID4_Msk instead)  */
#define WDT_WDOGPERIPHID4_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID4) Register Mask  */
...
#define WDT_WDOGPERIPHID5_RESETVALUE        _U_(0x00)                                     /**<  (WDT_WDOGPERIPHID5) Peripheral ID Register 5  Reset Value */

#define WDT_WDOGPERIPHID5_WDOGPERIPHID5_Pos 0                                              /**< (WDT_WDOGPERIPHID5)  Position */
#define WDT_WDOGPERIPHID5_WDOGPERIPHID5_Msk (_U_(0xFF) << WDT_WDOGPERIPHID5_WDOGPERIPHID5_Pos)  /**< (WDT_WDOGPERIPHID5)  Mask */
...
#define WDT_WDOGPERIPHID5_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID5) Register MASK  (Use WDT_WDOGPERIPHID5_Msk instead)  */
#define WDT_WDOGPERIPHID5_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID5) Register Mask  */
...
#define WDT_WDOGPERIPHID6_RESETVALUE        _U_(0x00)                                     /**<  (WDT_WDOGPERIPHID6) Peripheral ID Register 6  Reset Value */

#define WDT_WDOGPERIPHID6_WDOGPERIPHID6_Pos 0                                              /**< (WDT_WDOGPERIPHID6)  Position */
#define WDT_WDOGPERIPHID6_WDOGPERIPHID6_Msk (_U_(0xFF) << WDT_WDOGPERIPHID6_WDOGPERIPHID6_Pos)  /**< (WDT_WDOGPERIPHID6)  Mask */
...
#define WDT_WDOGPERIPHID6_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID6) Register MASK  (Use WDT_WDOGPERIPHID6_Msk instead)  */
#define WDT_WDOGPERIPHID6_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID6) Register Mask  */
...
#define WDT_WDOGPERIPHID7_RESETVALUE        _U_(0x00)                                     /**<  (WDT_WDOGPERIPHID7) Peripheral ID Register 7  Reset Value */

#define WDT_WDOGPERIPHID7_WDOGPERIPHID7_Pos 0                                              /**< (WDT_WDOGPERIPHID7)  Position */
#define WDT_WDOGPERIPHID7_WDOGPERIPHID7_Msk (_U_(0xFF) << WDT_WDOGPERIPHID7_WDOGPERIPHID7_Pos)  /**< (WDT_WDOGPERIPHID7)  Mask */
...
#define WDT_WDOGPERIPHID7_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID7) Register MASK  (Use WDT_WDOGPERIPHID7_Msk instead)  */
#define WDT_WDOGPERIPHID7_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID7) Register Mask  */
...
#define WDT_WDOGPERIPHID0_RESETVALUE        _U_(0x24)                                     /**<  (WDT_WDOGPERIPHID0) Peripheral ID Register 0  Reset Value */

#define WDT_WDOGPERIPHID0_PART_NUMBER_Pos   0                                              /**< (WDT_WDOGPERIPHID0) Part Number Bits 7:0 Position */
#define WDT_WDOGPERIPHID0_PART_NUMBER_Msk   (_U_(0xFF) << WDT_WDOGPERIPHID0_PART_NUMBER_Pos)  /**< (WDT_WDOGPERIPHID0) Part Number Bits 7:0 Mask */
#define WDT_WDOGPERIPHID0_PART_NUMBER(value) (WDT_WDOGPERIPHID0_PART_NUMBER_Msk & ((value) << WDT_WDOGPERIPHID0_PART_NUMBER_Pos))
#define WDT_WDOGPERIPHID0_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID0) Register MASK  (Use WDT_WDOGPERIPHID0_Msk instead)  */
#define WDT_WDOGPERIPHID0_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID0) Register Mask  */
...
#define WDT_WDOGPERIPHID1_RESETVALUE        _U_(0xB8)                                     /**<  (WDT_WDOGPERIPHID1) Peripheral ID Register 1  Reset Value */

#define WDT_WDOGPERIPHID1_PART_NUMBER_Pos   0                                              /**< (WDT_WDOGPERIPHID1) Part Number Bits 11:8 Position */
#define WDT_WDOGPERIPHID1_PART_NUMBER_Msk   (_U_(0xF) << WDT_WDOGPERIPHID1_PART_NUMBER_Pos)  /**< (WDT_WDOGPERIPHID1) Part Number Bits 11:8 Mask */
...
#define WDT_WDOGPERIPHID1_JEP106_ID_3_0_Msk (_U_(0xF) << WDT_WDOGPERIPHID1_JEP106_ID_3_0_Pos)  /**< (WDT_WDOGPERIPHID1) JEP106 ID Bits 3:0 Mask */
...
#define WDT_WDOGPERIPHID1_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID1) Register MASK  (Use WDT_WDOGPERIPHID1_Msk instead)  */
#define WDT_WDOGPERIPHID1_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID1) Register Mask  */
...
#define WDT_WDOGPERIPHID2_RESETVALUE        _U_(0x1B)                                     /**<  (WDT_WDOGPERIPHID2) Peripheral ID Register 2  Reset Value */

#define WDT_WDOGPERIPHID2_JEP106_ID_6_4_Pos 0                                              /**< (WDT_WDOGPERIPHID2) JEP106 ID Bits 6:4 Position */
#define WDT_WDOGPERIPHID2_JEP106_ID_6_4_Msk (_U_(0x7) << WDT_WDOGPERIPHID2_JEP106_ID_6_4_Pos)  /**< (WDT_WDOGPERIPHID2) JEP106 ID Bits 6:4 Mask */
...
#define WDT_WDOGPERIPHID2_JEDEC_USED_Msk    (_U_(0x1) << WDT_WDOGPERIPHID2_JEDEC_USED_Pos)  /**< (WDT_WDOGPERIPHID2) JEDEC Used Mask */
...
#define WDT_WDOGPERIPHID2_REVISION_Msk      (_U_(0xF) << WDT_WDOGPERIPHID2_REVISION_Pos)   /**< (WDT_WDOGPERIPHID2) Revision Mask */
#define WDT_WDOGPERIPHID2_REVISION(value)   (WDT_WDOGPERIPHID2_REVISION_Msk & ((value) << WDT_WDOGPERIPHID2_REVISION_Pos))
#define WDT_WDOGPERIPHID2_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID2) Register MASK  (Use WDT_WDOGPERIPHID2_Msk instead)  */
#define WDT_WDOGPERIPHID2_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID2) Register Mask  */
...
#define WDT_WDOGPERIPHID3_RESETVALUE        _U_(0x00)                                     /**<  (WDT_WDOGPERIPHID3) Peripheral ID Register 3  Reset Value */

#define WDT_WDOGPERIPHID3_CUSTOMER_MOD_NUMBER_Pos 0                                              /**< (WDT_WDOGPERIPHID3) Customer Modification Number Position */
#define WDT_WDOGPERIPHID3_CUSTOMER_MOD_NUMBER_Msk (_U_(0xF) << WDT_WDOGPERIPHID3_CUSTOMER_MOD_NUMBER_Pos)  /**< (WDT_WDOGPERIPHID3) Customer Modification Number Mask */
...
#define WDT_WDOGPERIPHID3_ECO_REV_NUMBER_Msk (_U_(0xF) << WDT_WDOGPERIPHID3_ECO_REV_NUMBER_Pos)  /**< (WDT_WDOGPERIPHID3) ECO Revision Number Mask */
...
#define WDT_WDOGPERIPHID3_MASK              _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPERIPHID3) Register MASK  (Use WDT_WDOGPERIPHID3_Msk instead)  */
#define WDT_WDOGPERIPHID3_Msk               _U_(0xFF)                                      /**< (WDT_WDOGPERIPHID3) Register Mask  */
...
#define WDT_WDOGPCELLID0_RESETVALUE         _U_(0x0D)                                     /**<  (WDT_WDOGPCELLID0) Component ID Register 0  Reset Value */

#define WDT_WDOGPCELLID0_WDOGPCELLID0_Pos   0                                              /**< (WDT_WDOGPCELLID0)  Position */
#define WDT_WDOGPCELLID0_WDOGPCELLID0_Msk   (_U_(0xFF) << WDT_WDOGPCELLID0_WDOGPCELLID0_Pos)  /**< (WDT_WDOGPCELLID0)  Mask */
#define WDT_WDOGPCELLID0_WDOGPCELLID0(value) (WDT_WDOGPCELLID0_WDOGPCELLID0_Msk & ((value) << WDT_WDOGPCELLID0_WDOGPCELLID0_Pos))
#define WDT_WDOGPCELLID0_MASK               _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPCELLID0) Register MASK  (Use WDT_WDOGPCELLID0_Msk instead)  */
#define WDT_WDOGPCELLID0_Msk                _U_(0xFF)                                      /**< (WDT_WDOGPCELLID0) Register Mask  */
...
#define WDT_WDOGPCELLID1_RESETVALUE         _U_(0xF0)                                     /**<  (WDT_WDOGPCELLID1) Component ID Register 1  Reset Value */

#define WDT_WDOGPCELLID1_WDOGPCELLID1_Pos   0                                              /**< (WDT_WDOGPCELLID1)  Position */
#define WDT_WDOGPCELLID1_WDOGPCELLID1_Msk   (_U_(0xFF) << WDT_WDOGPCELLID1_WDOGPCELLID1_Pos)  /**< (WDT_WDOGPCELLID1)  Mask */
#define WDT_WDOGPCELLID1_WDOGPCELLID1(value) (WDT_WDOGPCELLID1_WDOGPCELLID1_Msk & ((value) << WDT_WDOGPCELLID1_WDOGPCELLID1_Pos))
#define WDT_WDOGPCELLID1_MASK               _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPCELLID1) Register MASK  (Use WDT_WDOGPCELLID1_Msk instead)  */
#define WDT_WDOGPCELLID1_Msk                _U_(0xFF)                                      /**< (WDT_WDOGPCELLID1) Register Mask  */
...
#define WDT_WDOGPCELLID2_RESETVALUE         _U_(0x05)                                     /**<  (WDT_WDOGPCELLID2) Component ID Register 2  Reset Value */

#define WDT_WDOGPCELLID2_WDOGPCELLID2_Pos   0                                              /**< (WDT_WDOGPCELLID2)  Position */
#define WDT_WDOGPCELLID2_WDOGPCELLID2_Msk   (_U_(0xFF) << WDT_WDOGPCELLID2_WDOGPCELLID2_Pos)  /**< (WDT_WDOGPCELLID2)  Mask */
#define WDT_WDOGPCELLID2_WDOGPCELLID2(value) (WDT_WDOGPCELLID2_WDOGPCELLID2_Msk & ((value) << WDT_WDOGPCELLID2_WDOGPCELLID2_Pos))
#define WDT_WDOGPCELLID2_MASK               _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPCELLID2) Register MASK  (Use WDT_WDOGPCELLID2_Msk instead)  */
#define WDT_WDOGPCELLID2_Msk                _U_(0xFF)                                      /**< (WDT_WDOGPCELLID2) Register Mask  */
...
#define WDT_WDOGPCELLID3_RESETVALUE         _U_(0xB1)                                     /**<  (WDT_WDOGPCELLID3) Component ID Register 3  Reset Value */

#define WDT_WDOGPCELLID3_WDOGPCELLID3_Pos   0                                              /**< (WDT_WDOGPCELLID3)  Position */
#define WDT_WDOGPCELLID3_WDOGPCELLID3_Msk   (_U_(0xFF) << WDT_WDOGPCELLID3_WDOGPCELLID3_Pos)  /**< (WDT_WDOGPCELLID3)  Mask */
#define WDT_WDOGPCELLID3_WDOGPCELLID3(value) (WDT_WDOGPCELLID3_WDOGPCELLID3_Msk & ((value) << WDT_WDOGPCELLID3_WDOGPCELLID3_Pos))
#define WDT_WDOGPCELLID3_MASK               _U_(0xFF)                                      /**< \deprecated (WDT_WDOGPCELLID3) Register MASK  (Use WDT_WDOGPCELLID3_Msk instead)  */
#define WDT_WDOGPCELLID3_Msk                _U_(0xFF)                                      /**< (WDT_WDOGPCELLID3) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of Watchdog0 Timer */

#endif /* _SAMB11_WDT_COMPONENT_H_ */
