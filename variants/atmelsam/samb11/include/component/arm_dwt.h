...
#ifndef _SAMB11_ARM_DWT_COMPONENT_H_
#define _SAMB11_ARM_DWT_COMPONENT_H_
#define _SAMB11_ARM_DWT_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 ARM DWT Control
 *  @{
 */
/* ========================================================================== */
...
#define ARM_DWT_ADWT1234                   /**< (ARM_DWT) Module ID */
#define REV_ARM_DWT 0x100                  /**< (ARM_DWT) Module revision */
...
#define ARM_DWT_DWT_CTRL_RESETVALUE         _U_(0x00)                                     /**<  (ARM_DWT_DWT_CTRL) Control Register  Reset Value */

#define ARM_DWT_DWT_CTRL_NUMCOMP_Pos        28                                             /**< (ARM_DWT_DWT_CTRL) Number of comparators available Position */
#define ARM_DWT_DWT_CTRL_NUMCOMP_Msk        (_U_(0xF) << ARM_DWT_DWT_CTRL_NUMCOMP_Pos)     /**< (ARM_DWT_DWT_CTRL) Number of comparators available Mask */
#define ARM_DWT_DWT_CTRL_NUMCOMP(value)     (ARM_DWT_DWT_CTRL_NUMCOMP_Msk & ((value) << ARM_DWT_DWT_CTRL_NUMCOMP_Pos))
#define ARM_DWT_DWT_CTRL_MASK               _U_(0xF0000000)                                /**< \deprecated (ARM_DWT_DWT_CTRL) Register MASK  (Use ARM_DWT_DWT_CTRL_Msk instead)  */
#define ARM_DWT_DWT_CTRL_Msk                _U_(0xF0000000)                                /**< (ARM_DWT_DWT_CTRL) Register Mask  */
...
#define ARM_DWT_DWT_PCSR_RESETVALUE         _U_(0x00)                                     /**<  (ARM_DWT_DWT_PCSR) Program Counter Sample Register  Reset Value */

#define ARM_DWT_DWT_PCSR_EIASAMPLE_Pos      0                                              /**< (ARM_DWT_DWT_PCSR) Executed Instruction Address sample value Position */
#define ARM_DWT_DWT_PCSR_EIASAMPLE_Msk      (_U_(0xFFFFFFFF) << ARM_DWT_DWT_PCSR_EIASAMPLE_Pos)  /**< (ARM_DWT_DWT_PCSR) Executed Instruction Address sample value Mask */
#define ARM_DWT_DWT_PCSR_EIASAMPLE(value)   (ARM_DWT_DWT_PCSR_EIASAMPLE_Msk & ((value) << ARM_DWT_DWT_PCSR_EIASAMPLE_Pos))
#define ARM_DWT_DWT_PCSR_MASK               _U_(0xFFFFFFFF)                                /**< \deprecated (ARM_DWT_DWT_PCSR) Register MASK  (Use ARM_DWT_DWT_PCSR_Msk instead)  */
#define ARM_DWT_DWT_PCSR_Msk                _U_(0xFFFFFFFF)                                /**< (ARM_DWT_DWT_PCSR) Register Mask  */
...
#define ARM_DWT_DWT_COMP0_RESETVALUE        _U_(0x00)                                     /**<  (ARM_DWT_DWT_COMP0) DWT Compare Register 0  Reset Value */

#define ARM_DWT_DWT_COMP0_COMP_Pos          0                                              /**< (ARM_DWT_DWT_COMP0) Reference Value for Comparison Position */
#define ARM_DWT_DWT_COMP0_COMP_Msk          (_U_(0xFFFFFFFF) << ARM_DWT_DWT_COMP0_COMP_Pos)  /**< (ARM_DWT_DWT_COMP0) Reference Value for Comparison Mask */
#define ARM_DWT_DWT_COMP0_COMP(value)       (ARM_DWT_DWT_COMP0_COMP_Msk & ((value) << ARM_DWT_DWT_COMP0_COMP_Pos))
#define ARM_DWT_DWT_COMP0_MASK              _U_(0xFFFFFFFF)                                /**< \deprecated (ARM_DWT_DWT_COMP0) Register MASK  (Use ARM_DWT_DWT_COMP0_Msk instead)  */
#define ARM_DWT_DWT_COMP0_Msk               _U_(0xFFFFFFFF)                                /**< (ARM_DWT_DWT_COMP0) Register Mask  */
...
#define ARM_DWT_DWT_MASK0_RESETVALUE        _U_(0x00)                                     /**<  (ARM_DWT_DWT_MASK0) DWT Mask Register 0  Reset Value */
...
#define ARM_DWT_DWT_MASK0_MASK_VALUE_Msk    (_U_(0x1F) << ARM_DWT_DWT_MASK0_MASK_VALUE_Pos)  /**< (ARM_DWT_DWT_MASK0) Size of the ignore mask applied to address range matching Mask */
#define ARM_DWT_DWT_MASK0_MASK_VALUE(value) (ARM_DWT_DWT_MASK0_MASK_VALUE_Msk & ((value) << ARM_DWT_DWT_MASK0_MASK_VALUE_Pos))
#define ARM_DWT_DWT_MASK0_Msk               _U_(0x1F)                                      /**< (ARM_DWT_DWT_MASK0) Register Mask  */
...
#define ARM_DWT_DWT_FUNCTION0_RESETVALUE    _U_(0x00)                                     /**<  (ARM_DWT_DWT_FUNCTION0) DWT Function Register 0  Reset Value */

#define ARM_DWT_DWT_FUNCTION0_FUNCTION_Pos  0                                              /**< (ARM_DWT_DWT_FUNCTION0) Select action on comparator match Position */
#define ARM_DWT_DWT_FUNCTION0_FUNCTION_Msk  (_U_(0xF) << ARM_DWT_DWT_FUNCTION0_FUNCTION_Pos)  /**< (ARM_DWT_DWT_FUNCTION0) Select action on comparator match Mask */
#define ARM_DWT_DWT_FUNCTION0_FUNCTION(value) (ARM_DWT_DWT_FUNCTION0_FUNCTION_Msk & ((value) << ARM_DWT_DWT_FUNCTION0_FUNCTION_Pos))
#define   ARM_DWT_DWT_FUNCTION0_FUNCTION_0_Val _U_(0x0)                                       /**< (ARM_DWT_DWT_FUNCTION0) Disabled  */
#define   ARM_DWT_DWT_FUNCTION0_FUNCTION_4_Val _U_(0x4)                                       /**< (ARM_DWT_DWT_FUNCTION0) PC Watchpoint Event (Instruction)  */
#define   ARM_DWT_DWT_FUNCTION0_FUNCTION_5_Val _U_(0x5)                                       /**< (ARM_DWT_DWT_FUNCTION0) Watchpoint Event Read Only (Data)  */
#define   ARM_DWT_DWT_FUNCTION0_FUNCTION_6_Val _U_(0x6)                                       /**< (ARM_DWT_DWT_FUNCTION0) Watchpoint Event Write Only (Data)  */
#define   ARM_DWT_DWT_FUNCTION0_FUNCTION_7_Val _U_(0x7)                                       /**< (ARM_DWT_DWT_FUNCTION0) Watchpoing Event Write-Read (Data)  */
...
#define ARM_DWT_DWT_FUNCTION0_MATCHED_Msk   (_U_(0x1) << ARM_DWT_DWT_FUNCTION0_MATCHED_Pos)  /**< (ARM_DWT_DWT_FUNCTION0) Comparator Match Mask */
...
#define ARM_DWT_DWT_FUNCTION0_MASK          _U_(0x100000F)                                 /**< \deprecated (ARM_DWT_DWT_FUNCTION0) Register MASK  (Use ARM_DWT_DWT_FUNCTION0_Msk instead)  */
#define ARM_DWT_DWT_FUNCTION0_Msk           _U_(0x100000F)                                 /**< (ARM_DWT_DWT_FUNCTION0) Register Mask  */
...
#define ARM_DWT_DWT_COMP1_RESETVALUE        _U_(0x00)                                     /**<  (ARM_DWT_DWT_COMP1) DWT Compare Register 1  Reset Value */

#define ARM_DWT_DWT_COMP1_COMP_Pos          0                                              /**< (ARM_DWT_DWT_COMP1) Reference Value for Comparison Position */
#define ARM_DWT_DWT_COMP1_COMP_Msk          (_U_(0xFFFFFFFF) << ARM_DWT_DWT_COMP1_COMP_Pos)  /**< (ARM_DWT_DWT_COMP1) Reference Value for Comparison Mask */
#define ARM_DWT_DWT_COMP1_COMP(value)       (ARM_DWT_DWT_COMP1_COMP_Msk & ((value) << ARM_DWT_DWT_COMP1_COMP_Pos))
#define ARM_DWT_DWT_COMP1_MASK              _U_(0xFFFFFFFF)                                /**< \deprecated (ARM_DWT_DWT_COMP1) Register MASK  (Use ARM_DWT_DWT_COMP1_Msk instead)  */
#define ARM_DWT_DWT_COMP1_Msk               _U_(0xFFFFFFFF)                                /**< (ARM_DWT_DWT_COMP1) Register Mask  */
...
#define ARM_DWT_DWT_MASK1_RESETVALUE        _U_(0x00)                                     /**<  (ARM_DWT_DWT_MASK1) DWT Mask Register 1  Reset Value */
...
#define ARM_DWT_DWT_MASK1_MASK_VALUE_Msk    (_U_(0x1F) << ARM_DWT_DWT_MASK1_MASK_VALUE_Pos)  /**< (ARM_DWT_DWT_MASK1) Size of the ignore mask applied to address range matching Mask */
#define ARM_DWT_DWT_MASK1_MASK_VALUE(value) (ARM_DWT_DWT_MASK1_MASK_VALUE_Msk & ((value) << ARM_DWT_DWT_MASK1_MASK_VALUE_Pos))
#define ARM_DWT_DWT_MASK1_Msk               _U_(0x1F)                                      /**< (ARM_DWT_DWT_MASK1) Register Mask  */
...
#define ARM_DWT_DWT_FUNCTION1_RESETVALUE    _U_(0x00)                                     /**<  (ARM_DWT_DWT_FUNCTION1) DWT Function Register 1  Reset Value */

#define ARM_DWT_DWT_FUNCTION1_FUNCTION_Pos  0                                              /**< (ARM_DWT_DWT_FUNCTION1) Select action on comparator match Position */
#define ARM_DWT_DWT_FUNCTION1_FUNCTION_Msk  (_U_(0xF) << ARM_DWT_DWT_FUNCTION1_FUNCTION_Pos)  /**< (ARM_DWT_DWT_FUNCTION1) Select action on comparator match Mask */
#define ARM_DWT_DWT_FUNCTION1_FUNCTION(value) (ARM_DWT_DWT_FUNCTION1_FUNCTION_Msk & ((value) << ARM_DWT_DWT_FUNCTION1_FUNCTION_Pos))
#define   ARM_DWT_DWT_FUNCTION1_FUNCTION_0_Val _U_(0x0)                                       /**< (ARM_DWT_DWT_FUNCTION1) Disabled  */
#define   ARM_DWT_DWT_FUNCTION1_FUNCTION_4_Val _U_(0x4)                                       /**< (ARM_DWT_DWT_FUNCTION1) PC Watchpoint Event (Instruction)  */
#define   ARM_DWT_DWT_FUNCTION1_FUNCTION_5_Val _U_(0x5)                                       /**< (ARM_DWT_DWT_FUNCTION1) Watchpoint Event Read Only (Data)  */
#define   ARM_DWT_DWT_FUNCTION1_FUNCTION_6_Val _U_(0x6)                                       /**< (ARM_DWT_DWT_FUNCTION1) Watchpoint Event Write Only (Data)  */
#define   ARM_DWT_DWT_FUNCTION1_FUNCTION_7_Val _U_(0x7)                                       /**< (ARM_DWT_DWT_FUNCTION1) Watchpoing Event Write-Read (Data)  */
...
#define ARM_DWT_DWT_FUNCTION1_MATCHED_Msk   (_U_(0x1) << ARM_DWT_DWT_FUNCTION1_MATCHED_Pos)  /**< (ARM_DWT_DWT_FUNCTION1) Comparator Match Mask */
...
#define ARM_DWT_DWT_FUNCTION1_MASK          _U_(0x100000F)                                 /**< \deprecated (ARM_DWT_DWT_FUNCTION1) Register MASK  (Use ARM_DWT_DWT_FUNCTION1_Msk instead)  */
#define ARM_DWT_DWT_FUNCTION1_Msk           _U_(0x100000F)                                 /**< (ARM_DWT_DWT_FUNCTION1) Register Mask  */
...
#define ARM_DWT_DWT_PID4_RESETVALUE         _U_(0x04)                                     /**<  (ARM_DWT_DWT_PID4) Peripheral ID Register 4  Reset Value */

#define ARM_DWT_DWT_PID4_JEP106_C_CODE_Pos  0                                              /**< (ARM_DWT_DWT_PID4) JEP106 C Code Position */
#define ARM_DWT_DWT_PID4_JEP106_C_CODE_Msk  (_U_(0xF) << ARM_DWT_DWT_PID4_JEP106_C_CODE_Pos)  /**< (ARM_DWT_DWT_PID4) JEP106 C Code Mask */
...
#define ARM_DWT_DWT_PID4_BLOCK_COUNT_Msk    (_U_(0xF) << ARM_DWT_DWT_PID4_BLOCK_COUNT_Pos)  /**< (ARM_DWT_DWT_PID4) Block Count Mask */
#define ARM_DWT_DWT_PID4_BLOCK_COUNT(value) (ARM_DWT_DWT_PID4_BLOCK_COUNT_Msk & ((value) << ARM_DWT_DWT_PID4_BLOCK_COUNT_Pos))
#define ARM_DWT_DWT_PID4_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_PID4) Register MASK  (Use ARM_DWT_DWT_PID4_Msk instead)  */
#define ARM_DWT_DWT_PID4_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_PID4) Register Mask  */
...
#define ARM_DWT_DWT_PID0_RESETVALUE         _U_(0x0A)                                     /**<  (ARM_DWT_DWT_PID0) Peripheral ID Register 0  Reset Value */

#define ARM_DWT_DWT_PID0_PART_NUMBER_Pos    0                                              /**< (ARM_DWT_DWT_PID0) Part Number Bits 7:0 Position */
#define ARM_DWT_DWT_PID0_PART_NUMBER_Msk    (_U_(0xFF) << ARM_DWT_DWT_PID0_PART_NUMBER_Pos)  /**< (ARM_DWT_DWT_PID0) Part Number Bits 7:0 Mask */
#define ARM_DWT_DWT_PID0_PART_NUMBER(value) (ARM_DWT_DWT_PID0_PART_NUMBER_Msk & ((value) << ARM_DWT_DWT_PID0_PART_NUMBER_Pos))
#define ARM_DWT_DWT_PID0_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_PID0) Register MASK  (Use ARM_DWT_DWT_PID0_Msk instead)  */
#define ARM_DWT_DWT_PID0_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_PID0) Register Mask  */
...
#define ARM_DWT_DWT_PID1_RESETVALUE         _U_(0xB0)                                     /**<  (ARM_DWT_DWT_PID1) Peripheral ID Register 1  Reset Value */

#define ARM_DWT_DWT_PID1_PART_NUMBER_Pos    0                                              /**< (ARM_DWT_DWT_PID1) Part Number Bits 11:8 Position */
#define ARM_DWT_DWT_PID1_PART_NUMBER_Msk    (_U_(0xF) << ARM_DWT_DWT_PID1_PART_NUMBER_Pos)  /**< (ARM_DWT_DWT_PID1) Part Number Bits 11:8 Mask */
...
#define ARM_DWT_DWT_PID1_JEP106_ID_3_0_Msk  (_U_(0xF) << ARM_DWT_DWT_PID1_JEP106_ID_3_0_Pos)  /**< (ARM_DWT_DWT_PID1) JEP106 ID Code Bits 3:0 Mask */
#define ARM_DWT_DWT_PID1_JEP106_ID_3_0(value) (ARM_DWT_DWT_PID1_JEP106_ID_3_0_Msk & ((value) << ARM_DWT_DWT_PID1_JEP106_ID_3_0_Pos))
#define ARM_DWT_DWT_PID1_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_PID1) Register MASK  (Use ARM_DWT_DWT_PID1_Msk instead)  */
#define ARM_DWT_DWT_PID1_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_PID1) Register Mask  */
...
#define ARM_DWT_DWT_PID2_RESETVALUE         _U_(0x0B)                                     /**<  (ARM_DWT_DWT_PID2) Peripheral ID Register 2  Reset Value */

#define ARM_DWT_DWT_PID2_JEP106_ID_6_4_Pos  0                                              /**< (ARM_DWT_DWT_PID2) JEP106 ID Code Bits 6:4 Position */
#define ARM_DWT_DWT_PID2_JEP106_ID_6_4_Msk  (_U_(0x7) << ARM_DWT_DWT_PID2_JEP106_ID_6_4_Pos)  /**< (ARM_DWT_DWT_PID2) JEP106 ID Code Bits 6:4 Mask */
...
#define ARM_DWT_DWT_PID2_JEDEC_USED_Msk     (_U_(0x1) << ARM_DWT_DWT_PID2_JEDEC_USED_Pos)  /**< (ARM_DWT_DWT_PID2) JEDEC Used Mask */
...
#define ARM_DWT_DWT_PID2_REVISION_Msk       (_U_(0xF) << ARM_DWT_DWT_PID2_REVISION_Pos)    /**< (ARM_DWT_DWT_PID2) Revision Mask */
#define ARM_DWT_DWT_PID2_REVISION(value)    (ARM_DWT_DWT_PID2_REVISION_Msk & ((value) << ARM_DWT_DWT_PID2_REVISION_Pos))
#define ARM_DWT_DWT_PID2_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_PID2) Register MASK  (Use ARM_DWT_DWT_PID2_Msk instead)  */
#define ARM_DWT_DWT_PID2_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_PID2) Register Mask  */
...
#define ARM_DWT_DWT_PID3_RESETVALUE         _U_(0x00)                                     /**<  (ARM_DWT_DWT_PID3) Peripheral ID Register 3  Reset Value */

#define ARM_DWT_DWT_PID3_CUSTOMER_MOD_NUMBER_Pos 0                                              /**< (ARM_DWT_DWT_PID3) Customer Modification Number Position */
#define ARM_DWT_DWT_PID3_CUSTOMER_MOD_NUMBER_Msk (_U_(0xF) << ARM_DWT_DWT_PID3_CUSTOMER_MOD_NUMBER_Pos)  /**< (ARM_DWT_DWT_PID3) Customer Modification Number Mask */
...
#define ARM_DWT_DWT_PID3_ECO_REV_NUMBER_Msk (_U_(0xF) << ARM_DWT_DWT_PID3_ECO_REV_NUMBER_Pos)  /**< (ARM_DWT_DWT_PID3) ECO Revision Number Mask */
...
#define ARM_DWT_DWT_PID3_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_PID3) Register MASK  (Use ARM_DWT_DWT_PID3_Msk instead)  */
#define ARM_DWT_DWT_PID3_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_PID3) Register Mask  */
...
#define ARM_DWT_DWT_CID0_RESETVALUE         _U_(0x0D)                                     /**<  (ARM_DWT_DWT_CID0) Component ID Register 0  Reset Value */

#define ARM_DWT_DWT_CID0_DWT_CID0_Pos       0                                              /**< (ARM_DWT_DWT_CID0)  Position */
#define ARM_DWT_DWT_CID0_DWT_CID0_Msk       (_U_(0xFF) << ARM_DWT_DWT_CID0_DWT_CID0_Pos)   /**< (ARM_DWT_DWT_CID0)  Mask */
#define ARM_DWT_DWT_CID0_DWT_CID0(value)    (ARM_DWT_DWT_CID0_DWT_CID0_Msk & ((value) << ARM_DWT_DWT_CID0_DWT_CID0_Pos))
#define ARM_DWT_DWT_CID0_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_CID0) Register MASK  (Use ARM_DWT_DWT_CID0_Msk instead)  */
#define ARM_DWT_DWT_CID0_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_CID0) Register Mask  */
...
#define ARM_DWT_DWT_CID1_RESETVALUE         _U_(0xE0)                                     /**<  (ARM_DWT_DWT_CID1) Component ID Register 1  Reset Value */

#define ARM_DWT_DWT_CID1_DWT_CID1_Pos       0                                              /**< (ARM_DWT_DWT_CID1)  Position */
#define ARM_DWT_DWT_CID1_DWT_CID1_Msk       (_U_(0xFF) << ARM_DWT_DWT_CID1_DWT_CID1_Pos)   /**< (ARM_DWT_DWT_CID1)  Mask */
#define ARM_DWT_DWT_CID1_DWT_CID1(value)    (ARM_DWT_DWT_CID1_DWT_CID1_Msk & ((value) << ARM_DWT_DWT_CID1_DWT_CID1_Pos))
#define ARM_DWT_DWT_CID1_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_CID1) Register MASK  (Use ARM_DWT_DWT_CID1_Msk instead)  */
#define ARM_DWT_DWT_CID1_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_CID1) Register Mask  */
...
#define ARM_DWT_DWT_CID2_RESETVALUE         _U_(0x05)                                     /**<  (ARM_DWT_DWT_CID2) Component ID Register 2  Reset Value */

#define ARM_DWT_DWT_CID2_DWT_CID2_Pos       0                                              /**< (ARM_DWT_DWT_CID2)  Position */
#define ARM_DWT_DWT_CID2_DWT_CID2_Msk       (_U_(0xFF) << ARM_DWT_DWT_CID2_DWT_CID2_Pos)   /**< (ARM_DWT_DWT_CID2)  Mask */
#define ARM_DWT_DWT_CID2_DWT_CID2(value)    (ARM_DWT_DWT_CID2_DWT_CID2_Msk & ((value) << ARM_DWT_DWT_CID2_DWT_CID2_Pos))
#define ARM_DWT_DWT_CID2_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_CID2) Register MASK  (Use ARM_DWT_DWT_CID2_Msk instead)  */
#define ARM_DWT_DWT_CID2_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_CID2) Register Mask  */
...
#define ARM_DWT_DWT_CID3_RESETVALUE         _U_(0xB1)                                     /**<  (ARM_DWT_DWT_CID3) Component ID Register 3  Reset Value */

#define ARM_DWT_DWT_CID3_DWT_CID3_Pos       0                                              /**< (ARM_DWT_DWT_CID3)  Position */
#define ARM_DWT_DWT_CID3_DWT_CID3_Msk       (_U_(0xFF) << ARM_DWT_DWT_CID3_DWT_CID3_Pos)   /**< (ARM_DWT_DWT_CID3)  Mask */
#define ARM_DWT_DWT_CID3_DWT_CID3(value)    (ARM_DWT_DWT_CID3_DWT_CID3_Msk & ((value) << ARM_DWT_DWT_CID3_DWT_CID3_Pos))
#define ARM_DWT_DWT_CID3_MASK               _U_(0xFF)                                      /**< \deprecated (ARM_DWT_DWT_CID3) Register MASK  (Use ARM_DWT_DWT_CID3_Msk instead)  */
#define ARM_DWT_DWT_CID3_Msk                _U_(0xFF)                                      /**< (ARM_DWT_DWT_CID3) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of ARM DWT Control */

#endif /* _SAMB11_ARM_DWT_COMPONENT_H_ */
