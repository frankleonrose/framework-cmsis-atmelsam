...
#ifndef _SAMB11_AON_PWR_SEQ_COMPONENT_H_
#define _SAMB11_AON_PWR_SEQ_COMPONENT_H_
#define _SAMB11_AON_PWR_SEQ_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 Always On Power Sequencer
 *  @{
 */
/* ========================================================================== */
...
#define AON_PWR_SEQ_AONPS1234                  /**< (AON_PWR_SEQ) Module ID */
#define REV_AON_PWR_SEQ 0x100                  /**< (AON_PWR_SEQ) Module revision */
...
#define AON_PWR_SEQ_GPIO_WAKEUP_CTRL_RESETVALUE _U_(0x02)                                     /**<  (AON_PWR_SEQ_GPIO_WAKEUP_CTRL) Controls the wakeup enable for GPIO_0, GPIO_1 and GPIO_2 (Pinmux will control the ARM wakeup)  Reset Value */
...
#define AON_PWR_SEQ_GPIO_WAKEUP_CTRL_BLE_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_GPIO_WAKEUP_CTRL_BLE_ENABLE_Pos)  /**< (AON_PWR_SEQ_GPIO_WAKEUP_CTRL) If set, this will enable GPIO_0 to wake up the BLE domain (PD4, PD5 and PD6) Mask */
...
#define AON_PWR_SEQ_GPIO_WAKEUP_CTRL_MASK   _U_(0x02)                                      /**< \deprecated (AON_PWR_SEQ_GPIO_WAKEUP_CTRL) Register MASK  (Use AON_PWR_SEQ_GPIO_WAKEUP_CTRL_Msk instead)  */
#define AON_PWR_SEQ_GPIO_WAKEUP_CTRL_Msk    _U_(0x02)                                      /**< (AON_PWR_SEQ_GPIO_WAKEUP_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_AON_ST_WAKEUP_CTRL) Controls the wakeup enable for the Always On Sleep Timer (AON_ST)  Reset Value */
...
#define AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_ARM_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_ARM_ENABLE_Pos)  /**< (AON_PWR_SEQ_AON_ST_WAKEUP_CTRL) If set, this will enable the AON_ST to wake up the ARM domain (PD1, PD2 and PD3) Mask */
...
#define AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_BLE_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_BLE_ENABLE_Pos)  /**< (AON_PWR_SEQ_AON_ST_WAKEUP_CTRL) If set, this will enable the AON_ST to wake up the BLE domain (PD4, PD5 and PD6) Mask */
...
#define AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_MASK _U_(0x03)                                      /**< \deprecated (AON_PWR_SEQ_AON_ST_WAKEUP_CTRL) Register MASK  (Use AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_Msk instead)  */
#define AON_PWR_SEQ_AON_ST_WAKEUP_CTRL_Msk  _U_(0x03)                                      /**< (AON_PWR_SEQ_AON_ST_WAKEUP_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_LPMCU_WAKEUP_CTRL) Controls the wakeup enable for the Low Power Micro Controller Unit (LPMCU)  Reset Value */
...
#define AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_BLE_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_BLE_ENABLE_Pos)  /**< (AON_PWR_SEQ_LPMCU_WAKEUP_CTRL) If set, this will enable the LPMCU to wake up the BLE domain (PD4, PD5 and PD6) Mask */
...
#define AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_PD7_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_PD7_ENABLE_Pos)  /**< (AON_PWR_SEQ_LPMCU_WAKEUP_CTRL) If set, this will enable the LPMCU to wakeup the PD7 domain (EFUSE) Mask */
...
#define AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_MASK  _U_(0x240)                                     /**< \deprecated (AON_PWR_SEQ_LPMCU_WAKEUP_CTRL) Register MASK  (Use AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_Msk instead)  */
#define AON_PWR_SEQ_LPMCU_WAKEUP_CTRL_Msk   _U_(0x240)                                     /**< (AON_PWR_SEQ_LPMCU_WAKEUP_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL) Controls the wakeup enable for the BLE Sleep Timer (BLE_ST)  Reset Value */
...
#define AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_ARM_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_ARM_ENABLE_Pos)  /**< (AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL) If set, this will enable the BLE_ST to wake up the ARM domain Mask */
...
#define AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_BLE_ENABLE_Msk (_U_(0x1) << AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_BLE_ENABLE_Pos)  /**< (AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL) If set, this will enable the BLE_ST to wake up the BLE domain Mask */
...
#define AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_MASK _U_(0x03)                                      /**< \deprecated (AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL) Register MASK  (Use AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_Msk instead)  */
#define AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL_Msk  _U_(0x03)                                      /**< (AON_PWR_SEQ_BLE_ST_WAKEUP_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Controls the sleep and retention options for SLEEP request 1 from the ARM  Reset Value */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_ARM_SLEEP_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_ARM_SLEEP_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Enables the SLEEP request 1 to put all ARM domains in sleep or retention (PD1, PD2A, PD2B, PD3, PD8).  PD7 has its own control Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_BLE_SLEEP_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_BLE_SLEEP_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Enables the SLEEP request 1 to put PD4 domain in sleep (BLE Core) and PD5 (BLE memories) in sleep or retention Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD6_SLEEP_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD6_SLEEP_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Enables the SLEEP request 1 to put PD6 domain in sleep (BLE Sleep Timer) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD7_SLEEP_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD7_SLEEP_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Enables the SLEEP request 1 to put PD7 domain in sleep (EFUSE) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD2A_RETENTION_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD2A_RETENTION_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) If 1, then PD2A will be put in retention mode when instructed to go to sleep (First ARM Memory 16K) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD2B_RETENTION_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD2B_RETENTION_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) If 1, then PD2B will be put in retention mode when instructed to go to sleep (Second ARM Memory 16K) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD3_RETENTION_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD3_RETENTION_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) If 1, then PD3 will be put in retention mode when instructed to go to sleep (Third, Fourth and Fifth ARM Memories 3x32K = 96K) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD5_RETENTION_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD5_RETENTION_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) If 1, then PD5 will be put in retention mode when instructed to go to sleep (BLE Retention Memory) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD8_RETENTION_EN_Msk (_U_(0x1) << AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_PD8_RETENTION_EN_Pos)  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) If 1, then PD8 will be put in retention mode when instructed to go to sleep (BLE LP Memory) Mask */
...
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_MASK _U_(0x670341)                                  /**< \deprecated (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Register MASK  (Use AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_Msk instead)  */
#define AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL_Msk  _U_(0x670341)                                  /**< (AON_PWR_SEQ_LPMCU_SLEEP_1_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_RESETVALUE _U_(0x4030001)                                /**<  (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Power OFF Delays  Reset Value */
...
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_CLOCK_EN_EARLY_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_0_CTRL_CLOCK_EN_EARLY_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Number of clock cycles before setting clock_en_early to low (clock_en is +1 of this value) Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_ISOLATE_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_0_CTRL_ISOLATE_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Number of clock cycles before enabling the isolation cells Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_RESETN_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_0_CTRL_RESETN_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Number of clock cycles before asserting RESETN Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_MASK   _U_(0x3F3F003F)                                /**< \deprecated (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Register MASK  (Use AON_PWR_SEQ_OFF_DELAY_0_CTRL_Msk instead)  */
#define AON_PWR_SEQ_OFF_DELAY_0_CTRL_Msk    _U_(0x3F3F003F)                                /**< (AON_PWR_SEQ_OFF_DELAY_0_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_RESETVALUE _U_(0x8070605)                                /**<  (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Power OFF Delays  Reset Value */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_BTRIM_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_1_CTRL_BTRIM_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Number of clock cycles before applying BTRIM mux select Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_STDBY_N_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_1_CTRL_STDBY_N_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Number of clock cycles before applying STDBY_N Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_POWER_VDD_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_1_CTRL_POWER_VDD_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Number of clock cycles before cutting off power (VDD and standard cells) Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_POWER_VDM_Msk (_U_(0x3F) << AON_PWR_SEQ_OFF_DELAY_1_CTRL_POWER_VDM_Pos)  /**< (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Number of clock cycles before cutting off or lowering power (VDM) Mask */
...
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_MASK   _U_(0x3F3F3F3F)                                /**< \deprecated (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Register MASK  (Use AON_PWR_SEQ_OFF_DELAY_1_CTRL_Msk instead)  */
#define AON_PWR_SEQ_OFF_DELAY_1_CTRL_Msk    _U_(0x3F3F3F3F)                                /**< (AON_PWR_SEQ_OFF_DELAY_1_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_ON_DELAY_0_CTRL_RESETVALUE _U_(0x2727)                                   /**<  (AON_PWR_SEQ_ON_DELAY_0_CTRL) Power ON Delays  Reset Value */
...
#define AON_PWR_SEQ_ON_DELAY_0_CTRL_CLOCK_EN_EARLY_ARM_Msk (_U_(0x3F) << AON_PWR_SEQ_ON_DELAY_0_CTRL_CLOCK_EN_EARLY_ARM_Pos)  /**< (AON_PWR_SEQ_ON_DELAY_0_CTRL) Number of clock cycles before setting clock_en_early to high for ARM domain clock_en is +1 of this value isolate is -2 of this value resetn is -1 of this value  Mask */
...
#define AON_PWR_SEQ_ON_DELAY_0_CTRL_MASK    _U_(0x3F3F)                                    /**< \deprecated (AON_PWR_SEQ_ON_DELAY_0_CTRL) Register MASK  (Use AON_PWR_SEQ_ON_DELAY_0_CTRL_Msk instead)  */
#define AON_PWR_SEQ_ON_DELAY_0_CTRL_Msk     _U_(0x3F3F)                                    /**< (AON_PWR_SEQ_ON_DELAY_0_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_RESETVALUE _U_(0x1020304)                                /**<  (AON_PWR_SEQ_ON_DELAY_1_CTRL) Power ON Delays  Reset Value */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_BTRIM_Msk (_U_(0x3F) << AON_PWR_SEQ_ON_DELAY_1_CTRL_BTRIM_Pos)  /**< (AON_PWR_SEQ_ON_DELAY_1_CTRL) Number of clock cycles before removing BTRIM mux select Mask */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_STDBY_N_Msk (_U_(0x3F) << AON_PWR_SEQ_ON_DELAY_1_CTRL_STDBY_N_Pos)  /**< (AON_PWR_SEQ_ON_DELAY_1_CTRL) Number of clock cycles before de-asserting the STDBY_N Mask */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_POWER_VDD_Msk (_U_(0x3F) << AON_PWR_SEQ_ON_DELAY_1_CTRL_POWER_VDD_Pos)  /**< (AON_PWR_SEQ_ON_DELAY_1_CTRL) Number of clock cycles before applying VDD power Mask */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_POWER_VDM_Msk (_U_(0x3F) << AON_PWR_SEQ_ON_DELAY_1_CTRL_POWER_VDM_Pos)  /**< (AON_PWR_SEQ_ON_DELAY_1_CTRL) Number of clock cycles before applying VDM power Mask */
...
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_MASK    _U_(0x3F3F3F3F)                                /**< \deprecated (AON_PWR_SEQ_ON_DELAY_1_CTRL) Register MASK  (Use AON_PWR_SEQ_ON_DELAY_1_CTRL_Msk instead)  */
#define AON_PWR_SEQ_ON_DELAY_1_CTRL_Msk     _U_(0x3F3F3F3F)                                /**< (AON_PWR_SEQ_ON_DELAY_1_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_RESETVALUE _U_(0x2106)                                   /**<  (AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL) VDD_DCDC_EN Delay Control  Reset Value */
...
#define AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_OFF_Msk (_U_(0x3F) << AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_OFF_Pos)  /**< (AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL) Number of clock cycles before disabling the DCDC Mask */
...
#define AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_ON_Msk (_U_(0x3F) << AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_ON_Pos)  /**< (AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL) Number of clock cycles before turning on the DCDC Mask */
...
#define AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_MASK _U_(0x3F3F)                                    /**< \deprecated (AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL) Register MASK  (Use AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_Msk instead)  */
#define AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL_Msk _U_(0x3F3F)                                    /**< (AON_PWR_SEQ_VDD_DCDC_EN_DELAY_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_RESETVALUE _U_(0x88)                                     /**<  (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Bypass control for misc signals  Reset Value */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_PD0_LOW_VOLTAGE_EN_VAL_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_PD0_LOW_VOLTAGE_EN_VAL_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Bypass value for pd0_low_voltage_en Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_PD0_LOW_VOLTAGE_EN_EN_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_PD0_LOW_VOLTAGE_EN_EN_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Bypass enable for pd0_low_voltage_en Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_ENABLE_CLOCK_GATE_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_ENABLE_CLOCK_GATE_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) If set, allows the AON PS to gate its own clock while waiting for an event to enable it again Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_VDD_DCDC_EN_VAL_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_VDD_DCDC_EN_VAL_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Bypass value for vdd_dcdc_en Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_VDD_DCDC_EN_EN_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_VDD_DCDC_EN_EN_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Bypass enable for vdd_dcdc_en Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_FORCE_ON_BLE_CORE_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_FORCE_ON_BLE_CORE_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) If set, this will keep the power enabled for the BLE Core (enables the DCDC operation) Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_FORCE_ON_BLE_MEMORIES_Msk (_U_(0x1) << AON_PWR_SEQ_MISC_BYPASS_0_CTRL_FORCE_ON_BLE_MEMORIES_Pos)  /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) If set, this will keep the power enabled for the BLE memories (enables the DCDC operation) Mask */
...
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_MASK _U_(0x3DC)                                     /**< \deprecated (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Register MASK  (Use AON_PWR_SEQ_MISC_BYPASS_0_CTRL_Msk instead)  */
#define AON_PWR_SEQ_MISC_BYPASS_0_CTRL_Msk  _U_(0x3DC)                                     /**< (AON_PWR_SEQ_MISC_BYPASS_0_CTRL) Register Mask  */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_RAW_WAKEUP_BITS) Raw Wakeup Bits  Reset Value */

#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_0_Pos 0                                              /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) AO_GPIO_0 wakeup raw status Position */
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_0_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_0_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) AO_GPIO_0 wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_1_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_1_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) AO_GPIO_1 wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_2_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO_2_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) AO_GPIO_2 wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_AON_ST_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_AON_ST_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) AON_ST wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_LPMCU_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_LPMCU_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) LPMCU wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_BLE_ST_Msk (_U_(0x1) << AON_PWR_SEQ_RAW_WAKEUP_BITS_BLE_ST_Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) BLE_ST wakeup raw status Mask */
...
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_MASK    _U_(0x3F)                                      /**< \deprecated (AON_PWR_SEQ_RAW_WAKEUP_BITS) Register MASK  (Use AON_PWR_SEQ_RAW_WAKEUP_BITS_Msk instead)  */
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_Msk     _U_(0x3F)                                      /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS) Register Mask  */

#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO__Pos 0                                              /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS Position) AO_GPIO_x wakeup raw status */
#define AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO__Msk (_U_(0x7) << AON_PWR_SEQ_RAW_WAKEUP_BITS_GPIO__Pos)  /**< (AON_PWR_SEQ_RAW_WAKEUP_BITS Mask) GPIO_ */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_PD_WAKEUP_BITS) Individual Power Domain Wakeup Bits  Reset Value */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_ARM_Msk  (_U_(0x1) << AON_PWR_SEQ_PD_WAKEUP_BITS_ARM_Pos)  /**< (AON_PWR_SEQ_PD_WAKEUP_BITS) Indicates ARM (PD1, PD2A, PD2B, PD3, PD8) currently has a wakeup active Mask */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_BLE_Msk  (_U_(0x1) << AON_PWR_SEQ_PD_WAKEUP_BITS_BLE_Pos)  /**< (AON_PWR_SEQ_PD_WAKEUP_BITS) Indicates BLE (PD4 and PD5) currently has a wakeup active Mask */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_PD6_Msk  (_U_(0x1) << AON_PWR_SEQ_PD_WAKEUP_BITS_PD6_Pos)  /**< (AON_PWR_SEQ_PD_WAKEUP_BITS) Indicates PD6 currently has a wakeup active Mask */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_PD7_Msk  (_U_(0x1) << AON_PWR_SEQ_PD_WAKEUP_BITS_PD7_Pos)  /**< (AON_PWR_SEQ_PD_WAKEUP_BITS) Indicates PD7 currently has a wakeup active Mask */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_MASK     _U_(0x341)                                     /**< \deprecated (AON_PWR_SEQ_PD_WAKEUP_BITS) Register MASK  (Use AON_PWR_SEQ_PD_WAKEUP_BITS_Msk instead)  */
#define AON_PWR_SEQ_PD_WAKEUP_BITS_Msk      _U_(0x341)                                     /**< (AON_PWR_SEQ_PD_WAKEUP_BITS) Register Mask  */
...
#define AON_PWR_SEQ_PD_WAKEUP_BITS_PD_Msk   (_U_(0x3) << AON_PWR_SEQ_PD_WAKEUP_BITS_PD_Pos)  /**< (AON_PWR_SEQ_PD_WAKEUP_BITS Mask) PD */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_SERVICED_REQUEST) Serviced Request Status Bits  Reset Value */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_GPIO_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_SERVICED_REQUEST_GPIO_WAKEUP_Pos)  /**< (AON_PWR_SEQ_SERVICED_REQUEST) Indicates GPIO wakeup has been serviced Mask */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_AON_ST_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_SERVICED_REQUEST_AON_ST_WAKEUP_Pos)  /**< (AON_PWR_SEQ_SERVICED_REQUEST) Indicates AON_ST wakeup has been serviced Mask */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_LPMCU_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_SERVICED_REQUEST_LPMCU_WAKEUP_Pos)  /**< (AON_PWR_SEQ_SERVICED_REQUEST) Indicates LPMCU wakeup has been serviced Mask */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_BLE_ST_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_SERVICED_REQUEST_BLE_ST_WAKEUP_Pos)  /**< (AON_PWR_SEQ_SERVICED_REQUEST) Indicates BLE_ST wakeup has been serviced Mask */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_SLEEP_1_Msk (_U_(0x1) << AON_PWR_SEQ_SERVICED_REQUEST_SLEEP_1_Pos)  /**< (AON_PWR_SEQ_SERVICED_REQUEST) Indicates SLEEP 1 has been serviced Mask */
...
#define AON_PWR_SEQ_SERVICED_REQUEST_MASK   _U_(0x139)                                     /**< \deprecated (AON_PWR_SEQ_SERVICED_REQUEST) Register MASK  (Use AON_PWR_SEQ_SERVICED_REQUEST_Msk instead)  */
#define AON_PWR_SEQ_SERVICED_REQUEST_Msk    _U_(0x139)                                     /**< (AON_PWR_SEQ_SERVICED_REQUEST) Register Mask  */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_ACTIVE_REQUEST) Active Request Status Bits  Reset Value */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_GPIO_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_ACTIVE_REQUEST_GPIO_WAKEUP_Pos)  /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Indicates GPIO wakeup is the active request Mask */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_AON_ST_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_ACTIVE_REQUEST_AON_ST_WAKEUP_Pos)  /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Indicates AON_ST wakeup is the active request Mask */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_LPMCU_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_ACTIVE_REQUEST_LPMCU_WAKEUP_Pos)  /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Indicates LPMCU wakeup is the active request Mask */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_BLE_ST_WAKEUP_Msk (_U_(0x1) << AON_PWR_SEQ_ACTIVE_REQUEST_BLE_ST_WAKEUP_Pos)  /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Indicates BLE_ST wakeup is the active request Mask */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_SLEEP_1_Msk (_U_(0x1) << AON_PWR_SEQ_ACTIVE_REQUEST_SLEEP_1_Pos)  /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Indicates SLEEP 1 is the active request Mask */
...
#define AON_PWR_SEQ_ACTIVE_REQUEST_MASK     _U_(0x139)                                     /**< \deprecated (AON_PWR_SEQ_ACTIVE_REQUEST) Register MASK  (Use AON_PWR_SEQ_ACTIVE_REQUEST_Msk instead)  */
#define AON_PWR_SEQ_ACTIVE_REQUEST_Msk      _U_(0x139)                                     /**< (AON_PWR_SEQ_ACTIVE_REQUEST) Register Mask  */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_RESETVALUE _U_(0x00)                                     /**<  (AON_PWR_SEQ_LOGIC_FSM_STATES) Current Logic FSM States  Reset Value */

#define AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_Pos 0                                              /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) Main FSM State Position */
#define AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_Msk (_U_(0x7) << AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) Main FSM State Mask */
...
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_0_Val _U_(0x0)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) RESET  */
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_1_Val _U_(0x1)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) READY  */
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_2_Val _U_(0x2)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) TRANS  */
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_3_Val _U_(0x3)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) RESET_TO_READY  */
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_4_Val _U_(0x4)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) READY_TO_TRANS  */
#define   AON_PWR_SEQ_LOGIC_FSM_STATES_MAIN_FSM_STATE_5_Val _U_(0x5)                                       /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) TRANS_TO_READY  */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_BLE_ON_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_BLE_ON_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD4 and PD5 are ON Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_BLE_OFF_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_BLE_OFF_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD4 and PD5 are OFF (PD5 is in RET if set by ARM) Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_PD6_ON_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_PD6_ON_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD6 is ON Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_PD6_OFF_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_PD6_OFF_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD6 is OFF Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_PD7_ON_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_PD7_ON_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD7 is ON Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_PD7_OFF_STATE_Msk (_U_(0x1) << AON_PWR_SEQ_LOGIC_FSM_STATES_PD7_OFF_STATE_Pos)  /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) If 1, then PD7 is OFF Mask */
...
#define AON_PWR_SEQ_LOGIC_FSM_STATES_MASK   _U_(0x33307)                                   /**< \deprecated (AON_PWR_SEQ_LOGIC_FSM_STATES) Register MASK  (Use AON_PWR_SEQ_LOGIC_FSM_STATES_Msk instead)  */
#define AON_PWR_SEQ_LOGIC_FSM_STATES_Msk    _U_(0x33307)                                   /**< (AON_PWR_SEQ_LOGIC_FSM_STATES) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of Always On Power Sequencer */

#endif /* _SAMB11_AON_PWR_SEQ_COMPONENT_H_ */
