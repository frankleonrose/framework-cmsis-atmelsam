...
#ifndef _SAMB11_I2C_COMPONENT_H_
#define _SAMB11_I2C_COMPONENT_H_
#define _SAMB11_I2C_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 I2C Master/Slave Controller
 *  @{
 */
/* ========================================================================== */
...
#define I2C_I1234                      /**< (I2C) Module ID */
#define REV_I2C 0x100                  /**< (I2C) Module revision */
...
#define I2C_TRANSMIT_DATA_RESETVALUE        _U_(0x00)                                     /**<  (I2C_TRANSMIT_DATA) Writes one byte to I2C Transmit Data FIFO.   Reset Value */
...
#define I2C_TRANSMIT_DATA_TX_DATA_Msk       (_U_(0xFF) << I2C_TRANSMIT_DATA_TX_DATA_Pos)   /**< (I2C_TRANSMIT_DATA) Represents either Tx Data, or Address and Direction if address flag is set.  Mask */
...
#define I2C_TRANSMIT_DATA_ADDRESS_FLAG_Msk  (_U_(0x1) << I2C_TRANSMIT_DATA_ADDRESS_FLAG_Pos)  /**< (I2C_TRANSMIT_DATA) Specifies that tx_data field is used for address and direction. Mask */
...
#define   I2C_TRANSMIT_DATA_ADDRESS_FLAG_0_Val _U_(0x0)                                       /**< (I2C_TRANSMIT_DATA) tx_data field bits 7:0 are Transmit Data  */
#define   I2C_TRANSMIT_DATA_ADDRESS_FLAG_1_Val _U_(0x1)                                       /**< (I2C_TRANSMIT_DATA) tx_data field bit 0 is direction (0: write to slave, 1: read from slave), and bits 7:1 are the Address to transmit.  */
...
#define I2C_TRANSMIT_DATA_MASK              _U_(0x1FF)                                     /**< \deprecated (I2C_TRANSMIT_DATA) Register MASK  (Use I2C_TRANSMIT_DATA_Msk instead)  */
#define I2C_TRANSMIT_DATA_Msk               _U_(0x1FF)                                     /**< (I2C_TRANSMIT_DATA) Register Mask  */
...
#define I2C_RECEIVE_DATA_RESETVALUE         _U_(0x00)                                     /**<  (I2C_RECEIVE_DATA) Read one byte from I2C Receive Data FIFO.   Reset Value */

#define I2C_RECEIVE_DATA_RX_BYTE_Pos        0                                              /**< (I2C_RECEIVE_DATA) Oldest data in receive FIFO.  Position */
#define I2C_RECEIVE_DATA_RX_BYTE_Msk        (_U_(0xFF) << I2C_RECEIVE_DATA_RX_BYTE_Pos)    /**< (I2C_RECEIVE_DATA) Oldest data in receive FIFO.  Mask */
#define I2C_RECEIVE_DATA_RX_BYTE(value)     (I2C_RECEIVE_DATA_RX_BYTE_Msk & ((value) << I2C_RECEIVE_DATA_RX_BYTE_Pos))
#define I2C_RECEIVE_DATA_MASK               _U_(0xFF)                                      /**< \deprecated (I2C_RECEIVE_DATA) Register MASK  (Use I2C_RECEIVE_DATA_Msk instead)  */
#define I2C_RECEIVE_DATA_Msk                _U_(0xFF)                                      /**< (I2C_RECEIVE_DATA) Register Mask  */
...
#define I2C_TRANSMIT_STATUS_RESETVALUE      _U_(0x00)                                     /**<  (I2C_TRANSMIT_STATUS) Status of the I2C transmitter. Each field can generate an interrupt if corresponding bit in  the Tx interrupt mask register is set.   Reset Value */
...
#define I2C_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Msk (_U_(0x1) << I2C_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Pos)  /**< (I2C_TRANSMIT_STATUS) Active High indication when Tx FIFO can still accepts at least one more character. Mask */
...
#define   I2C_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_0_Val _U_(0x0)                                       /**< (I2C_TRANSMIT_STATUS) TX FIFO Full  */
#define   I2C_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_1_Val _U_(0x1)                                       /**< (I2C_TRANSMIT_STATUS) TX FIFO not Full  */
...
#define I2C_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Msk (_U_(0x1) << I2C_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Pos)  /**< (I2C_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least quarter empty. Reset when more.  Mask */
...
#define I2C_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Msk (_U_(0x1) << I2C_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Pos)  /**< (I2C_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least half empty. Reset when more.  Mask */
...
#define I2C_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Msk (_U_(0x1) << I2C_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Pos)  /**< (I2C_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least three quarters empty. Reset when more.  Mask */
...
#define I2C_TRANSMIT_STATUS_TX_FIFO_EMPTY_Msk (_U_(0x1) << I2C_TRANSMIT_STATUS_TX_FIFO_EMPTY_Pos)  /**< (I2C_TRANSMIT_STATUS) Active High indication when Tx FIFO is Empty and has no more character to transmit  Mask */
...
#define I2C_TRANSMIT_STATUS_MASK            _U_(0x1F)                                      /**< \deprecated (I2C_TRANSMIT_STATUS) Register MASK  (Use I2C_TRANSMIT_STATUS_Msk instead)  */
#define I2C_TRANSMIT_STATUS_Msk             _U_(0x1F)                                      /**< (I2C_TRANSMIT_STATUS) Register Mask  */
...
#define I2C_RECEIVE_STATUS_RESETVALUE       _U_(0x00)                                     /**<  (I2C_RECEIVE_STATUS) Status of the I2C receiver. Each field can generate an interrupt if corresponding bit in  the Rx interrupt mask register is set.   Reset Value */
...
#define I2C_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Msk (_U_(0x1) << I2C_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Pos)  /**< (I2C_RECEIVE_STATUS) Active High indication when data is available in Rx FIFO Mask */
...
#define I2C_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Msk (_U_(0x1) << I2C_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Pos)  /**< (I2C_RECEIVE_STATUS) Active High indication when FIFO is at least quarter full. Reset when less.  Mask */
...
#define I2C_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Msk (_U_(0x1) << I2C_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Pos)  /**< (I2C_RECEIVE_STATUS) Active High indication when FIFO is at least half full. Reset when less.  Mask */
...
#define I2C_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Msk (_U_(0x1) << I2C_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Pos)  /**< (I2C_RECEIVE_STATUS) Active High indication when FIFO is at least three quarters full. Reset when less.  Mask */
...
#define I2C_RECEIVE_STATUS_FIFO_OVERRUN_Msk (_U_(0x1) << I2C_RECEIVE_STATUS_FIFO_OVERRUN_Pos)  /**< (I2C_RECEIVE_STATUS) Active High indication when character is received but FIFO is full. Reset by reading  the status register.  Mask */
...
#define I2C_RECEIVE_STATUS_NAK_Msk          (_U_(0x1) << I2C_RECEIVE_STATUS_NAK_Pos)       /**< (I2C_RECEIVE_STATUS) Active High indication when NAK is received. The I2C module will retry transmission  unless transaction aborted by the flush register.  Mask */
...
#define I2C_RECEIVE_STATUS_MASK             _U_(0x3F)                                      /**< \deprecated (I2C_RECEIVE_STATUS) Register MASK  (Use I2C_RECEIVE_STATUS_Msk instead)  */
#define I2C_RECEIVE_STATUS_Msk              _U_(0x3F)                                      /**< (I2C_RECEIVE_STATUS) Register Mask  */
...
#define I2C_CLOCK_SOURCE_SELECT_RESETVALUE  _U_(0x00)                                     /**<  (I2C_CLOCK_SOURCE_SELECT) Clock Source Select  Reset Value */

#define I2C_CLOCK_SOURCE_SELECT_CLOCK_Pos   0                                              /**< (I2C_CLOCK_SOURCE_SELECT) Clock Used to Generate Divided Clock Position */
#define I2C_CLOCK_SOURCE_SELECT_CLOCK_Msk   (_U_(0x3) << I2C_CLOCK_SOURCE_SELECT_CLOCK_Pos)  /**< (I2C_CLOCK_SOURCE_SELECT) Clock Used to Generate Divided Clock Mask */
#define I2C_CLOCK_SOURCE_SELECT_CLOCK(value) (I2C_CLOCK_SOURCE_SELECT_CLOCK_Msk & ((value) << I2C_CLOCK_SOURCE_SELECT_CLOCK_Pos))
#define   I2C_CLOCK_SOURCE_SELECT_CLOCK_0_Val _U_(0x0)                                       /**< (I2C_CLOCK_SOURCE_SELECT) 26 MHz Clock  */
#define   I2C_CLOCK_SOURCE_SELECT_CLOCK_1_Val _U_(0x1)                                       /**< (I2C_CLOCK_SOURCE_SELECT) 13 MHz Clock  */
#define   I2C_CLOCK_SOURCE_SELECT_CLOCK_2_Val _U_(0x2)                                       /**< (I2C_CLOCK_SOURCE_SELECT) 6.5 MHz Clock  */
#define   I2C_CLOCK_SOURCE_SELECT_CLOCK_3_Val _U_(0x3)                                       /**< (I2C_CLOCK_SOURCE_SELECT) 3.25 MHz Clock  */
...
#define I2C_CLOCK_SOURCE_SELECT_MASK        _U_(0x03)                                      /**< \deprecated (I2C_CLOCK_SOURCE_SELECT) Register MASK  (Use I2C_CLOCK_SOURCE_SELECT_Msk instead)  */
#define I2C_CLOCK_SOURCE_SELECT_Msk         _U_(0x03)                                      /**< (I2C_CLOCK_SOURCE_SELECT) Register Mask  */
...
#define I2C_MODULE_ENABLE_RESETVALUE        _U_(0x00)                                     /**<  (I2C_MODULE_ENABLE) I2C Enable  Reset Value */

#define I2C_MODULE_ENABLE_ENABLE_Pos        0                                              /**< (I2C_MODULE_ENABLE) Enables I2C Operation Position */
#define I2C_MODULE_ENABLE_ENABLE_Msk        (_U_(0x1) << I2C_MODULE_ENABLE_ENABLE_Pos)     /**< (I2C_MODULE_ENABLE) Enables I2C Operation Mask */
...
#define I2C_MODULE_ENABLE_MASK              _U_(0x01)                                      /**< \deprecated (I2C_MODULE_ENABLE) Register MASK  (Use I2C_MODULE_ENABLE_Msk instead)  */
#define I2C_MODULE_ENABLE_Msk               _U_(0x01)                                      /**< (I2C_MODULE_ENABLE) Register Mask  */
...
#define I2C_CLK_DIVIDER_RESETVALUE          _U_(0x00)                                     /**<  (I2C_CLK_DIVIDER) Register sets the divide ratio used to generate the sck clock from the module's input clock.   Reset Value */
...
#define I2C_CLK_DIVIDER_I2C_DIVIDE_RATIO_Msk (_U_(0xFFFF) << I2C_CLK_DIVIDER_I2C_DIVIDE_RATIO_Pos)  /**< (I2C_CLK_DIVIDER) Clock Divide Ratio. The input clock signal is divided by (n+1) where n is the value set in  this field.  The minimum division is by 2; a value of 0 is illegal.  Mask */
...
#define I2C_CLK_DIVIDER_MASK                _U_(0xFFFF)                                    /**< \deprecated (I2C_CLK_DIVIDER) Register MASK  (Use I2C_CLK_DIVIDER_Msk instead)  */
#define I2C_CLK_DIVIDER_Msk                 _U_(0xFFFF)                                    /**< (I2C_CLK_DIVIDER) Register Mask  */
...
#define I2C_MASTER_MODE_RESETVALUE          _U_(0x00)                                     /**<  (I2C_MASTER_MODE) Selects I2C Master or Slave Mode.   Reset Value */

#define I2C_MASTER_MODE_MASTER_ENABLE_Pos   0                                              /**< (I2C_MASTER_MODE) Active High I2C Master Mode Enable Position */
#define I2C_MASTER_MODE_MASTER_ENABLE_Msk   (_U_(0x1) << I2C_MASTER_MODE_MASTER_ENABLE_Pos)  /**< (I2C_MASTER_MODE) Active High I2C Master Mode Enable Mask */
...
#define   I2C_MASTER_MODE_MASTER_ENABLE_0_Val _U_(0x0)                                       /**< (I2C_MASTER_MODE) I2C Slave  */
#define   I2C_MASTER_MODE_MASTER_ENABLE_1_Val _U_(0x1)                                       /**< (I2C_MASTER_MODE) I2C Master  */
...
#define I2C_MASTER_MODE_MASK                _U_(0x01)                                      /**< \deprecated (I2C_MASTER_MODE) Register MASK  (Use I2C_MASTER_MODE_Msk instead)  */
#define I2C_MASTER_MODE_Msk                 _U_(0x01)                                      /**< (I2C_MASTER_MODE) Register Mask  */
...
#define I2C_ONBUS_RESETVALUE                _U_(0x00)                                     /**<  (I2C_ONBUS) Enable/Disable transactions when in Master Mode.   Reset Value */

#define I2C_ONBUS_ONBUS_ENABLE_Pos          0                                              /**< (I2C_ONBUS) Active High Enable to initiate transactions when in Master Mode. Position */
#define I2C_ONBUS_ONBUS_ENABLE_Msk          (_U_(0x1) << I2C_ONBUS_ONBUS_ENABLE_Pos)       /**< (I2C_ONBUS) Active High Enable to initiate transactions when in Master Mode. Mask */
...
#define   I2C_ONBUS_ONBUS_ENABLE_0_Val      _U_(0x0)                                       /**< (I2C_ONBUS) Master completes current byte and generates stop condition on bus.  */
#define   I2C_ONBUS_ONBUS_ENABLE_1_Val      _U_(0x1)                                       /**< (I2C_ONBUS) Master tranmits contents of FIFO until empty.  */
...
#define I2C_ONBUS_MASK                      _U_(0x01)                                      /**< \deprecated (I2C_ONBUS) Register MASK  (Use I2C_ONBUS_Msk instead)  */
#define I2C_ONBUS_Msk                       _U_(0x01)                                      /**< (I2C_ONBUS) Register Mask  */
...
#define I2C_SLAVE_ADDRESS_RESETVALUE        _U_(0x00)                                     /**<  (I2C_SLAVE_ADDRESS) Configures the I2C slave Address.   Reset Value */

#define I2C_SLAVE_ADDRESS_ADDRESS_Pos       0                                              /**< (I2C_SLAVE_ADDRESS) I2C Slave Address  Position */
#define I2C_SLAVE_ADDRESS_ADDRESS_Msk       (_U_(0x7F) << I2C_SLAVE_ADDRESS_ADDRESS_Pos)   /**< (I2C_SLAVE_ADDRESS) I2C Slave Address  Mask */
#define I2C_SLAVE_ADDRESS_ADDRESS(value)    (I2C_SLAVE_ADDRESS_ADDRESS_Msk & ((value) << I2C_SLAVE_ADDRESS_ADDRESS_Pos))
#define I2C_SLAVE_ADDRESS_MASK              _U_(0x7F)                                      /**< \deprecated (I2C_SLAVE_ADDRESS) Register MASK  (Use I2C_SLAVE_ADDRESS_Msk instead)  */
#define I2C_SLAVE_ADDRESS_Msk               _U_(0x7F)                                      /**< (I2C_SLAVE_ADDRESS) Register Mask  */
...
#define I2C_STATUS_RESETVALUE               _U_(0x00)                                     /**<  (I2C_STATUS) Status of I2C Module.   Reset Value */
...
#define I2C_STATUS_I2C_ACTIVE_Msk           (_U_(0x1) << I2C_STATUS_I2C_ACTIVE_Pos)        /**< (I2C_STATUS) Active High indicatation that the I2C Module is active. While set, I2C configuration  should not be modified.  Mask */
...
#define I2C_STATUS_MASK                     _U_(0x01)                                      /**< \deprecated (I2C_STATUS) Register MASK  (Use I2C_STATUS_Msk instead)  */
#define I2C_STATUS_Msk                      _U_(0x01)                                      /**< (I2C_STATUS) Register Mask  */
...
#define I2C_TX_INTERRUPT_MASK_RESETVALUE    _U_(0x00)                                     /**<  (I2C_TX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the tx_status register.   Reset Value */
...
#define I2C_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Msk (_U_(0x1) << I2C_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Pos)  /**< (I2C_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_not_full interrupt  Mask */
...
#define I2C_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Msk (_U_(0x1) << I2C_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Pos)  /**< (I2C_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p25_empty interrupt  Mask */
...
#define I2C_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Msk (_U_(0x1) << I2C_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Pos)  /**< (I2C_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p5_empty interrupt  Mask */
...
#define I2C_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Msk (_U_(0x1) << I2C_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Pos)  /**< (I2C_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p75_empty interrupt  Mask */
...
#define I2C_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Msk (_U_(0x1) << I2C_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Pos)  /**< (I2C_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_empty interrupt  Mask */
...
#define I2C_TX_INTERRUPT_MASK_Msk           _U_(0x1F)                                      /**< (I2C_TX_INTERRUPT_MASK) Register Mask  */
...
#define I2C_RX_INTERRUPT_MASK_RESETVALUE    _U_(0x00)                                     /**<  (I2C_RX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the rx_status register.   Reset Value */
...
#define I2C_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Msk (_U_(0x1) << I2C_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_not_empty interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Msk (_U_(0x1) << I2C_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p25_full interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Msk (_U_(0x1) << I2C_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p5_full interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Msk (_U_(0x1) << I2C_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p75_full interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Msk (_U_(0x1) << I2C_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable of FIFO overrun interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_NAK_MASK_Msk  (_U_(0x1) << I2C_RX_INTERRUPT_MASK_NAK_MASK_Pos)  /**< (I2C_RX_INTERRUPT_MASK) Active High Enable NAK interrupt  Mask */
...
#define I2C_RX_INTERRUPT_MASK_Msk           _U_(0x3F)                                      /**< (I2C_RX_INTERRUPT_MASK) Register Mask  */
...
#define I2C_FLUSH_RESETVALUE                _U_(0x00)                                     /**<  (I2C_FLUSH) Writing to this address  flushes the contents of both the Tx and Rx FIFOs. The value written has no effect. Flushing the Tx FIFO will abort ongoing transactions when the current byte has been transmitted.   Reset Value */

#define I2C_FLUSH_I2C_FLUSH_Pos             0                                              /**< (I2C_FLUSH)  Position */
#define I2C_FLUSH_I2C_FLUSH_Msk             (_U_(0x1) << I2C_FLUSH_I2C_FLUSH_Pos)          /**< (I2C_FLUSH)  Mask */
...
#define I2C_FLUSH_MASK                      _U_(0x01)                                      /**< \deprecated (I2C_FLUSH) Register MASK  (Use I2C_FLUSH_Msk instead)  */
#define I2C_FLUSH_Msk                       _U_(0x01)                                      /**< (I2C_FLUSH) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of I2C Master/Slave Controller */

#endif /* _SAMB11_I2C_COMPONENT_H_ */
