...
#ifndef _SAMB11_SPI_FLASH_COMPONENT_H_
#define _SAMB11_SPI_FLASH_COMPONENT_H_
#define _SAMB11_SPI_FLASH_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 SPI Flash Controller
 *  @{
 */
/* ========================================================================== */
...
#define SPI_FLASH_SF1234                     /**< (SPI_FLASH) Module ID */
#define REV_SPI_FLASH 0x100                  /**< (SPI_FLASH) Module revision */
...
#define SPI_FLASH_MODE_CTRL_RESETVALUE      _U_(0x00)                                     /**<  (SPI_FLASH_MODE_CTRL) SPI Flash Mode Control  Reset Value */

#define SPI_FLASH_MODE_CTRL_MODE_Pos        0                                              /**< (SPI_FLASH_MODE_CTRL) SPI Modes Position */
#define SPI_FLASH_MODE_CTRL_MODE_Msk        (_U_(0x3) << SPI_FLASH_MODE_CTRL_MODE_Pos)     /**< (SPI_FLASH_MODE_CTRL) SPI Modes Mask */
#define SPI_FLASH_MODE_CTRL_MODE(value)     (SPI_FLASH_MODE_CTRL_MODE_Msk & ((value) << SPI_FLASH_MODE_CTRL_MODE_Pos))
#define   SPI_FLASH_MODE_CTRL_MODE_0_Val    _U_(0x0)                                       /**< (SPI_FLASH_MODE_CTRL) Mode 0  */
#define   SPI_FLASH_MODE_CTRL_MODE_1_Val    _U_(0x1)                                       /**< (SPI_FLASH_MODE_CTRL) Mode 1  */
#define   SPI_FLASH_MODE_CTRL_MODE_2_Val    _U_(0x2)                                       /**< (SPI_FLASH_MODE_CTRL) Mode 2  */
#define   SPI_FLASH_MODE_CTRL_MODE_3_Val    _U_(0x3)                                       /**< (SPI_FLASH_MODE_CTRL) Mode 3  */
...
#define SPI_FLASH_MODE_CTRL_BYPASS_CS_PRE_Msk (_U_(0x1) << SPI_FLASH_MODE_CTRL_BYPASS_CS_PRE_Pos)  /**< (SPI_FLASH_MODE_CTRL) Bypass CS PRE state Mask */
...
#define SPI_FLASH_MODE_CTRL_BYPASS_CS_POST_Msk (_U_(0x1) << SPI_FLASH_MODE_CTRL_BYPASS_CS_POST_Pos)  /**< (SPI_FLASH_MODE_CTRL) Bypass CS POST state Mask */
...
#define SPI_FLASH_MODE_CTRL_MODE_SELECT_Msk (_U_(0x1) << SPI_FLASH_MODE_CTRL_MODE_SELECT_Pos)  /**< (SPI_FLASH_MODE_CTRL) Set to 1 to use external bits for mode Mask */
...
#define SPI_FLASH_MODE_CTRL_MASK            _U_(0x8F)                                      /**< \deprecated (SPI_FLASH_MODE_CTRL) Register MASK  (Use SPI_FLASH_MODE_CTRL_Msk instead)  */
#define SPI_FLASH_MODE_CTRL_Msk             _U_(0x8F)                                      /**< (SPI_FLASH_MODE_CTRL) Register Mask  */
...
#define SPI_FLASH_TRANSACTION_CTRL_RESETVALUE _U_(0x04)                                     /**<  (SPI_FLASH_TRANSACTION_CTRL) Transaction Control (Cleared after each transaction completes)  Reset Value */
...
#define SPI_FLASH_TRANSACTION_CTRL_CMD_COUNT_Msk (_U_(0x7) << SPI_FLASH_TRANSACTION_CTRL_CMD_COUNT_Pos)  /**< (SPI_FLASH_TRANSACTION_CTRL) Number of bytes to be transferred or received Mask */
...
#define SPI_FLASH_TRANSACTION_CTRL_FLASH_TRANS_START_Msk (_U_(0x1) << SPI_FLASH_TRANSACTION_CTRL_FLASH_TRANS_START_Pos)  /**< (SPI_FLASH_TRANSACTION_CTRL) Rising Edge Flast Transaction Start Mask */
...
#define SPI_FLASH_TRANSACTION_CTRL_WDATA_COUNT_Msk (_U_(0xFFFFFF) << SPI_FLASH_TRANSACTION_CTRL_WDATA_COUNT_Pos)  /**< (SPI_FLASH_TRANSACTION_CTRL) Number of bytes to be programmed to flash Mask */
...
#define SPI_FLASH_TRANSACTION_CTRL_MASK     _U_(0xFFFFFF87)                                /**< \deprecated (SPI_FLASH_TRANSACTION_CTRL) Register MASK  (Use SPI_FLASH_TRANSACTION_CTRL_Msk instead)  */
#define SPI_FLASH_TRANSACTION_CTRL_Msk      _U_(0xFFFFFF87)                                /**< (SPI_FLASH_TRANSACTION_CTRL) Register Mask  */
...
#define SPI_FLASH_READ_CTRL_RESETVALUE      _U_(0x00)                                     /**<  (SPI_FLASH_READ_CTRL) Read Control (Cleared after each transaction completes)  Reset Value */

#define SPI_FLASH_READ_CTRL_RDATA_COUNT_Pos 0                                              /**< (SPI_FLASH_READ_CTRL) Number of data bytes to be read from flash Position */
#define SPI_FLASH_READ_CTRL_RDATA_COUNT_Msk (_U_(0xFFFFFF) << SPI_FLASH_READ_CTRL_RDATA_COUNT_Pos)  /**< (SPI_FLASH_READ_CTRL) Number of data bytes to be read from flash Mask */
...
#define SPI_FLASH_READ_CTRL_MASK            _U_(0xFFFFFF)                                  /**< \deprecated (SPI_FLASH_READ_CTRL) Register MASK  (Use SPI_FLASH_READ_CTRL_Msk instead)  */
#define SPI_FLASH_READ_CTRL_Msk             _U_(0xFFFFFF)                                  /**< (SPI_FLASH_READ_CTRL) Register Mask  */
...
#define SPI_FLASH_CMD_BUFFER0_RESETVALUE    _U_(0x03)                                     /**<  (SPI_FLASH_CMD_BUFFER0) Command Buffer 0 (Bytes 3 - 0)  Reset Value */

#define SPI_FLASH_CMD_BUFFER0_CMD_BUFFER0_Pos 0                                              /**< (SPI_FLASH_CMD_BUFFER0)  Position */
#define SPI_FLASH_CMD_BUFFER0_CMD_BUFFER0_Msk (_U_(0xFFFFFFFF) << SPI_FLASH_CMD_BUFFER0_CMD_BUFFER0_Pos)  /**< (SPI_FLASH_CMD_BUFFER0)  Mask */
...
#define SPI_FLASH_CMD_BUFFER0_MASK          _U_(0xFFFFFFFF)                                /**< \deprecated (SPI_FLASH_CMD_BUFFER0) Register MASK  (Use SPI_FLASH_CMD_BUFFER0_Msk instead)  */
#define SPI_FLASH_CMD_BUFFER0_Msk           _U_(0xFFFFFFFF)                                /**< (SPI_FLASH_CMD_BUFFER0) Register Mask  */
...
#define SPI_FLASH_CMD_BUFFER1_RESETVALUE    _U_(0x00)                                     /**<  (SPI_FLASH_CMD_BUFFER1) Command Buffer 1 (Bytes 7 - 4)  Reset Value */

#define SPI_FLASH_CMD_BUFFER1_CMD_BUFFER1_Pos 0                                              /**< (SPI_FLASH_CMD_BUFFER1)  Position */
#define SPI_FLASH_CMD_BUFFER1_CMD_BUFFER1_Msk (_U_(0xFFFFFFFF) << SPI_FLASH_CMD_BUFFER1_CMD_BUFFER1_Pos)  /**< (SPI_FLASH_CMD_BUFFER1)  Mask */
...
#define SPI_FLASH_CMD_BUFFER1_MASK          _U_(0xFFFFFFFF)                                /**< \deprecated (SPI_FLASH_CMD_BUFFER1) Register MASK  (Use SPI_FLASH_CMD_BUFFER1_Msk instead)  */
#define SPI_FLASH_CMD_BUFFER1_Msk           _U_(0xFFFFFFFF)                                /**< (SPI_FLASH_CMD_BUFFER1) Register Mask  */
...
#define SPI_FLASH_DIRECTION_RESETVALUE      _U_(0x0F)                                     /**<  (SPI_FLASH_DIRECTION) Read/Write bit for Bytes 7 - 0  Reset Value */

#define SPI_FLASH_DIRECTION_DIRECTION_Pos   0                                              /**< (SPI_FLASH_DIRECTION)  Position */
#define SPI_FLASH_DIRECTION_DIRECTION_Msk   (_U_(0xFF) << SPI_FLASH_DIRECTION_DIRECTION_Pos)  /**< (SPI_FLASH_DIRECTION)  Mask */
#define SPI_FLASH_DIRECTION_DIRECTION(value) (SPI_FLASH_DIRECTION_DIRECTION_Msk & ((value) << SPI_FLASH_DIRECTION_DIRECTION_Pos))
#define SPI_FLASH_DIRECTION_MASK            _U_(0xFF)                                      /**< \deprecated (SPI_FLASH_DIRECTION) Register MASK  (Use SPI_FLASH_DIRECTION_Msk instead)  */
#define SPI_FLASH_DIRECTION_Msk             _U_(0xFF)                                      /**< (SPI_FLASH_DIRECTION) Register Mask  */
...
#define SPI_FLASH_IRQ_STATUS_RESETVALUE     _U_(0x00)                                     /**<  (SPI_FLASH_IRQ_STATUS) IRQ Status (Write 0 to bit to clear, Read clears interupts)  Reset Value */

#define SPI_FLASH_IRQ_STATUS_FLASH_TRANS_DONE_Pos 0                                              /**< (SPI_FLASH_IRQ_STATUS) Current Flash Transaction Done Position */
#define SPI_FLASH_IRQ_STATUS_FLASH_TRANS_DONE_Msk (_U_(0x1) << SPI_FLASH_IRQ_STATUS_FLASH_TRANS_DONE_Pos)  /**< (SPI_FLASH_IRQ_STATUS) Current Flash Transaction Done Mask */
...
#define SPI_FLASH_IRQ_STATUS_AHB_ERROR_RESPONSE_Msk (_U_(0x1) << SPI_FLASH_IRQ_STATUS_AHB_ERROR_RESPONSE_Pos)  /**< (SPI_FLASH_IRQ_STATUS) AHB Error Response Mask */
...
#define SPI_FLASH_IRQ_STATUS_MASK           _U_(0x03)                                      /**< \deprecated (SPI_FLASH_IRQ_STATUS) Register MASK  (Use SPI_FLASH_IRQ_STATUS_Msk instead)  */
#define SPI_FLASH_IRQ_STATUS_Msk            _U_(0x03)                                      /**< (SPI_FLASH_IRQ_STATUS) Register Mask  */
...
#define SPI_FLASH_DMA_START_ADDRESS_RESETVALUE _U_(0x00)                                     /**<  (SPI_FLASH_DMA_START_ADDRESS) DMA Starting Address  Reset Value */

#define SPI_FLASH_DMA_START_ADDRESS_DMA_START_ADDRESS_Pos 0                                              /**< (SPI_FLASH_DMA_START_ADDRESS)  Position */
#define SPI_FLASH_DMA_START_ADDRESS_DMA_START_ADDRESS_Msk (_U_(0xFFFFFFFF) << SPI_FLASH_DMA_START_ADDRESS_DMA_START_ADDRESS_Pos)  /**< (SPI_FLASH_DMA_START_ADDRESS)  Mask */
...
#define SPI_FLASH_DMA_START_ADDRESS_MASK    _U_(0xFFFFFFFF)                                /**< \deprecated (SPI_FLASH_DMA_START_ADDRESS) Register MASK  (Use SPI_FLASH_DMA_START_ADDRESS_Msk instead)  */
#define SPI_FLASH_DMA_START_ADDRESS_Msk     _U_(0xFFFFFFFF)                                /**< (SPI_FLASH_DMA_START_ADDRESS) Register Mask  */
...
#define SPI_FLASH_CONFIG_RESETVALUE         _U_(0x103)                                    /**<  (SPI_FLASH_CONFIG) SPI Flash Configuration  Reset Value */

#define SPI_FLASH_CONFIG_ENDIANNESS_Pos     0                                              /**< (SPI_FLASH_CONFIG) 1 for Little Endian Position */
#define SPI_FLASH_CONFIG_ENDIANNESS_Msk     (_U_(0x1) << SPI_FLASH_CONFIG_ENDIANNESS_Pos)  /**< (SPI_FLASH_CONFIG) 1 for Little Endian Mask */
...
#define SPI_FLASH_CONFIG_REVERSE_CMD_BUFFER_Msk (_U_(0x1) << SPI_FLASH_CONFIG_REVERSE_CMD_BUFFER_Pos)  /**< (SPI_FLASH_CONFIG) Reverse bits of every byte in cmd_buffer Mask */
...
#define SPI_FLASH_CONFIG_RDATA_REVERSE_Msk  (_U_(0x1) << SPI_FLASH_CONFIG_RDATA_REVERSE_Pos)  /**< (SPI_FLASH_CONFIG) Reverse bits of every data byte read from flash Mask */
...
#define SPI_FLASH_CONFIG_REVERSE_INCOMIND_DATA_Msk (_U_(0x1) << SPI_FLASH_CONFIG_REVERSE_INCOMIND_DATA_Pos)  /**< (SPI_FLASH_CONFIG) Reverse bits of status registers read from flash Mask */
...
#define SPI_FLASH_CONFIG_SPI_INTERFACE_CONFIG_DEBUG_Msk (_U_(0xF) << SPI_FLASH_CONFIG_SPI_INTERFACE_CONFIG_DEBUG_Pos)  /**< (SPI_FLASH_CONFIG) Debug only Mask */
...
#define SPI_FLASH_CONFIG_WDATA_REVERSE_Msk  (_U_(0x1) << SPI_FLASH_CONFIG_WDATA_REVERSE_Pos)  /**< (SPI_FLASH_CONFIG) Reverse bits of every data byte written to flash Mask */
...
#define SPI_FLASH_CONFIG_MASK               _U_(0x1FF)                                     /**< \deprecated (SPI_FLASH_CONFIG) Register MASK  (Use SPI_FLASH_CONFIG_Msk instead)  */
#define SPI_FLASH_CONFIG_Msk                _U_(0x1FF)                                     /**< (SPI_FLASH_CONFIG) Register Mask  */
...
#define SPI_FLASH_TX_CONTROL_RESETVALUE     _U_(0x00)                                     /**<  (SPI_FLASH_TX_CONTROL) TX Control  Reset Value */

#define SPI_FLASH_TX_CONTROL_DRIVE_0_ON_TX_Pos 0                                              /**< (SPI_FLASH_TX_CONTROL) Drive 0 on TX while reading Position */
#define SPI_FLASH_TX_CONTROL_DRIVE_0_ON_TX_Msk (_U_(0x1) << SPI_FLASH_TX_CONTROL_DRIVE_0_ON_TX_Pos)  /**< (SPI_FLASH_TX_CONTROL) Drive 0 on TX while reading Mask */
...
#define SPI_FLASH_TX_CONTROL_DRIVE_1_ON_TX_Msk (_U_(0x1) << SPI_FLASH_TX_CONTROL_DRIVE_1_ON_TX_Pos)  /**< (SPI_FLASH_TX_CONTROL) Drive 1 on TX while reading Mask */
...
#define SPI_FLASH_TX_CONTROL_TOGGLE_ON_TX_Msk (_U_(0x1) << SPI_FLASH_TX_CONTROL_TOGGLE_ON_TX_Pos)  /**< (SPI_FLASH_TX_CONTROL) Toggle TX while reading Mask */
...
#define SPI_FLASH_TX_CONTROL_DUMMY_ON_TX_Msk (_U_(0x1) << SPI_FLASH_TX_CONTROL_DUMMY_ON_TX_Pos)  /**< (SPI_FLASH_TX_CONTROL) Send dummy_byte while reading Mask */
...
#define SPI_FLASH_TX_CONTROL_DUMMY_BYTE_Msk (_U_(0xFF) << SPI_FLASH_TX_CONTROL_DUMMY_BYTE_Pos)  /**< (SPI_FLASH_TX_CONTROL) Byte to be sent for dummy_on_tx option Mask */
...
#define SPI_FLASH_TX_CONTROL_MASK           _U_(0xFF0F)                                    /**< \deprecated (SPI_FLASH_TX_CONTROL) Register MASK  (Use SPI_FLASH_TX_CONTROL_Msk instead)  */
#define SPI_FLASH_TX_CONTROL_Msk            _U_(0xFF0F)                                    /**< (SPI_FLASH_TX_CONTROL) Register Mask  */
...
#define SPI_FLASH_STATUS_RESETVALUE         _U_(0x00)                                     /**<  (SPI_FLASH_STATUS) Misc Status  Reset Value */

#define SPI_FLASH_STATUS_AHB_MASTER_STATE_Pos 0                                              /**< (SPI_FLASH_STATUS) AHB Master State Position */
#define SPI_FLASH_STATUS_AHB_MASTER_STATE_Msk (_U_(0x3) << SPI_FLASH_STATUS_AHB_MASTER_STATE_Pos)  /**< (SPI_FLASH_STATUS) AHB Master State Mask */
...
#define   SPI_FLASH_STATUS_AHB_MASTER_STATE_0_Val _U_(0x0)                                       /**< (SPI_FLASH_STATUS) IDLE  */
#define   SPI_FLASH_STATUS_AHB_MASTER_STATE_1_Val _U_(0x1)                                       /**< (SPI_FLASH_STATUS) WAIT_GRANT  */
#define   SPI_FLASH_STATUS_AHB_MASTER_STATE_2_Val _U_(0x2)                                       /**< (SPI_FLASH_STATUS) ADDR_PHASE  */
#define   SPI_FLASH_STATUS_AHB_MASTER_STATE_3_Val _U_(0x3)                                       /**< (SPI_FLASH_STATUS) DATA_PHASE  */
...
#define SPI_FLASH_STATUS_FIFO_CTRL_STATE_Msk (_U_(0x7) << SPI_FLASH_STATUS_FIFO_CTRL_STATE_Pos)  /**< (SPI_FLASH_STATUS) FIFO Control State Mask */
...
#define   SPI_FLASH_STATUS_FIFO_CTRL_STATE_0_Val _U_(0x0)                                       /**< (SPI_FLASH_STATUS) FLASH_IDLE  */
#define   SPI_FLASH_STATUS_FIFO_CTRL_STATE_1_Val _U_(0x1)                                       /**< (SPI_FLASH_STATUS) GET_DATA_FROM_FLASH  */
#define   SPI_FLASH_STATUS_FIFO_CTRL_STATE_2_Val _U_(0x2)                                       /**< (SPI_FLASH_STATUS) WRITE_DATA_TO_AHB  */
#define   SPI_FLASH_STATUS_FIFO_CTRL_STATE_3_Val _U_(0x3)                                       /**< (SPI_FLASH_STATUS) GET_DATA_FROM_AHB  */
#define   SPI_FLASH_STATUS_FIFO_CTRL_STATE_4_Val _U_(0x4)                                       /**< (SPI_FLASH_STATUS) WRITE_DATA_TO_FLASH  */
...
#define SPI_FLASH_STATUS_SPI_MASTER_STATE_Msk (_U_(0x7) << SPI_FLASH_STATUS_SPI_MASTER_STATE_Pos)  /**< (SPI_FLASH_STATUS) SPI Master State Mask */
...
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_0_Val _U_(0x0)                                       /**< (SPI_FLASH_STATUS) IDLE  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_1_Val _U_(0x1)                                       /**< (SPI_FLASH_STATUS) READ  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_2_Val _U_(0x2)                                       /**< (SPI_FLASH_STATUS) WRITE  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_3_Val _U_(0x3)                                       /**< (SPI_FLASH_STATUS) READ_FLASH  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_4_Val _U_(0x4)                                       /**< (SPI_FLASH_STATUS) WRITE_FLASH  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_5_Val _U_(0x5)                                       /**< (SPI_FLASH_STATUS) PRE_ACTION  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_6_Val _U_(0x6)                                       /**< (SPI_FLASH_STATUS) POST_ACTION  */
#define   SPI_FLASH_STATUS_SPI_MASTER_STATE_7_Val _U_(0x7)                                       /**< (SPI_FLASH_STATUS) WAIT_AHB  */
...
#define SPI_FLASH_STATUS_SPI_MASTER_CSN_Msk (_U_(0x1) << SPI_FLASH_STATUS_SPI_MASTER_CSN_Pos)  /**< (SPI_FLASH_STATUS) Inverted version of the SPI Master Chip Select Mask */
...
#define SPI_FLASH_STATUS_MASK               _U_(0x1773)                                    /**< \deprecated (SPI_FLASH_STATUS) Register MASK  (Use SPI_FLASH_STATUS_Msk instead)  */
#define SPI_FLASH_STATUS_Msk                _U_(0x1773)                                    /**< (SPI_FLASH_STATUS) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of SPI Flash Controller */

#endif /* _SAMB11_SPI_FLASH_COMPONENT_H_ */
