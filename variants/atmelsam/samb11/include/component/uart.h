...
#ifndef _SAMB11_UART_COMPONENT_H_
#define _SAMB11_UART_COMPONENT_H_
#define _SAMB11_UART_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 UART Controller
 *  @{
 */
/* ========================================================================== */
...
#define UART_U1234                      /**< (UART) Module ID */
#define REV_UART 0x100                  /**< (UART) Module revision */
...
#define UART_TRANSMIT_DATA_RESETVALUE       _U_(0x00)                                     /**<  (UART_TRANSMIT_DATA) Writes one byte to UART Transmit Data FIFO.   Reset Value */
...
#define UART_TRANSMIT_DATA_TX_BYTE_Msk      (_U_(0xFF) << UART_TRANSMIT_DATA_TX_BYTE_Pos)  /**< (UART_TRANSMIT_DATA) Writes data in transmit FIFO. If byte length is set to 7, the MSB should be set to 0.  Mask */
#define UART_TRANSMIT_DATA_TX_BYTE(value)   (UART_TRANSMIT_DATA_TX_BYTE_Msk & ((value) << UART_TRANSMIT_DATA_TX_BYTE_Pos))
#define UART_TRANSMIT_DATA_MASK             _U_(0xFF)                                      /**< \deprecated (UART_TRANSMIT_DATA) Register MASK  (Use UART_TRANSMIT_DATA_Msk instead)  */
#define UART_TRANSMIT_DATA_Msk              _U_(0xFF)                                      /**< (UART_TRANSMIT_DATA) Register Mask  */
...
#define UART_TRANSMIT_STATUS_RESETVALUE     _U_(0x00)                                     /**<  (UART_TRANSMIT_STATUS) Status of the UART transmitter. Each field can generate an interrupt if corresponding bit in  the Tx interrupt mask register is set.   Reset Value */
...
#define UART_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_TX_FIFO_NOT_FULL_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when Tx FIFO can still accepts at least one more character. 0: TX FIFO Full. 1: TX FIFO not Full.  Mask */
...
#define UART_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_TX_FIFO_0P25_EMPTY_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least quarter empty. Reset when more.  Mask */
...
#define UART_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_TX_FIFO_0P5_EMPTY_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least half empty. Reset when more.  Mask */
...
#define UART_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_TX_FIFO_0P75_EMPTY_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when Tx FIFO is at least three quarters empty. Reset when more.  Mask */
...
#define UART_TRANSMIT_STATUS_TX_FIFO_EMPTY_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_TX_FIFO_EMPTY_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when Tx FIFO is Empty and has no more character to transmit  Mask */
...
#define UART_TRANSMIT_STATUS_CTS_ACTIVE_Msk (_U_(0x1) << UART_TRANSMIT_STATUS_CTS_ACTIVE_Pos)  /**< (UART_TRANSMIT_STATUS) Active High indication when flow control signal "cts" is active. Unaffected by cts  enable bit in config register.  Mask */
...
#define UART_TRANSMIT_STATUS_MASK           _U_(0x3F)                                      /**< \deprecated (UART_TRANSMIT_STATUS) Register MASK  (Use UART_TRANSMIT_STATUS_Msk instead)  */
#define UART_TRANSMIT_STATUS_Msk            _U_(0x3F)                                      /**< (UART_TRANSMIT_STATUS) Register Mask  */
...
#define UART_TX_INTERRUPT_MASK_RESETVALUE   _U_(0x00)                                     /**<  (UART_TX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the tx_status register.   Reset Value */
...
#define UART_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_TX_FIFO_NOT_FULL_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_not_full interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_TX_FIFO_0P25_EMPTY_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p25_empty interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_TX_FIFO_0P5_EMPTY_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p5_empty interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_TX_FIFO_0P75_EMPTY_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_0p75_empty interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_TX_FIFO_EMPTY_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of tx_fifo_empty interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_CTS_ACTIVE_MASK_Msk (_U_(0x1) << UART_TX_INTERRUPT_MASK_CTS_ACTIVE_MASK_Pos)  /**< (UART_TX_INTERRUPT_MASK) Active High Enable of cts_active interrupt  Mask */
...
#define UART_TX_INTERRUPT_MASK_Msk          _U_(0x3F)                                      /**< (UART_TX_INTERRUPT_MASK) Register Mask  */
...
#define UART_RECEIVE_DATA_RESETVALUE        _U_(0x00)                                     /**<  (UART_RECEIVE_DATA) Read one byte from UART Receive Data FIFO.   Reset Value */
...
#define UART_RECEIVE_DATA_RX_BYTE_Msk       (_U_(0xFF) << UART_RECEIVE_DATA_RX_BYTE_Pos)   /**< (UART_RECEIVE_DATA) Oldest data in receive FIFO. If byte length is set to 7, the MSB is set to 0.  Mask */
#define UART_RECEIVE_DATA_RX_BYTE(value)    (UART_RECEIVE_DATA_RX_BYTE_Msk & ((value) << UART_RECEIVE_DATA_RX_BYTE_Pos))
#define UART_RECEIVE_DATA_MASK              _U_(0xFF)                                      /**< \deprecated (UART_RECEIVE_DATA) Register MASK  (Use UART_RECEIVE_DATA_Msk instead)  */
#define UART_RECEIVE_DATA_Msk               _U_(0xFF)                                      /**< (UART_RECEIVE_DATA) Register Mask  */
...
#define UART_RECEIVE_STATUS_RESETVALUE      _U_(0x00)                                     /**<  (UART_RECEIVE_STATUS) Status of the UART receiver. Each field can generate an interrupt if corresponding bit in  the Rx interrupt mask register is set.   Reset Value */
...
#define UART_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Msk (_U_(0x1) << UART_RECEIVE_STATUS_RX_FIFO_NOT_EMPTY_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when data is available in Rx FIFO. 0: RX FIFO Empty. 1: RX FIFO contains at least one byte of data.  Mask */
...
#define UART_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Msk (_U_(0x1) << UART_RECEIVE_STATUS_RX_FIFO_0P25_FULL_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when FIFO is at least quarter full. Reset when less.  Mask */
...
#define UART_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Msk (_U_(0x1) << UART_RECEIVE_STATUS_RX_FIFO_0P5_FULL_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when FIFO is at least half full. Reset when less.  Mask */
...
#define UART_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Msk (_U_(0x1) << UART_RECEIVE_STATUS_RX_FIFO_0P75_FULL_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when FIFO is at least three quarters full. Reset when less.  Mask */
...
#define UART_RECEIVE_STATUS_TIMEOUT_Msk     (_U_(0x1) << UART_RECEIVE_STATUS_TIMEOUT_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when the timeout set in the rx_timeout register has elapsed since  the last interaction with the receiver. Reset by reading the status register.   Mask */
...
#define UART_RECEIVE_STATUS_PARITY_ERROR_Msk (_U_(0x1) << UART_RECEIVE_STATUS_PARITY_ERROR_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when a receive parity error is detected. Reset by reading the status register.  Mask */
...
#define UART_RECEIVE_STATUS_FIFO_OVERRUN_Msk (_U_(0x1) << UART_RECEIVE_STATUS_FIFO_OVERRUN_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when character is received but FIFO is full. Reset by reading the status register.  Mask */
...
#define UART_RECEIVE_STATUS_FRAMING_ERROR_Msk (_U_(0x1) << UART_RECEIVE_STATUS_FRAMING_ERROR_Pos)  /**< (UART_RECEIVE_STATUS) Active High indication when no stop bit is detected. Reset by reading the status register.  Mask */
...
#define UART_RECEIVE_STATUS_MASK            _U_(0xFF)                                      /**< \deprecated (UART_RECEIVE_STATUS) Register MASK  (Use UART_RECEIVE_STATUS_Msk instead)  */
#define UART_RECEIVE_STATUS_Msk             _U_(0xFF)                                      /**< (UART_RECEIVE_STATUS) Register Mask  */
...
#define UART_RX_INTERRUPT_MASK_RESETVALUE   _U_(0x00)                                     /**<  (UART_RX_INTERRUPT_MASK) Enable or Disable the generation of interrupts by the rx_status register.   Reset Value */
...
#define UART_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_RX_FIFO_NOT_EMPTY_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_not_empty interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_RX_FIFO_0P25_FULL_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p25_full interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_RX_FIFO_0P5_FULL_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p5_full interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_RX_FIFO_0P75_FULL_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of rx_fifo_0p75_full interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_TIMEOUT_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_TIMEOUT_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of timeout interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_PARITY_ERROR_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_PARITY_ERROR_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of parity error interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_FIFO_OVERRUN_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of FIFO overrun interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_FRAMING_ERROR_MASK_Msk (_U_(0x1) << UART_RX_INTERRUPT_MASK_FRAMING_ERROR_MASK_Pos)  /**< (UART_RX_INTERRUPT_MASK) Active High Enable of framing error interrupt  Mask */
...
#define UART_RX_INTERRUPT_MASK_Msk          _U_(0xFF)                                      /**< (UART_RX_INTERRUPT_MASK) Register Mask  */
...
#define UART_RECEIVE_TIMEOUT_RESETVALUE     _U_(0x00)                                     /**<  (UART_RECEIVE_TIMEOUT) Timeout counter configuration.   Reset Value */
...
#define UART_RECEIVE_TIMEOUT_TIMEOUT_VALUE_Msk (_U_(0xFF) << UART_RECEIVE_TIMEOUT_TIMEOUT_VALUE_Pos)  /**< (UART_RECEIVE_TIMEOUT) Timeout counter reload value, after status register is read or character received.  Counter decrements at baud rate clock.  Mask */
...
#define UART_RECEIVE_TIMEOUT_MASK           _U_(0xFF)                                      /**< \deprecated (UART_RECEIVE_TIMEOUT) Register MASK  (Use UART_RECEIVE_TIMEOUT_Msk instead)  */
#define UART_RECEIVE_TIMEOUT_Msk            _U_(0xFF)                                      /**< (UART_RECEIVE_TIMEOUT) Register Mask  */
...
#define UART_CONFIGURATION_RESETVALUE       _U_(0x00)                                     /**<  (UART_CONFIGURATION) UART Operation Configuration Register, for both Rx and Tx.   Reset Value */
...
#define UART_CONFIGURATION_NUMBER_OF_BITS_Msk (_U_(0x1) << UART_CONFIGURATION_NUMBER_OF_BITS_Pos)  /**< (UART_CONFIGURATION) Number of bits per character, not including parity Mask */
...
#define   UART_CONFIGURATION_NUMBER_OF_BITS_0_Val _U_(0x0)                                       /**< (UART_CONFIGURATION) 8 bits  */
#define   UART_CONFIGURATION_NUMBER_OF_BITS_1_Val _U_(0x1)                                       /**< (UART_CONFIGURATION) 7 bits  */
...
#define UART_CONFIGURATION_PARITY_ENABLE_Msk (_U_(0x1) << UART_CONFIGURATION_PARITY_ENABLE_Pos)  /**< (UART_CONFIGURATION) Active High parity checking and generation enable Mask */
...
#define   UART_CONFIGURATION_PARITY_ENABLE_0_Val _U_(0x0)                                       /**< (UART_CONFIGURATION) Disable  */
#define   UART_CONFIGURATION_PARITY_ENABLE_1_Val _U_(0x1)                                       /**< (UART_CONFIGURATION) Enable  */
...
#define UART_CONFIGURATION_PARITY_MODE_Msk  (_U_(0x3) << UART_CONFIGURATION_PARITY_MODE_Pos)  /**< (UART_CONFIGURATION) Parity Mode Select Mask */
#define UART_CONFIGURATION_PARITY_MODE(value) (UART_CONFIGURATION_PARITY_MODE_Msk & ((value) << UART_CONFIGURATION_PARITY_MODE_Pos))
#define   UART_CONFIGURATION_PARITY_MODE_0_Val _U_(0x0)                                       /**< (UART_CONFIGURATION) Even Parity  */
#define   UART_CONFIGURATION_PARITY_MODE_1_Val _U_(0x1)                                       /**< (UART_CONFIGURATION) Odd Parity  */
#define   UART_CONFIGURATION_PARITY_MODE_2_Val _U_(0x2)                                       /**< (UART_CONFIGURATION) Parity bit is space  */
#define   UART_CONFIGURATION_PARITY_MODE_3_Val _U_(0x3)                                       /**< (UART_CONFIGURATION) Parity bit is mark  */
...
#define UART_CONFIGURATION_STOP_BITS_Msk    (_U_(0x1) << UART_CONFIGURATION_STOP_BITS_Pos)  /**< (UART_CONFIGURATION) Number of stop bits Mask */
...
#define   UART_CONFIGURATION_STOP_BITS_0_Val _U_(0x0)                                       /**< (UART_CONFIGURATION) One Bit  */
#define   UART_CONFIGURATION_STOP_BITS_1_Val _U_(0x1)                                       /**< (UART_CONFIGURATION) Two Bits  */
...
#define UART_CONFIGURATION_CTS_ENABLE_Msk   (_U_(0x1) << UART_CONFIGURATION_CTS_ENABLE_Pos)  /**< (UART_CONFIGURATION) Active High Flow Control Enable. When enabled, transmission starts when cts signal is asserted Mask */
...
#define   UART_CONFIGURATION_CTS_ENABLE_0_Val _U_(0x0)                                       /**< (UART_CONFIGURATION) Disable-Transmission starts only when cts signal is asserted  */
#define   UART_CONFIGURATION_CTS_ENABLE_1_Val _U_(0x1)                                       /**< (UART_CONFIGURATION) Enable-Transmission starts regardless of cts signal  */
...
#define UART_CONFIGURATION_MASK             _U_(0x3F)                                      /**< \deprecated (UART_CONFIGURATION) Register MASK  (Use UART_CONFIGURATION_Msk instead)  */
#define UART_CONFIGURATION_Msk              _U_(0x3F)                                      /**< (UART_CONFIGURATION) Register Mask  */
...
#define UART_BAUD_RATE_RESETVALUE           _U_(0x00)                                     /**<  (UART_BAUD_RATE) Baud Rate Control Register. Bits 15:3 specify the integral division of the clock (divide by n),  and bit 2:0 specify the fractional division.   Reset Value */
...
#define UART_BAUD_RATE_FRACTIONAL_DIVISION_Msk (_U_(0x7) << UART_BAUD_RATE_FRACTIONAL_DIVISION_Pos)  /**< (UART_BAUD_RATE) Fractional Division Part. If non-zero, the integer part must be at least set to 3.  Mask */
...
#define UART_BAUD_RATE_INTEGER_DIVISION_Msk (_U_(0x1FFF) << UART_BAUD_RATE_INTEGER_DIVISION_Pos)  /**< (UART_BAUD_RATE) Integral Division Part. Must be at least set to 2.  Mask */
...
#define UART_BAUD_RATE_MASK                 _U_(0xFFFF)                                    /**< \deprecated (UART_BAUD_RATE) Register MASK  (Use UART_BAUD_RATE_Msk instead)  */
#define UART_BAUD_RATE_Msk                  _U_(0xFFFF)                                    /**< (UART_BAUD_RATE) Register Mask  */
...
#define UART_CLOCK_SOURCE_RESETVALUE        _U_(0x00)                                     /**<  (UART_CLOCK_SOURCE) Selects Source of UART Clock   Reset Value */

#define UART_CLOCK_SOURCE_CLOCK_SELECT_Pos  0                                              /**< (UART_CLOCK_SOURCE) Selects one of the four possible clock sources. Position */
#define UART_CLOCK_SOURCE_CLOCK_SELECT_Msk  (_U_(0x3) << UART_CLOCK_SOURCE_CLOCK_SELECT_Pos)  /**< (UART_CLOCK_SOURCE) Selects one of the four possible clock sources. Mask */
#define UART_CLOCK_SOURCE_CLOCK_SELECT(value) (UART_CLOCK_SOURCE_CLOCK_SELECT_Msk & ((value) << UART_CLOCK_SOURCE_CLOCK_SELECT_Pos))
#define   UART_CLOCK_SOURCE_CLOCK_SELECT_0_Val _U_(0x0)                                       /**< (UART_CLOCK_SOURCE) Clock input 0  */
#define   UART_CLOCK_SOURCE_CLOCK_SELECT_1_Val _U_(0x1)                                       /**< (UART_CLOCK_SOURCE) Clock input 1  */
#define   UART_CLOCK_SOURCE_CLOCK_SELECT_2_Val _U_(0x2)                                       /**< (UART_CLOCK_SOURCE) Clock input 2  */
#define   UART_CLOCK_SOURCE_CLOCK_SELECT_3_Val _U_(0x3)                                       /**< (UART_CLOCK_SOURCE) Clock input 3  */
...
#define UART_CLOCK_SOURCE_MASK              _U_(0x03)                                      /**< \deprecated (UART_CLOCK_SOURCE) Register MASK  (Use UART_CLOCK_SOURCE_Msk instead)  */
#define UART_CLOCK_SOURCE_Msk               _U_(0x03)                                      /**< (UART_CLOCK_SOURCE) Register Mask  */
...
#endif /* _SAMB11_UART_COMPONENT_H_ */
