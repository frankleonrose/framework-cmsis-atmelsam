...
#ifndef _SAMB11_AON_GP_REGS_COMPONENT_H_
#define _SAMB11_AON_GP_REGS_COMPONENT_H_
#define _SAMB11_AON_GP_REGS_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 Always On General Purpose Registers
 *  @{
 */
/* ========================================================================== */
...
#define AON_GP_REGS_AGR1234                    /**< (AON_GP_REGS) Module ID */
#define REV_AON_GP_REGS 0x100                  /**< (AON_GP_REGS) Module revision */
...
#define AON_GP_REGS_AON_PINMUX_SEL_RESETVALUE _U_(0x01)                                     /**<  (AON_GP_REGS_AON_PINMUX_SEL) Controls the pinmux selection for the AO GPIOs  Reset Value */

#define AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_0_SEL_Pos 0                                              /**< (AON_GP_REGS_AON_PINMUX_SEL) Pinmux select for AO_GPIO_0 Position */
#define AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_0_SEL_Msk (_U_(0x3) << AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_0_SEL_Pos)  /**< (AON_GP_REGS_AON_PINMUX_SEL) Pinmux select for AO_GPIO_0 Mask */
...
#define AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_1_SEL_Msk (_U_(0x3) << AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_1_SEL_Pos)  /**< (AON_GP_REGS_AON_PINMUX_SEL) Pinmux select for AO_GPIO_1 Mask */
...
#define AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_2_SEL_Msk (_U_(0x3) << AON_GP_REGS_AON_PINMUX_SEL_AO_GPIO_2_SEL_Pos)  /**< (AON_GP_REGS_AON_PINMUX_SEL) Pinmux select for AO_GPIO_2 Mask */
...
#define AON_GP_REGS_AON_PINMUX_SEL_MASK     _U_(0x333)                                     /**< \deprecated (AON_GP_REGS_AON_PINMUX_SEL) Register MASK  (Use AON_GP_REGS_AON_PINMUX_SEL_Msk instead)  */
#define AON_GP_REGS_AON_PINMUX_SEL_Msk      _U_(0x333)                                     /**< (AON_GP_REGS_AON_PINMUX_SEL) Register Mask  */
...
#define AON_GP_REGS_AON_PMU_CTRL_RESETVALUE _U_(0xA0022)                                  /**<  (AON_GP_REGS_AON_PMU_CTRL) Always On Misc Control  Reset Value */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_REGS_4TO1_SEL_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_REGS_4TO1_SEL_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) If 1 then uses the frequency hopping table otherwise registers in PD0 Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_RTC_CLK_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_RTC_CLK_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) Enables the PMU RTC clock Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_RETN_VAL_SEL_Msk (_U_(0x3) << AON_GP_REGS_AON_PMU_CTRL_PMU_RETN_VAL_SEL_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) Retention Voltage Selection Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_EFUSE_LDO_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_EFUSE_LDO_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) Enables the EFUSE LDO Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU MUX EN Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_A_Msk (_U_(0x7) << AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_A_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU MUX A Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_SEL_Msk (_U_(0xF) << AON_GP_REGS_AON_PMU_CTRL_PMU_MUX_SEL_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU MUX SEL Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_SENS_ADC_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_SENS_ADC_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU Sensor ADC Enable Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_SENS_ADC_RST_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_SENS_ADC_RST_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU Sensor ADC Reset Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_BGR_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_BGR_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) PMU BGR EN Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_2MHZ_CLK_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_2MHZ_CLK_EN_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) Enables the 2MHz OSC clock coming to the digital from the PMU Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_PMU_26MHZ_CLK_FORCE_OFF_Msk (_U_(0x1) << AON_GP_REGS_AON_PMU_CTRL_PMU_26MHZ_CLK_FORCE_OFF_Pos)  /**< (AON_GP_REGS_AON_PMU_CTRL) If set, this will force off the OSC 26 MHz clock, otherwise this will follow the power for PD1 Mask */
...
#define AON_GP_REGS_AON_PMU_CTRL_MASK       _U_(0x1FFFB3)                                  /**< \deprecated (AON_GP_REGS_AON_PMU_CTRL) Register MASK  (Use AON_GP_REGS_AON_PMU_CTRL_Msk instead)  */
#define AON_GP_REGS_AON_PMU_CTRL_Msk        _U_(0x1FFFB3)                                  /**< (AON_GP_REGS_AON_PMU_CTRL) Register Mask  */
...
#define AON_GP_REGS_AON_BLE_LP_CTRL_RESETVALUE _U_(0x00)                                     /**<  (AON_GP_REGS_AON_BLE_LP_CTRL) Always On BLE LP Control  Reset Value */
...
#define AON_GP_REGS_AON_BLE_LP_CTRL_WAKEUP_LP_LATCH_Msk (_U_(0x1) << AON_GP_REGS_AON_BLE_LP_CTRL_WAKEUP_LP_LATCH_Pos)  /**< (AON_GP_REGS_AON_BLE_LP_CTRL) If set, this will latch the wakeup signal in the BLE LP block Mask */
...
#define AON_GP_REGS_AON_BLE_LP_CTRL_DEEP_SLEEP_STAT_SYNC_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_BLE_LP_CTRL_DEEP_SLEEP_STAT_SYNC_EN_Pos)  /**< (AON_GP_REGS_AON_BLE_LP_CTRL) If set, this will use the sync flops for deep sleep stat Mask */
...
#define AON_GP_REGS_AON_BLE_LP_CTRL_MASK    _U_(0x03)                                      /**< \deprecated (AON_GP_REGS_AON_BLE_LP_CTRL) Register MASK  (Use AON_GP_REGS_AON_BLE_LP_CTRL_Msk instead)  */
#define AON_GP_REGS_AON_BLE_LP_CTRL_Msk     _U_(0x03)                                      /**< (AON_GP_REGS_AON_BLE_LP_CTRL) Register Mask  */
...
#define AON_GP_REGS_AON_MISC_CTRL_RESETVALUE _U_(0x10000)                                  /**<  (AON_GP_REGS_AON_MISC_CTRL) Always On Misc Control  Reset Value */
...
#define AON_GP_REGS_AON_MISC_CTRL_USE_RTC_32KHZ_CLK_SLEEP_TIMER_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_USE_RTC_32KHZ_CLK_SLEEP_TIMER_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will use the RTC version of the 32khz clock for the sleep timer Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_USE_EXT_32KHZ_CLK_SLEEP_TIMER_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_USE_EXT_32KHZ_CLK_SLEEP_TIMER_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will use an external RTC for the 32khz clock for the sleep timer Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_LPMCU_BOOT_RESET_MUXSEL_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_LPMCU_BOOT_RESET_MUXSEL_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If 1, then it uses the CPU register bit, otherwise LP_BOOT_PIN is connected Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_LPMCU_USE_BOOT_REGS_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_LPMCU_USE_BOOT_REGS_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If 1, then the ARM will use the boot regs instead of the boot rom for the first 4 boot addresses (0x0 - 0xF) Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_LPMCU_CPU_RESET_OVERRIDE_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_LPMCU_CPU_RESET_OVERRIDE_EN_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If 1, then it will use the PD0 register value for LPMCU CPU RESET (higher priority than lpmcu_boot_reset_muxsel) Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_LPMCU_CPU_RESET_OVERRIDE_VAL_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_LPMCU_CPU_RESET_OVERRIDE_VAL_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If lpmcu_cpu_reset_override_en is set then this value will be used for the LPMCU CPU RESET Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_USE_2M_AON_PWR_SEQ_CLK_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_USE_2M_AON_PWR_SEQ_CLK_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will use either the osc 2M or rtc 32kHz clock for the AON power sequencer.  The field use_rtc_aon_pwr_seq_clk determines which. Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_USE_OSC2M_AS_TB_CLK_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_USE_OSC2M_AS_TB_CLK_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will use the osc 2M clock as the PD0 testbus clock Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_AON_SLEEP_TIMER_CLK_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_AON_SLEEP_TIMER_CLK_EN_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will enable the 32khz clock to the AON Sleep Timer Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_AON_EXT_32KHZ_OUT_EN_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_AON_EXT_32KHZ_OUT_EN_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will enable the 32khz clock to the AON pads as an output of the chip Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_USE_RTC_AON_PWR_SEQ_CLK_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_USE_RTC_AON_PWR_SEQ_CLK_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will use the RTC clock as the AON power sequencer clock once use_2m_aon_pwr_seq_clk is also set.  This must be set first. Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_INVERT_WAKEUP_GPIO_0_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_INVERT_WAKEUP_GPIO_0_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will invert the wakeup gpio_0 Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_FORCE_OFF_XO_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_FORCE_OFF_XO_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will force off the XO, otherwise XO is always on if BLE core is powered on. Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_FORCE_XO_TO_BYPASS_MODE_Msk (_U_(0x1) << AON_GP_REGS_AON_MISC_CTRL_FORCE_XO_TO_BYPASS_MODE_Pos)  /**< (AON_GP_REGS_AON_MISC_CTRL) If set, this will force the XO into bypass mode. Mask */
...
#define AON_GP_REGS_AON_MISC_CTRL_MASK      _U_(0x3FC07E)                                  /**< \deprecated (AON_GP_REGS_AON_MISC_CTRL) Register MASK  (Use AON_GP_REGS_AON_MISC_CTRL_Msk instead)  */
#define AON_GP_REGS_AON_MISC_CTRL_Msk       _U_(0x3FC07E)                                  /**< (AON_GP_REGS_AON_MISC_CTRL) Register Mask  */
...
#define AON_GP_REGS_AON_GLOBAL_RESET_RESETVALUE _U_(0x1B)                                     /**<  (AON_GP_REGS_AON_GLOBAL_RESET) Active Low Always On Reset Control  Reset Value */

#define AON_GP_REGS_AON_GLOBAL_RESET_GLOBAL_RSTN_Pos 0                                              /**< (AON_GP_REGS_AON_GLOBAL_RESET) Global Reset Position */
#define AON_GP_REGS_AON_GLOBAL_RESET_GLOBAL_RSTN_Msk (_U_(0x1) << AON_GP_REGS_AON_GLOBAL_RESET_GLOBAL_RSTN_Pos)  /**< (AON_GP_REGS_AON_GLOBAL_RESET) Global Reset Mask */
...
#define AON_GP_REGS_AON_GLOBAL_RESET_SLEEP_TIMER_RSTN_Msk (_U_(0x1) << AON_GP_REGS_AON_GLOBAL_RESET_SLEEP_TIMER_RSTN_Pos)  /**< (AON_GP_REGS_AON_GLOBAL_RESET) Sleep Timer Reset Mask */
...
#define AON_GP_REGS_AON_GLOBAL_RESET_BLE_LP_RSTN_Msk (_U_(0x1) << AON_GP_REGS_AON_GLOBAL_RESET_BLE_LP_RSTN_Pos)  /**< (AON_GP_REGS_AON_GLOBAL_RESET) BLE Low Power Reset Mask */
...
#define AON_GP_REGS_AON_GLOBAL_RESET_PD4_RSTN_Msk (_U_(0x1) << AON_GP_REGS_AON_GLOBAL_RESET_PD4_RSTN_Pos)  /**< (AON_GP_REGS_AON_GLOBAL_RESET) Allow the SW to force PD4 into reset Mask */
...
#define AON_GP_REGS_AON_GLOBAL_RESET_MASK   _U_(0x1B)                                      /**< \deprecated (AON_GP_REGS_AON_GLOBAL_RESET) Register MASK  (Use AON_GP_REGS_AON_GLOBAL_RESET_Msk instead)  */
#define AON_GP_REGS_AON_GLOBAL_RESET_Msk    _U_(0x1B)                                      /**< (AON_GP_REGS_AON_GLOBAL_RESET) Register Mask  */
...
#define AON_GP_REGS_AON_PULL_ENABLE_RESETVALUE _U_(0x00)                                     /**<  (AON_GP_REGS_AON_PULL_ENABLE) Active Low Always On Pull Enable Control  Reset Value */

#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_0_Pos 0                                              /**< (AON_GP_REGS_AON_PULL_ENABLE) Pull Enable for AO_GPIO_0 Position */
#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_0_Msk (_U_(0x1) << AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_0_Pos)  /**< (AON_GP_REGS_AON_PULL_ENABLE) Pull Enable for AO_GPIO_0 Mask */
...
#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_1_Msk (_U_(0x1) << AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_1_Pos)  /**< (AON_GP_REGS_AON_PULL_ENABLE) Pull Enable for AO_GPIO_1 Mask */
...
#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_2_Msk (_U_(0x1) << AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO_2_Pos)  /**< (AON_GP_REGS_AON_PULL_ENABLE) Pull Enable for AO_GPIO_2 Mask */
...
#define AON_GP_REGS_AON_PULL_ENABLE_MASK    _U_(0x07)                                      /**< \deprecated (AON_GP_REGS_AON_PULL_ENABLE) Register MASK  (Use AON_GP_REGS_AON_PULL_ENABLE_Msk instead)  */
#define AON_GP_REGS_AON_PULL_ENABLE_Msk     _U_(0x07)                                      /**< (AON_GP_REGS_AON_PULL_ENABLE) Register Mask  */

#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO__Pos 0                                              /**< (AON_GP_REGS_AON_PULL_ENABLE Position) Pull Enable for AO_GPIO_2 */
#define AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO__Msk (_U_(0x7) << AON_GP_REGS_AON_PULL_ENABLE_AO_GPIO__Pos)  /**< (AON_GP_REGS_AON_PULL_ENABLE Mask) AO_GPIO_ */
...
#define AON_GP_REGS_AON_RESET_CTRL_RESETVALUE _U_(0x3A0A0)                                  /**<  (AON_GP_REGS_AON_RESET_CTRL) Reset Count Control for PD1, PD4, PD6 and PD7  Reset Value */
...
#define AON_GP_REGS_AON_RESET_CTRL_PD1_COUNT_Msk (_U_(0xF) << AON_GP_REGS_AON_RESET_CTRL_PD1_COUNT_Pos)  /**< (AON_GP_REGS_AON_RESET_CTRL) Number of clock cycles to delay the PD1 reset. (also for PD7) Upper 4 MSBs only (bits 3:0 will be forced to 0) Mask */
...
#define AON_GP_REGS_AON_RESET_CTRL_PD4_COUNT_Msk (_U_(0xF) << AON_GP_REGS_AON_RESET_CTRL_PD4_COUNT_Pos)  /**< (AON_GP_REGS_AON_RESET_CTRL) Number of clock cycles to delay the PD4 reset. Upper 4 MSBs only (bits 3:0 will be forced to 0) Mask */
...
#define AON_GP_REGS_AON_RESET_CTRL_PD6_COUNT_Msk (_U_(0xF) << AON_GP_REGS_AON_RESET_CTRL_PD6_COUNT_Pos)  /**< (AON_GP_REGS_AON_RESET_CTRL) Number of clock cycles to delay the PD6 reset Mask */
...
#define AON_GP_REGS_AON_RESET_CTRL_MASK     _U_(0xFF0F0)                                   /**< \deprecated (AON_GP_REGS_AON_RESET_CTRL) Register MASK  (Use AON_GP_REGS_AON_RESET_CTRL_Msk instead)  */
#define AON_GP_REGS_AON_RESET_CTRL_Msk      _U_(0xFF0F0)                                   /**< (AON_GP_REGS_AON_RESET_CTRL) Register Mask  */
...
#define AON_GP_REGS_AON_BTRIM_ACTIVE_RESETVALUE _U_(0x08)                                     /**<  (AON_GP_REGS_AON_BTRIM_ACTIVE) BTRIM settings for active mode (i.e. not in retention)  Reset Value */

#define AON_GP_REGS_AON_BTRIM_ACTIVE_AON_BTRIM_ACTIVE_Pos 0                                              /**< (AON_GP_REGS_AON_BTRIM_ACTIVE)  Position */
#define AON_GP_REGS_AON_BTRIM_ACTIVE_AON_BTRIM_ACTIVE_Msk (_U_(0xF) << AON_GP_REGS_AON_BTRIM_ACTIVE_AON_BTRIM_ACTIVE_Pos)  /**< (AON_GP_REGS_AON_BTRIM_ACTIVE)  Mask */
...
#define AON_GP_REGS_AON_BTRIM_ACTIVE_MASK   _U_(0x0F)                                      /**< \deprecated (AON_GP_REGS_AON_BTRIM_ACTIVE) Register MASK  (Use AON_GP_REGS_AON_BTRIM_ACTIVE_Msk instead)  */
#define AON_GP_REGS_AON_BTRIM_ACTIVE_Msk    _U_(0x0F)                                      /**< (AON_GP_REGS_AON_BTRIM_ACTIVE) Register Mask  */
...
#define AON_GP_REGS_AON_BTRIM_RETENTION_RESETVALUE _U_(0x08)                                     /**<  (AON_GP_REGS_AON_BTRIM_RETENTION) BTRIM settings for retention mode  Reset Value */

#define AON_GP_REGS_AON_BTRIM_RETENTION_AON_BTRIM_RETENTION_Pos 0                                              /**< (AON_GP_REGS_AON_BTRIM_RETENTION)  Position */
#define AON_GP_REGS_AON_BTRIM_RETENTION_AON_BTRIM_RETENTION_Msk (_U_(0xF) << AON_GP_REGS_AON_BTRIM_RETENTION_AON_BTRIM_RETENTION_Pos)  /**< (AON_GP_REGS_AON_BTRIM_RETENTION)  Mask */
...
#define AON_GP_REGS_AON_BTRIM_RETENTION_MASK _U_(0x0F)                                      /**< \deprecated (AON_GP_REGS_AON_BTRIM_RETENTION) Register MASK  (Use AON_GP_REGS_AON_BTRIM_RETENTION_Msk instead)  */
#define AON_GP_REGS_AON_BTRIM_RETENTION_Msk _U_(0x0F)                                      /**< (AON_GP_REGS_AON_BTRIM_RETENTION) Register Mask  */
...
#define AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_RESETVALUE _U_(0x00)                                     /**<  (AON_GP_REGS_AON_LPMCU_SCRATCH_PAD) Usage for the LPMCU for any sort of status it needs to store for itself before it goes to sleep  Reset Value */

#define AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_AON_LPMCU_SCRATCH_PAD_Pos 0                                              /**< (AON_GP_REGS_AON_LPMCU_SCRATCH_PAD)  Position */
#define AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_AON_LPMCU_SCRATCH_PAD_Msk (_U_(0xFF) << AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_AON_LPMCU_SCRATCH_PAD_Pos)  /**< (AON_GP_REGS_AON_LPMCU_SCRATCH_PAD)  Mask */
...
#define AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_MASK _U_(0xFF)                                      /**< \deprecated (AON_GP_REGS_AON_LPMCU_SCRATCH_PAD) Register MASK  (Use AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_Msk instead)  */
#define AON_GP_REGS_AON_LPMCU_SCRATCH_PAD_Msk _U_(0xFF)                                      /**< (AON_GP_REGS_AON_LPMCU_SCRATCH_PAD) Register Mask  */
...
#define AON_GP_REGS_AON_LPMCU_COLD_BOOT_RESETVALUE _U_(0x78)                                     /**<  (AON_GP_REGS_AON_LPMCU_COLD_BOOT) To be used by ARM to determine if it is a cold boot or not  Reset Value */

#define AON_GP_REGS_AON_LPMCU_COLD_BOOT_AON_LPMCU_COLD_BOOT_Pos 0                                              /**< (AON_GP_REGS_AON_LPMCU_COLD_BOOT)  Position */
#define AON_GP_REGS_AON_LPMCU_COLD_BOOT_AON_LPMCU_COLD_BOOT_Msk (_U_(0xFF) << AON_GP_REGS_AON_LPMCU_COLD_BOOT_AON_LPMCU_COLD_BOOT_Pos)  /**< (AON_GP_REGS_AON_LPMCU_COLD_BOOT)  Mask */
...
#define AON_GP_REGS_AON_LPMCU_COLD_BOOT_MASK _U_(0xFF)                                      /**< \deprecated (AON_GP_REGS_AON_LPMCU_COLD_BOOT) Register MASK  (Use AON_GP_REGS_AON_LPMCU_COLD_BOOT_Msk instead)  */
#define AON_GP_REGS_AON_LPMCU_COLD_BOOT_Msk _U_(0xFF)                                      /**< (AON_GP_REGS_AON_LPMCU_COLD_BOOT) Register Mask  */
...
#define AON_GP_REGS_AON_BO_OUT_STATUS_RESETVALUE _U_(0x00)                                     /**<  (AON_GP_REGS_AON_BO_OUT_STATUS) Brown Out Detected (must be cleared manually)  Reset Value */

#define AON_GP_REGS_AON_BO_OUT_STATUS_AON_BO_OUT_STATUS_Pos 0                                              /**< (AON_GP_REGS_AON_BO_OUT_STATUS)  Position */
#define AON_GP_REGS_AON_BO_OUT_STATUS_AON_BO_OUT_STATUS_Msk (_U_(0x1) << AON_GP_REGS_AON_BO_OUT_STATUS_AON_BO_OUT_STATUS_Pos)  /**< (AON_GP_REGS_AON_BO_OUT_STATUS)  Mask */
...
#define AON_GP_REGS_AON_BO_OUT_STATUS_MASK  _U_(0x01)                                      /**< \deprecated (AON_GP_REGS_AON_BO_OUT_STATUS) Register MASK  (Use AON_GP_REGS_AON_BO_OUT_STATUS_Msk instead)  */
#define AON_GP_REGS_AON_BO_OUT_STATUS_Msk   _U_(0x01)                                      /**< (AON_GP_REGS_AON_BO_OUT_STATUS) Register Mask  */
...
#define AON_GP_REGS_CLEAR_BROWN_OUT_REG_RESETVALUE _U_(0x00)                                     /**<  (AON_GP_REGS_CLEAR_BROWN_OUT_REG) Set to 1 to clear (hold until 0 read at aon_bo_out_status and then this must be cleared to detect another brown out condition)  Reset Value */

#define AON_GP_REGS_CLEAR_BROWN_OUT_REG_CLEAR_BROWN_OUT_REG_Pos 0                                              /**< (AON_GP_REGS_CLEAR_BROWN_OUT_REG)  Position */
#define AON_GP_REGS_CLEAR_BROWN_OUT_REG_CLEAR_BROWN_OUT_REG_Msk (_U_(0x1) << AON_GP_REGS_CLEAR_BROWN_OUT_REG_CLEAR_BROWN_OUT_REG_Pos)  /**< (AON_GP_REGS_CLEAR_BROWN_OUT_REG)  Mask */
...
#define AON_GP_REGS_CLEAR_BROWN_OUT_REG_MASK _U_(0x01)                                      /**< \deprecated (AON_GP_REGS_CLEAR_BROWN_OUT_REG) Register MASK  (Use AON_GP_REGS_CLEAR_BROWN_OUT_REG_Msk instead)  */
#define AON_GP_REGS_CLEAR_BROWN_OUT_REG_Msk _U_(0x01)                                      /**< (AON_GP_REGS_CLEAR_BROWN_OUT_REG) Register Mask  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_RESETVALUE _U_(0xF600409)                                /**<  (AON_GP_REGS_RF_PMU_REGS_0) RF PMU Registers  Reset Value */
...
#define AON_GP_REGS_RF_PMU_REGS_0_CLK_EDGE_SEL_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_0_CLK_EDGE_SEL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Select clock edge for Vreg comparator in buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_EDGE_SEL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Comparator samples on rising edge of clock  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_EDGE_SEL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Comparator samples on falling edge of clock  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Select the output voltage of the buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.12V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.15V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.17V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.20V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.22V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.25V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.27V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.30V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.32V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.35V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.37V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.40V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.42V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.45V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.47V  */
#define   AON_GP_REGS_RF_PMU_REGS_0_VOUT_CTRL_BUCK_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.50V  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_CLK_2_4_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_0_CLK_2_4_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Comparator clock divider in buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_2_4_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 2  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_2_4_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 4  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_VREG_FILT_CTRL_Msk (_U_(0x3) << AON_GP_REGS_RF_PMU_REGS_0_VREG_FILT_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Not Used Mask */
...
#define AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Programmable divider that sets the on duration of positive charging pulse Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 4  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 6  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 8  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 10  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 12  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 14  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_DIV_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 16  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_RESET_FSM_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_0_RESET_FSM_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Force reset of FSM in buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_RESET_FSM_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) FSM is not reset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_RESET_FSM_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) FSM is reset  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_EN_TRISTATE_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_0_EN_TRISTATE_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Allow tristate_ctrl to control minimum time between pulses of the buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_EN_TRISTATE_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Tristate logic disable  */
#define   AON_GP_REGS_RF_PMU_REGS_0_EN_TRISTATE_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Tristate logic enabled  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Controls the minimum time between pulses in the buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 4  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 6  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 8  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 10  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 12  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 14  */
#define   AON_GP_REGS_RF_PMU_REGS_0_TRISTATE_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Divide by 16  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Controls a fixed comparator offset in the buck converter for positive pulses Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 3.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 3.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 5.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 5.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETP_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 6.0mV offset  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Controls a fixed comparator offset in the buck converter for negative pulses Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 3.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 3.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.0mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.4mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4.8mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 5.2mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 5.6mV offset  */
#define   AON_GP_REGS_RF_PMU_REGS_0_OFFSETN_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 6.0mV offset  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_Msk (_U_(0x7F) << AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Power switch units for the buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 0 power switches enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 1 power switch enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 2 power switches enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 3 power switches enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) 4 power switches enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_31_Val _U_(0x1F)                                      /**< (AON_GP_REGS_RF_PMU_REGS_0) 5 power switches enabled  */
#define   AON_GP_REGS_RF_PMU_REGS_0_P_SW_CTRL_63_Val _U_(0x3F)                                      /**< (AON_GP_REGS_RF_PMU_REGS_0) 6 power switches enabled  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_CLK_SEL_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_0_CLK_SEL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_0) Source clock for the buck converter Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_SEL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) Internal 26MHz clock  */
#define   AON_GP_REGS_RF_PMU_REGS_0_CLK_SEL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_0) External 52MHz clock  */
...
#define AON_GP_REGS_RF_PMU_REGS_0_MASK      _U_(0xFFFFFFFF)                                /**< \deprecated (AON_GP_REGS_RF_PMU_REGS_0) Register MASK  (Use AON_GP_REGS_RF_PMU_REGS_0_Msk instead)  */
#define AON_GP_REGS_RF_PMU_REGS_0_Msk       _U_(0xFFFFFFFF)                                /**< (AON_GP_REGS_RF_PMU_REGS_0) Register Mask  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_RESETVALUE _U_(0x31888C82)                               /**<  (AON_GP_REGS_RF_PMU_REGS_1) RF PMU Registers  Reset Value */
...
#define AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Internal reference voltage level for sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0.5V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0.6V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0.7V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0.8V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0.9V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.0V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.1V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.2V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.3V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.4V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.5V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.6V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.7V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.8V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1.9V (only for VBATT gt 2.0V)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_BIAS_RES_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.0V (only for VBATT gt 2.0V)  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Reference Voltage Source for the Sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Buffered reference voltage  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) IR voltage  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) VBATT divided by 2  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS1  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS2  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS3  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS4  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_REF_SEL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) VBATT supply voltage  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_BOD_EN_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_1_BOD_EN_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Brown Out Detector Enable Control Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_BOD_EN_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Disable  */
#define   AON_GP_REGS_RF_PMU_REGS_1_BOD_EN_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Enable  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_LPD_CLK_INJECT_EN_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_1_LPD_CLK_INJECT_EN_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Low Power Domain Clock Injection Enable Control Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_LPD_CLK_INJECT_EN_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Disable (Free running)  */
#define   AON_GP_REGS_RF_PMU_REGS_1_LPD_CLK_INJECT_EN_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Enable (Lock to XO clock)  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_BYP_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_BYP_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Bypass controlf for EFUSE LDO Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_BYP_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) EFUSE LDO regulates from VBATT voltage to 2.5V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_BYP_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1)  EFUSE LDO is bypass to VBATT voltage  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Output voltage of EFUSE LDO Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.3V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.4V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.4V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.5V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.6V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.7V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.7V  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_VOUT_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2.8V  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_Msk (_U_(0x3) << AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Set the current bias for the EFUSE LDO Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 80uA bias current  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 100uA bias current  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 120uA bias current  */
#define   AON_GP_REGS_RF_PMU_REGS_1_EFUSE_LDO_IBIAS_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 140uA bias current  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_PIERCE_RES_CTRL_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_1_PIERCE_RES_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) RTC crystal circuit feedback resistance value Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_RES_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 20Mohm resistor  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_RES_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 30Mohm resistor  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Transconductance of RTC oscillator Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 75nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 85nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 96nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 106nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 116nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 127nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 137nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 147nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 158nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 168nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 178nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 189nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 199nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 209nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 220nS  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_GM_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 230nS  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_Msk (_U_(0xF) << AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) On chip single ended capacitors for RTC oscillator Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 0pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 1pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 2pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 3pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 4pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 5pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 6pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 7pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 8pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 9pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 10pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 11pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 12pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 13pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 14pF  */
#define   AON_GP_REGS_RF_PMU_REGS_1_PIERCE_CAP_CTRL_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) 15pF  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_CTRL_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) enable input channel time multiplexing to the sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Conversion is done on the four input channels in a time multiplexed manner  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Conversion is done for one specific input channel  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Input channel selection for the sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS1  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS2  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS3  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) GPIO_MS4  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) On Chip Temperature  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) VBATT divided by 4 voltage level  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) LP_LDO_OUT_1P2 low power domain voltage  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_CHN_SEL_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Sensor ADC reference voltage level  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_Msk (_U_(0x3) << AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Optional mode to improve sub-ranging technique of the sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) input dynamic range from 0V to VBATT voltage level  */
#define   AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) input dynamic range from 0.08*VBATT to 0.92*VBATT  */
#define   AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) input dynamic range from 0.17*VBATT to 0.83*VBATT  */
#define   AON_GP_REGS_RF_PMU_REGS_1_CODE_IN_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) input dynamic range from 0.25*VBATT to 0.75*VBATT  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_Msk (_U_(0x3) << AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_1) Comparator biasing current for different sampling rates of the sensor ADC Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Comparator bias current is 4uA  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Comparator bias current is 8uA  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Comparator bias current is 20uA  */
#define   AON_GP_REGS_RF_PMU_REGS_1_SADC_LP_CTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_1) Comparator bias current is 24uA  */
...
#define AON_GP_REGS_RF_PMU_REGS_1_MASK      _U_(0xFFFFFFFF)                                /**< \deprecated (AON_GP_REGS_RF_PMU_REGS_1) Register MASK  (Use AON_GP_REGS_RF_PMU_REGS_1_Msk instead)  */
#define AON_GP_REGS_RF_PMU_REGS_1_Msk       _U_(0xFFFFFFFF)                                /**< (AON_GP_REGS_RF_PMU_REGS_1) Register Mask  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_RESETVALUE _U_(0x05)                                     /**<  (AON_GP_REGS_RF_PMU_REGS_2) RF PMU Registers  Reset Value */
...
#define AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_BYP_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_BYP_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) Bypass mode of digital core LDO which regulates from the buck converter output to the local power domains of each digital power island Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_BYP_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) Not in bypass mode  */
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_BYP_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) Bypass mode so output will be shorted to the buck converter output  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_Msk (_U_(0x3) << AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) Voltage level of the digital core LDO when LDO is not in bypass mode Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 0.91V  */
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 0.96V  */
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 1.02V  */
#define   AON_GP_REGS_RF_PMU_REGS_2_DIG_CORE_LDO_VCTRL_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 1.09V  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) Controls the sensor ADCs internal reference buffer output resistance Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for applications that require less than 10KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for throughputs between 10KSPS and 100KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for 100KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for 325KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for 550KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for 775KSPS  */
#define   AON_GP_REGS_RF_PMU_REGS_2_REF_HP_MODE_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) setting for 1MSPS  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_OFFSET_CAL_EN_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_2_OFFSET_CAL_EN_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) Enable sensor ADC offset calibration Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_2_OFFSET_CAL_EN_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) Disable  */
#define   AON_GP_REGS_RF_PMU_REGS_2_OFFSET_CAL_EN_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) Enable  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_RESERVED_7_Msk (_U_(0x1) << AON_GP_REGS_RF_PMU_REGS_2_RESERVED_7_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) not using Mask */
...
#define AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_Msk (_U_(0x1F) << AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) Control the 26MHz RC oscillator frequency Mask */
...
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_0_Val _U_(0x0)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 12MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_1_Val _U_(0x1)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 13MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_2_Val _U_(0x2)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 14MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_3_Val _U_(0x3)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 15MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_4_Val _U_(0x4)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 16MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_5_Val _U_(0x5)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 17MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_6_Val _U_(0x6)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 18MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_7_Val _U_(0x7)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 19MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_8_Val _U_(0x8)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 20MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_9_Val _U_(0x9)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 21MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_10_Val _U_(0xA)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 22MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_11_Val _U_(0xB)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 23MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_12_Val _U_(0xC)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 24MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_13_Val _U_(0xD)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 25MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_14_Val _U_(0xE)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 26MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_15_Val _U_(0xF)                                       /**< (AON_GP_REGS_RF_PMU_REGS_2) 27MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_16_Val _U_(0x10)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 28MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_17_Val _U_(0x11)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 29MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_18_Val _U_(0x12)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 30MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_19_Val _U_(0x13)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 31MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_20_Val _U_(0x14)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 32MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_21_Val _U_(0x15)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 33MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_22_Val _U_(0x16)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 34MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_23_Val _U_(0x17)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 35MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_24_Val _U_(0x18)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 36MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_25_Val _U_(0x19)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 37MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_26_Val _U_(0x1A)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 38MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_27_Val _U_(0x1B)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 39MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_28_Val _U_(0x1C)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 40MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_29_Val _U_(0x1D)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 41MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_30_Val _U_(0x1E)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 42MHz  */
#define   AON_GP_REGS_RF_PMU_REGS_2_CLK_CTRL_26MHZ_31_Val _U_(0x1F)                                      /**< (AON_GP_REGS_RF_PMU_REGS_2) 43MHz  */
...
#define AON_GP_REGS_RF_PMU_REGS_2_RESERVED_15_13_Msk (_U_(0x7) << AON_GP_REGS_RF_PMU_REGS_2_RESERVED_15_13_Pos)  /**< (AON_GP_REGS_RF_PMU_REGS_2) not using Mask */
...
#define AON_GP_REGS_RF_PMU_REGS_2_MASK      _U_(0xFFFF)                                    /**< \deprecated (AON_GP_REGS_RF_PMU_REGS_2) Register MASK  (Use AON_GP_REGS_RF_PMU_REGS_2_Msk instead)  */
#define AON_GP_REGS_RF_PMU_REGS_2_Msk       _U_(0xFFFF)                                    /**< (AON_GP_REGS_RF_PMU_REGS_2) Register Mask  */
...
#define AON_GP_REGS_MS_GPIO_MODE_RESETVALUE _U_(0x0F)                                     /**<  (AON_GP_REGS_MS_GPIO_MODE) Analog Mode Select of Mixed Signal GPIOs  Reset Value */
...
#define AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_44_Msk (_U_(0x1) << AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_44_Pos)  /**< (AON_GP_REGS_MS_GPIO_MODE) Active High Analog Mode Enable for Mixed Signal LP_GPIO_44 Mask */
...
#define AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_45_Msk (_U_(0x1) << AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_45_Pos)  /**< (AON_GP_REGS_MS_GPIO_MODE) Active High Analog Mode Enable for Mixed Signal LP_GPIO_45 Mask */
...
#define AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_46_Msk (_U_(0x1) << AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_46_Pos)  /**< (AON_GP_REGS_MS_GPIO_MODE) Active High Analog Mode Enable for Mixed Signal LP_GPIO_46 Mask */
...
#define AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_47_Msk (_U_(0x1) << AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE_47_Pos)  /**< (AON_GP_REGS_MS_GPIO_MODE) Active High Analog Mode Enable for Mixed Signal LP_GPIO_47 Mask */
...
#define AON_GP_REGS_MS_GPIO_MODE_MASK       _U_(0x0F)                                      /**< \deprecated (AON_GP_REGS_MS_GPIO_MODE) Register MASK  (Use AON_GP_REGS_MS_GPIO_MODE_Msk instead)  */
#define AON_GP_REGS_MS_GPIO_MODE_Msk        _U_(0x0F)                                      /**< (AON_GP_REGS_MS_GPIO_MODE) Register Mask  */
...
#define AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE__Msk (_U_(0xF) << AON_GP_REGS_MS_GPIO_MODE_ANALOG_ENABLE__Pos)  /**< (AON_GP_REGS_MS_GPIO_MODE Mask) ANALOG_ENABLE_ */
...
#define AON_GP_REGS_IO_PADS_CONTROL_RESETVALUE _U_(0x01)                                     /**<  (AON_GP_REGS_IO_PADS_CONTROL) Controls behaviour of IO Pads in Sleep Mode  Reset Value */
...
#define AON_GP_REGS_IO_PADS_CONTROL_LATCH_ENABLE_Msk (_U_(0x1) << AON_GP_REGS_IO_PADS_CONTROL_LATCH_ENABLE_Pos)  /**< (AON_GP_REGS_IO_PADS_CONTROL) Active High Latch Enable of IO Pads configuration parameters. When Low, Pads retain their configured state during sleep mode. Mask */
...
#define AON_GP_REGS_IO_PADS_CONTROL_MASK    _U_(0x01)                                      /**< \deprecated (AON_GP_REGS_IO_PADS_CONTROL) Register MASK  (Use AON_GP_REGS_IO_PADS_CONTROL_Msk instead)  */
#define AON_GP_REGS_IO_PADS_CONTROL_Msk     _U_(0x01)                                      /**< (AON_GP_REGS_IO_PADS_CONTROL) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of Always On General Purpose Registers */

#endif /* _SAMB11_AON_GP_REGS_COMPONENT_H_ */
