...
#ifndef _SAMB11_DUALTIMER_COMPONENT_H_
#define _SAMB11_DUALTIMER_COMPONENT_H_
#define _SAMB11_DUALTIMER_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMB_SAMB11 ARM General Purpose Dual Timer
 *  @{
 */
/* ========================================================================== */
...
#define DUALTIMER_DT1234                     /**< (DUALTIMER) Module ID */
#define REV_DUALTIMER 0x100                  /**< (DUALTIMER) Module revision */
...
#define DUALTIMER_TIMER1LOAD_RESETVALUE     _U_(0x00)                                     /**<  (DUALTIMER_TIMER1LOAD) Timer 1 Load Register  Reset Value */

#define DUALTIMER_TIMER1LOAD_TIMER1LOAD_Pos 0                                              /**< (DUALTIMER_TIMER1LOAD)  Position */
#define DUALTIMER_TIMER1LOAD_TIMER1LOAD_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER1LOAD_TIMER1LOAD_Pos)  /**< (DUALTIMER_TIMER1LOAD)  Mask */
...
#define DUALTIMER_TIMER1LOAD_MASK           _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER1LOAD) Register MASK  (Use DUALTIMER_TIMER1LOAD_Msk instead)  */
#define DUALTIMER_TIMER1LOAD_Msk            _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER1LOAD) Register Mask  */
...
#define DUALTIMER_TIMER1VALUE_RESETVALUE    _U_(0xFFFFFFFF)                               /**<  (DUALTIMER_TIMER1VALUE) Timer 1 Current Value Register  Reset Value */

#define DUALTIMER_TIMER1VALUE_TIMER1VALUE_Pos 0                                              /**< (DUALTIMER_TIMER1VALUE)  Position */
#define DUALTIMER_TIMER1VALUE_TIMER1VALUE_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER1VALUE_TIMER1VALUE_Pos)  /**< (DUALTIMER_TIMER1VALUE)  Mask */
...
#define DUALTIMER_TIMER1VALUE_MASK          _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER1VALUE) Register MASK  (Use DUALTIMER_TIMER1VALUE_Msk instead)  */
#define DUALTIMER_TIMER1VALUE_Msk           _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER1VALUE) Register Mask  */
...
#define DUALTIMER_TIMER1CONTROL_RESETVALUE  _U_(0x20)                                     /**<  (DUALTIMER_TIMER1CONTROL) Timer 1 Control Register  Reset Value */

#define DUALTIMER_TIMER1CONTROL_ONE_SHOT_COUNT_Pos 0                                              /**< (DUALTIMER_TIMER1CONTROL) Mode Select Position */
#define DUALTIMER_TIMER1CONTROL_ONE_SHOT_COUNT_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_ONE_SHOT_COUNT_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Mode Select Mask */
...
#define   DUALTIMER_TIMER1CONTROL_ONE_SHOT_COUNT_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER1CONTROL) Wrapping Mode  */
#define   DUALTIMER_TIMER1CONTROL_ONE_SHOT_COUNT_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER1CONTROL) One-Shot Mode  */
...
#define DUALTIMER_TIMER1CONTROL_TIMER_SIZE_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_TIMER_SIZE_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Timer Size Mask */
...
#define   DUALTIMER_TIMER1CONTROL_TIMER_SIZE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER1CONTROL) 16-bit Counter  */
#define   DUALTIMER_TIMER1CONTROL_TIMER_SIZE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER1CONTROL) 32-bit Counter  */
...
#define DUALTIMER_TIMER1CONTROL_TIMERPRE_Msk (_U_(0x3) << DUALTIMER_TIMER1CONTROL_TIMERPRE_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Prescale Bits Mask */
...
#define   DUALTIMER_TIMER1CONTROL_TIMERPRE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER1CONTROL) 0 Stages, Clock Divided by 1  */
#define   DUALTIMER_TIMER1CONTROL_TIMERPRE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER1CONTROL) 4 Stages, Clock Divided by 16  */
#define   DUALTIMER_TIMER1CONTROL_TIMERPRE_2_Val _U_(0x2)                                       /**< (DUALTIMER_TIMER1CONTROL) 8 Stages, Clock Divided by 256  */
#define   DUALTIMER_TIMER1CONTROL_TIMERPRE_3_Val _U_(0x3)                                       /**< (DUALTIMER_TIMER1CONTROL) Undefined, do not use  */
...
#define DUALTIMER_TIMER1CONTROL_RESERVED4_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_RESERVED4_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Reserved bit do not use Mask */
...
#define DUALTIMER_TIMER1CONTROL_INTERRUPT_ENABLE_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_INTERRUPT_ENABLE_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Active High Interrupt Enable Bit Mask */
...
#define DUALTIMER_TIMER1CONTROL_TIMER_MODE_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_TIMER_MODE_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Mode Bit Mask */
...
#define   DUALTIMER_TIMER1CONTROL_TIMER_MODE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER1CONTROL) Free-Running Mode  */
#define   DUALTIMER_TIMER1CONTROL_TIMER_MODE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER1CONTROL) Periodic Mode  */
...
#define DUALTIMER_TIMER1CONTROL_TIMER_ENABLE_Msk (_U_(0x1) << DUALTIMER_TIMER1CONTROL_TIMER_ENABLE_Pos)  /**< (DUALTIMER_TIMER1CONTROL) Active High Timer Enable Mask */
...
#define DUALTIMER_TIMER1CONTROL_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMER1CONTROL) Register MASK  (Use DUALTIMER_TIMER1CONTROL_Msk instead)  */
#define DUALTIMER_TIMER1CONTROL_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMER1CONTROL) Register Mask  */
...
#define DUALTIMER_TIMER1INTCLR_RESETVALUE   _U_(0x00)                                     /**<  (DUALTIMER_TIMER1INTCLR) Timer 1 Interrupt Clear Register  Reset Value */

#define DUALTIMER_TIMER1INTCLR_TIMER1INTCLR_Pos 0                                              /**< (DUALTIMER_TIMER1INTCLR)  Position */
#define DUALTIMER_TIMER1INTCLR_TIMER1INTCLR_Msk (_U_(0x1) << DUALTIMER_TIMER1INTCLR_TIMER1INTCLR_Pos)  /**< (DUALTIMER_TIMER1INTCLR)  Mask */
...
#define DUALTIMER_TIMER1INTCLR_MASK         _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER1INTCLR) Register MASK  (Use DUALTIMER_TIMER1INTCLR_Msk instead)  */
#define DUALTIMER_TIMER1INTCLR_Msk          _U_(0x01)                                      /**< (DUALTIMER_TIMER1INTCLR) Register Mask  */
...
#define DUALTIMER_TIMER1RIS_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMER1RIS) Timer 1 Raw Interrupt Status Register  Reset Value */

#define DUALTIMER_TIMER1RIS_TIMER1RIS_Pos   0                                              /**< (DUALTIMER_TIMER1RIS)  Position */
#define DUALTIMER_TIMER1RIS_TIMER1RIS_Msk   (_U_(0x1) << DUALTIMER_TIMER1RIS_TIMER1RIS_Pos)  /**< (DUALTIMER_TIMER1RIS)  Mask */
...
#define DUALTIMER_TIMER1RIS_MASK            _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER1RIS) Register MASK  (Use DUALTIMER_TIMER1RIS_Msk instead)  */
#define DUALTIMER_TIMER1RIS_Msk             _U_(0x01)                                      /**< (DUALTIMER_TIMER1RIS) Register Mask  */
...
#define DUALTIMER_TIMER1MIS_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMER1MIS) Timer 1 Masked Interrupt Status Register  Reset Value */

#define DUALTIMER_TIMER1MIS_TIMER1MIS_Pos   0                                              /**< (DUALTIMER_TIMER1MIS)  Position */
#define DUALTIMER_TIMER1MIS_TIMER1MIS_Msk   (_U_(0x1) << DUALTIMER_TIMER1MIS_TIMER1MIS_Pos)  /**< (DUALTIMER_TIMER1MIS)  Mask */
...
#define DUALTIMER_TIMER1MIS_MASK            _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER1MIS) Register MASK  (Use DUALTIMER_TIMER1MIS_Msk instead)  */
#define DUALTIMER_TIMER1MIS_Msk             _U_(0x01)                                      /**< (DUALTIMER_TIMER1MIS) Register Mask  */
...
#define DUALTIMER_TIMER1BGLOAD_RESETVALUE   _U_(0x00)                                     /**<  (DUALTIMER_TIMER1BGLOAD) Timer 1 Background Load Register (Reload Value for Period Mode)  Reset Value */

#define DUALTIMER_TIMER1BGLOAD_TIMER1BGLOAD_Pos 0                                              /**< (DUALTIMER_TIMER1BGLOAD)  Position */
#define DUALTIMER_TIMER1BGLOAD_TIMER1BGLOAD_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER1BGLOAD_TIMER1BGLOAD_Pos)  /**< (DUALTIMER_TIMER1BGLOAD)  Mask */
...
#define DUALTIMER_TIMER1BGLOAD_MASK         _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER1BGLOAD) Register MASK  (Use DUALTIMER_TIMER1BGLOAD_Msk instead)  */
#define DUALTIMER_TIMER1BGLOAD_Msk          _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER1BGLOAD) Register Mask  */
...
#define DUALTIMER_TIMER2LOAD_RESETVALUE     _U_(0x00)                                     /**<  (DUALTIMER_TIMER2LOAD) Timer 2 Load Register  Reset Value */

#define DUALTIMER_TIMER2LOAD_TIMER2LOAD_Pos 0                                              /**< (DUALTIMER_TIMER2LOAD)  Position */
#define DUALTIMER_TIMER2LOAD_TIMER2LOAD_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER2LOAD_TIMER2LOAD_Pos)  /**< (DUALTIMER_TIMER2LOAD)  Mask */
...
#define DUALTIMER_TIMER2LOAD_MASK           _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER2LOAD) Register MASK  (Use DUALTIMER_TIMER2LOAD_Msk instead)  */
#define DUALTIMER_TIMER2LOAD_Msk            _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER2LOAD) Register Mask  */
...
#define DUALTIMER_TIMER2VALUE_RESETVALUE    _U_(0xFFFFFFFF)                               /**<  (DUALTIMER_TIMER2VALUE) Timer 2 Current Value Register  Reset Value */

#define DUALTIMER_TIMER2VALUE_TIMER2VALUE_Pos 0                                              /**< (DUALTIMER_TIMER2VALUE)  Position */
#define DUALTIMER_TIMER2VALUE_TIMER2VALUE_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER2VALUE_TIMER2VALUE_Pos)  /**< (DUALTIMER_TIMER2VALUE)  Mask */
...
#define DUALTIMER_TIMER2VALUE_MASK          _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER2VALUE) Register MASK  (Use DUALTIMER_TIMER2VALUE_Msk instead)  */
#define DUALTIMER_TIMER2VALUE_Msk           _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER2VALUE) Register Mask  */
...
#define DUALTIMER_TIMER2CONTROL_RESETVALUE  _U_(0x20)                                     /**<  (DUALTIMER_TIMER2CONTROL) Timer 2 Control Register  Reset Value */

#define DUALTIMER_TIMER2CONTROL_ONE_SHOT_COUNT_Pos 0                                              /**< (DUALTIMER_TIMER2CONTROL) Mode Select Position */
#define DUALTIMER_TIMER2CONTROL_ONE_SHOT_COUNT_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_ONE_SHOT_COUNT_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Mode Select Mask */
...
#define   DUALTIMER_TIMER2CONTROL_ONE_SHOT_COUNT_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER2CONTROL) Wrapping Mode  */
#define   DUALTIMER_TIMER2CONTROL_ONE_SHOT_COUNT_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER2CONTROL) One-Shot Mode  */
...
#define DUALTIMER_TIMER2CONTROL_TIMER_SIZE_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_TIMER_SIZE_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Timer Size Mask */
...
#define   DUALTIMER_TIMER2CONTROL_TIMER_SIZE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER2CONTROL) 16-bit Counter  */
#define   DUALTIMER_TIMER2CONTROL_TIMER_SIZE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER2CONTROL) 32-bit Counter  */
...
#define DUALTIMER_TIMER2CONTROL_TIMERPRE_Msk (_U_(0x3) << DUALTIMER_TIMER2CONTROL_TIMERPRE_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Prescale Bits Mask */
...
#define   DUALTIMER_TIMER2CONTROL_TIMERPRE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER2CONTROL) 0 Stages, Clock Divided by 1  */
#define   DUALTIMER_TIMER2CONTROL_TIMERPRE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER2CONTROL) 4 Stages, Clock Divided by 16  */
#define   DUALTIMER_TIMER2CONTROL_TIMERPRE_2_Val _U_(0x2)                                       /**< (DUALTIMER_TIMER2CONTROL) 8 Stages, Clock Divided by 256  */
#define   DUALTIMER_TIMER2CONTROL_TIMERPRE_3_Val _U_(0x3)                                       /**< (DUALTIMER_TIMER2CONTROL) Undefined, do not use  */
...
#define DUALTIMER_TIMER2CONTROL_RESERVED4_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_RESERVED4_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Reserved bit do not use Mask */
...
#define DUALTIMER_TIMER2CONTROL_INTERRUPT_ENABLE_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_INTERRUPT_ENABLE_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Active High Interrupt Enable Bit Mask */
...
#define DUALTIMER_TIMER2CONTROL_TIMER_MODE_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_TIMER_MODE_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Mode Bit Mask */
...
#define   DUALTIMER_TIMER2CONTROL_TIMER_MODE_0_Val _U_(0x0)                                       /**< (DUALTIMER_TIMER2CONTROL) Free-Running Mode  */
#define   DUALTIMER_TIMER2CONTROL_TIMER_MODE_1_Val _U_(0x1)                                       /**< (DUALTIMER_TIMER2CONTROL) Periodic Mode  */
...
#define DUALTIMER_TIMER2CONTROL_TIMER_ENABLE_Msk (_U_(0x1) << DUALTIMER_TIMER2CONTROL_TIMER_ENABLE_Pos)  /**< (DUALTIMER_TIMER2CONTROL) Active High Timer Enable Mask */
...
#define DUALTIMER_TIMER2CONTROL_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMER2CONTROL) Register MASK  (Use DUALTIMER_TIMER2CONTROL_Msk instead)  */
#define DUALTIMER_TIMER2CONTROL_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMER2CONTROL) Register Mask  */
...
#define DUALTIMER_TIMER2INTCLR_RESETVALUE   _U_(0x00)                                     /**<  (DUALTIMER_TIMER2INTCLR) Timer 2 Interrupt Clear Register  Reset Value */

#define DUALTIMER_TIMER2INTCLR_TIMER2INTCLR_Pos 0                                              /**< (DUALTIMER_TIMER2INTCLR)  Position */
#define DUALTIMER_TIMER2INTCLR_TIMER2INTCLR_Msk (_U_(0x1) << DUALTIMER_TIMER2INTCLR_TIMER2INTCLR_Pos)  /**< (DUALTIMER_TIMER2INTCLR)  Mask */
...
#define DUALTIMER_TIMER2INTCLR_MASK         _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER2INTCLR) Register MASK  (Use DUALTIMER_TIMER2INTCLR_Msk instead)  */
#define DUALTIMER_TIMER2INTCLR_Msk          _U_(0x01)                                      /**< (DUALTIMER_TIMER2INTCLR) Register Mask  */
...
#define DUALTIMER_TIMER2RIS_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMER2RIS) Timer 2 Raw Interrupt Status Register  Reset Value */

#define DUALTIMER_TIMER2RIS_TIMER2RIS_Pos   0                                              /**< (DUALTIMER_TIMER2RIS)  Position */
#define DUALTIMER_TIMER2RIS_TIMER2RIS_Msk   (_U_(0x1) << DUALTIMER_TIMER2RIS_TIMER2RIS_Pos)  /**< (DUALTIMER_TIMER2RIS)  Mask */
...
#define DUALTIMER_TIMER2RIS_MASK            _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER2RIS) Register MASK  (Use DUALTIMER_TIMER2RIS_Msk instead)  */
#define DUALTIMER_TIMER2RIS_Msk             _U_(0x01)                                      /**< (DUALTIMER_TIMER2RIS) Register Mask  */
...
#define DUALTIMER_TIMER2MIS_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMER2MIS) Timer 2 Masked Interrupt Status Register  Reset Value */

#define DUALTIMER_TIMER2MIS_TIMER2MIS_Pos   0                                              /**< (DUALTIMER_TIMER2MIS)  Position */
#define DUALTIMER_TIMER2MIS_TIMER2MIS_Msk   (_U_(0x1) << DUALTIMER_TIMER2MIS_TIMER2MIS_Pos)  /**< (DUALTIMER_TIMER2MIS)  Mask */
...
#define DUALTIMER_TIMER2MIS_MASK            _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMER2MIS) Register MASK  (Use DUALTIMER_TIMER2MIS_Msk instead)  */
#define DUALTIMER_TIMER2MIS_Msk             _U_(0x01)                                      /**< (DUALTIMER_TIMER2MIS) Register Mask  */
...
#define DUALTIMER_TIMER2BGLOAD_RESETVALUE   _U_(0x00)                                     /**<  (DUALTIMER_TIMER2BGLOAD) Timer 2 Background Load Register (Reload Value for Period Mode)  Reset Value */

#define DUALTIMER_TIMER2BGLOAD_TIMER2BGLOAD_Pos 0                                              /**< (DUALTIMER_TIMER2BGLOAD)  Position */
#define DUALTIMER_TIMER2BGLOAD_TIMER2BGLOAD_Msk (_U_(0xFFFFFFFF) << DUALTIMER_TIMER2BGLOAD_TIMER2BGLOAD_Pos)  /**< (DUALTIMER_TIMER2BGLOAD)  Mask */
...
#define DUALTIMER_TIMER2BGLOAD_MASK         _U_(0xFFFFFFFF)                                /**< \deprecated (DUALTIMER_TIMER2BGLOAD) Register MASK  (Use DUALTIMER_TIMER2BGLOAD_Msk instead)  */
#define DUALTIMER_TIMER2BGLOAD_Msk          _U_(0xFFFFFFFF)                                /**< (DUALTIMER_TIMER2BGLOAD) Register Mask  */
...
#define DUALTIMER_TIMERITCR_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMERITCR) Integration Test Control Register  Reset Value */

#define DUALTIMER_TIMERITCR_TIMERITCR_Pos   0                                              /**< (DUALTIMER_TIMERITCR)  Position */
#define DUALTIMER_TIMERITCR_TIMERITCR_Msk   (_U_(0x1) << DUALTIMER_TIMERITCR_TIMERITCR_Pos)  /**< (DUALTIMER_TIMERITCR)  Mask */
...
#define DUALTIMER_TIMERITCR_MASK            _U_(0x01)                                      /**< \deprecated (DUALTIMER_TIMERITCR) Register MASK  (Use DUALTIMER_TIMERITCR_Msk instead)  */
#define DUALTIMER_TIMERITCR_Msk             _U_(0x01)                                      /**< (DUALTIMER_TIMERITCR) Register Mask  */
...
#define DUALTIMER_TIMERITOP_RESETVALUE      _U_(0x00)                                     /**<  (DUALTIMER_TIMERITOP) Integration Test Output Set Register  Reset Value */
...
#define DUALTIMER_TIMERITOP_INT_TEST_TIMINT1_VALUE_Msk (_U_(0x1) << DUALTIMER_TIMERITOP_INT_TEST_TIMINT1_VALUE_Pos)  /**< (DUALTIMER_TIMERITOP) Value Output on TIMINT1 in Integration Test Mode Mask */
...
#define DUALTIMER_TIMERITOP_INT_TEST_TIMING2_VALUE_Msk (_U_(0x1) << DUALTIMER_TIMERITOP_INT_TEST_TIMING2_VALUE_Pos)  /**< (DUALTIMER_TIMERITOP) Value Output on TIMINT2 in Integration Test Mode Mask */
...
#define DUALTIMER_TIMERITOP_MASK            _U_(0x03)                                      /**< \deprecated (DUALTIMER_TIMERITOP) Register MASK  (Use DUALTIMER_TIMERITOP_Msk instead)  */
#define DUALTIMER_TIMERITOP_Msk             _U_(0x03)                                      /**< (DUALTIMER_TIMERITOP) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID4_RESETVALUE _U_(0x04)                                     /**<  (DUALTIMER_TIMERPERIPHID4) Peripheral ID Register 4  Reset Value */

#define DUALTIMER_TIMERPERIPHID4_JEP106_C_CODE_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID4) JEP106 C Code Position */
#define DUALTIMER_TIMERPERIPHID4_JEP106_C_CODE_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID4_JEP106_C_CODE_Pos)  /**< (DUALTIMER_TIMERPERIPHID4) JEP106 C Code Mask */
...
#define DUALTIMER_TIMERPERIPHID4_BLOCK_COUNT_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID4_BLOCK_COUNT_Pos)  /**< (DUALTIMER_TIMERPERIPHID4) Block Count Mask */
...
#define DUALTIMER_TIMERPERIPHID4_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID4) Register MASK  (Use DUALTIMER_TIMERPERIPHID4_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID4_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID4) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID5_RESETVALUE _U_(0x00)                                     /**<  (DUALTIMER_TIMERPERIPHID5) Peripheral ID Register 5  Reset Value */

#define DUALTIMER_TIMERPERIPHID5_TIMERPERIPHID5_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID5)  Position */
#define DUALTIMER_TIMERPERIPHID5_TIMERPERIPHID5_Msk (_U_(0xFF) << DUALTIMER_TIMERPERIPHID5_TIMERPERIPHID5_Pos)  /**< (DUALTIMER_TIMERPERIPHID5)  Mask */
...
#define DUALTIMER_TIMERPERIPHID5_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID5) Register MASK  (Use DUALTIMER_TIMERPERIPHID5_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID5_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID5) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID6_RESETVALUE _U_(0x00)                                     /**<  (DUALTIMER_TIMERPERIPHID6) Peripheral ID Register 6  Reset Value */

#define DUALTIMER_TIMERPERIPHID6_TIMERPERIPHID6_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID6)  Position */
#define DUALTIMER_TIMERPERIPHID6_TIMERPERIPHID6_Msk (_U_(0xFF) << DUALTIMER_TIMERPERIPHID6_TIMERPERIPHID6_Pos)  /**< (DUALTIMER_TIMERPERIPHID6)  Mask */
...
#define DUALTIMER_TIMERPERIPHID6_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID6) Register MASK  (Use DUALTIMER_TIMERPERIPHID6_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID6_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID6) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID7_RESETVALUE _U_(0x00)                                     /**<  (DUALTIMER_TIMERPERIPHID7) Peripheral ID Register 7  Reset Value */

#define DUALTIMER_TIMERPERIPHID7_TIMERPERIPHID7_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID7)  Position */
#define DUALTIMER_TIMERPERIPHID7_TIMERPERIPHID7_Msk (_U_(0xFF) << DUALTIMER_TIMERPERIPHID7_TIMERPERIPHID7_Pos)  /**< (DUALTIMER_TIMERPERIPHID7)  Mask */
...
#define DUALTIMER_TIMERPERIPHID7_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID7) Register MASK  (Use DUALTIMER_TIMERPERIPHID7_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID7_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID7) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID0_RESETVALUE _U_(0x23)                                     /**<  (DUALTIMER_TIMERPERIPHID0) Peripheral ID Register 0  Reset Value */

#define DUALTIMER_TIMERPERIPHID0_PART_NUMBER_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID0) Part Number Bits 7:0 Position */
#define DUALTIMER_TIMERPERIPHID0_PART_NUMBER_Msk (_U_(0xFF) << DUALTIMER_TIMERPERIPHID0_PART_NUMBER_Pos)  /**< (DUALTIMER_TIMERPERIPHID0) Part Number Bits 7:0 Mask */
...
#define DUALTIMER_TIMERPERIPHID0_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID0) Register MASK  (Use DUALTIMER_TIMERPERIPHID0_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID0_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID0) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID1_RESETVALUE _U_(0xB8)                                     /**<  (DUALTIMER_TIMERPERIPHID1) Peripheral ID Register 1  Reset Value */

#define DUALTIMER_TIMERPERIPHID1_PART_NUMBER_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID1) Part Number Bits 11:8 Position */
#define DUALTIMER_TIMERPERIPHID1_PART_NUMBER_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID1_PART_NUMBER_Pos)  /**< (DUALTIMER_TIMERPERIPHID1) Part Number Bits 11:8 Mask */
...
#define DUALTIMER_TIMERPERIPHID1_JEP106_ID_3_0_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID1_JEP106_ID_3_0_Pos)  /**< (DUALTIMER_TIMERPERIPHID1) JEP106 ID Bits 3:0 Mask */
...
#define DUALTIMER_TIMERPERIPHID1_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID1) Register MASK  (Use DUALTIMER_TIMERPERIPHID1_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID1_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID1) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID2_RESETVALUE _U_(0x1B)                                     /**<  (DUALTIMER_TIMERPERIPHID2) Peripheral ID Register 2  Reset Value */

#define DUALTIMER_TIMERPERIPHID2_JEP106_ID_6_4_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID2) JEP106 ID Bits 6:4 Position */
#define DUALTIMER_TIMERPERIPHID2_JEP106_ID_6_4_Msk (_U_(0x7) << DUALTIMER_TIMERPERIPHID2_JEP106_ID_6_4_Pos)  /**< (DUALTIMER_TIMERPERIPHID2) JEP106 ID Bits 6:4 Mask */
...
#define DUALTIMER_TIMERPERIPHID2_JEDEC_USED_Msk (_U_(0x1) << DUALTIMER_TIMERPERIPHID2_JEDEC_USED_Pos)  /**< (DUALTIMER_TIMERPERIPHID2) JEDEC Used Mask */
...
#define DUALTIMER_TIMERPERIPHID2_REVISION_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID2_REVISION_Pos)  /**< (DUALTIMER_TIMERPERIPHID2) Revision Mask */
...
#define DUALTIMER_TIMERPERIPHID2_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID2) Register MASK  (Use DUALTIMER_TIMERPERIPHID2_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID2_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID2) Register Mask  */
...
#define DUALTIMER_TIMERPERIPHID3_RESETVALUE _U_(0x00)                                     /**<  (DUALTIMER_TIMERPERIPHID3) Peripheral ID Register 3  Reset Value */

#define DUALTIMER_TIMERPERIPHID3_CUSTOMER_MOD_NUMBER_Pos 0                                              /**< (DUALTIMER_TIMERPERIPHID3) Customer Modification Number Position */
#define DUALTIMER_TIMERPERIPHID3_CUSTOMER_MOD_NUMBER_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID3_CUSTOMER_MOD_NUMBER_Pos)  /**< (DUALTIMER_TIMERPERIPHID3) Customer Modification Number Mask */
...
#define DUALTIMER_TIMERPERIPHID3_ECO_REV_NUMBER_Msk (_U_(0xF) << DUALTIMER_TIMERPERIPHID3_ECO_REV_NUMBER_Pos)  /**< (DUALTIMER_TIMERPERIPHID3) ECO Revision Number Mask */
...
#define DUALTIMER_TIMERPERIPHID3_MASK       _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPERIPHID3) Register MASK  (Use DUALTIMER_TIMERPERIPHID3_Msk instead)  */
#define DUALTIMER_TIMERPERIPHID3_Msk        _U_(0xFF)                                      /**< (DUALTIMER_TIMERPERIPHID3) Register Mask  */
...
#define DUALTIMER_TIMERPCELLID0_RESETVALUE  _U_(0x0D)                                     /**<  (DUALTIMER_TIMERPCELLID0) Component ID Register 0  Reset Value */

#define DUALTIMER_TIMERPCELLID0_TIMERPCELLID0_Pos 0                                              /**< (DUALTIMER_TIMERPCELLID0)  Position */
#define DUALTIMER_TIMERPCELLID0_TIMERPCELLID0_Msk (_U_(0xFF) << DUALTIMER_TIMERPCELLID0_TIMERPCELLID0_Pos)  /**< (DUALTIMER_TIMERPCELLID0)  Mask */
...
#define DUALTIMER_TIMERPCELLID0_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPCELLID0) Register MASK  (Use DUALTIMER_TIMERPCELLID0_Msk instead)  */
#define DUALTIMER_TIMERPCELLID0_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMERPCELLID0) Register Mask  */
...
#define DUALTIMER_TIMERPCELLID1_RESETVALUE  _U_(0xF0)                                     /**<  (DUALTIMER_TIMERPCELLID1) Component ID Register 1  Reset Value */

#define DUALTIMER_TIMERPCELLID1_TIMERPCELLID1_Pos 0                                              /**< (DUALTIMER_TIMERPCELLID1)  Position */
#define DUALTIMER_TIMERPCELLID1_TIMERPCELLID1_Msk (_U_(0xFF) << DUALTIMER_TIMERPCELLID1_TIMERPCELLID1_Pos)  /**< (DUALTIMER_TIMERPCELLID1)  Mask */
...
#define DUALTIMER_TIMERPCELLID1_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPCELLID1) Register MASK  (Use DUALTIMER_TIMERPCELLID1_Msk instead)  */
#define DUALTIMER_TIMERPCELLID1_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMERPCELLID1) Register Mask  */
...
#define DUALTIMER_TIMERPCELLID2_RESETVALUE  _U_(0x05)                                     /**<  (DUALTIMER_TIMERPCELLID2) Component ID Register 2  Reset Value */

#define DUALTIMER_TIMERPCELLID2_TIMERPCELLID2_Pos 0                                              /**< (DUALTIMER_TIMERPCELLID2)  Position */
#define DUALTIMER_TIMERPCELLID2_TIMERPCELLID2_Msk (_U_(0xFF) << DUALTIMER_TIMERPCELLID2_TIMERPCELLID2_Pos)  /**< (DUALTIMER_TIMERPCELLID2)  Mask */
...
#define DUALTIMER_TIMERPCELLID2_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPCELLID2) Register MASK  (Use DUALTIMER_TIMERPCELLID2_Msk instead)  */
#define DUALTIMER_TIMERPCELLID2_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMERPCELLID2) Register Mask  */
...
#define DUALTIMER_TIMERPCELLID3_RESETVALUE  _U_(0xB1)                                     /**<  (DUALTIMER_TIMERPCELLID3) Component ID Register 3  Reset Value */

#define DUALTIMER_TIMERPCELLID3_TIMERPCELLID3_Pos 0                                              /**< (DUALTIMER_TIMERPCELLID3)  Position */
#define DUALTIMER_TIMERPCELLID3_TIMERPCELLID3_Msk (_U_(0xFF) << DUALTIMER_TIMERPCELLID3_TIMERPCELLID3_Pos)  /**< (DUALTIMER_TIMERPCELLID3)  Mask */
...
#define DUALTIMER_TIMERPCELLID3_MASK        _U_(0xFF)                                      /**< \deprecated (DUALTIMER_TIMERPCELLID3) Register MASK  (Use DUALTIMER_TIMERPCELLID3_Msk instead)  */
#define DUALTIMER_TIMERPCELLID3_Msk         _U_(0xFF)                                      /**< (DUALTIMER_TIMERPCELLID3) Register Mask  */
...
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
/** @}  end of ARM General Purpose Dual Timer */

#endif /* _SAMB11_DUALTIMER_COMPONENT_H_ */
