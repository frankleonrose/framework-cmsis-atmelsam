...
#define PAC_INTFLAGC_MASK           _U(0x000003FF) /**< \brief (PAC_INTFLAGC) MASK Register */
...
#define PAC_INTFLAGD_MASK           _U(0x000000BF) /**< \brief (PAC_INTFLAGD) MASK Register */
...
#define PAC_STATUSC_MASK            _U(0x000003FF) /**< \brief (PAC_STATUSC) MASK Register */
...
#define PAC_STATUSD_MASK            _U(0x000000BF) /**< \brief (PAC_STATUSD) MASK Register */
