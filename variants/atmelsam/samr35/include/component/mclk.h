...
#ifndef _SAMR35_MCLK_COMPONENT_
#define _SAMR35_MCLK_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR MCLK */
/* ========================================================================== */
/** \addtogroup SAMR35_MCLK Main Clock */
/*@{*/
...
#define MCLK_AHBMASK_MASK           _U_(0x000FCF3F) /**< \brief (MCLK_AHBMASK) MASK Register */
...
#define MCLK_APBBMASK_MASK          _U_(0x00000006) /**< \brief (MCLK_APBBMASK) MASK Register */
