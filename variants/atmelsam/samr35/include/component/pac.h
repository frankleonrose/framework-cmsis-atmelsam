...
#ifndef _SAMR35_PAC_COMPONENT_
#define _SAMR35_PAC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR PAC */
/* ========================================================================== */
/** \addtogroup SAMR35_PAC Peripheral Access Controller */
/*@{*/
...
#define PAC_INTFLAGB_MASK           _U_(0x0000000E) /**< \brief (PAC_INTFLAGB) MASK Register */
...
#define PAC_STATUSB_MASK            _U_(0x0000000E) /**< \brief (PAC_STATUSB) MASK Register */
